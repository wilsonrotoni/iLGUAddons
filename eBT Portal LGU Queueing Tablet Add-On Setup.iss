[Setup]
AppId=eBTPortalLGUQueueingTabletAddOnSetup
AppName=eBT Portal LGU Queueing Tablet AddOn Setup
AppVerName=eBT Portal LGU Queueing Tablet AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUQueueingTabletAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Queueing Tablet Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'LGU Queueing Tablet Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'LGUQueueingTablet';
  AddOnVersion := '1.0.0';
