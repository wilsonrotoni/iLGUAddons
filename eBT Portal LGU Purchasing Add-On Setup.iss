[Setup]
AppId=eBTPortalLGUPurchasingAddOnSetup
AppName=eBT Portal LGU Purchasing AddOn Setup
AppVerName=eBT Portal LGU Purchasing AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUPurchasingAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Purchasing Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'LGU Purchasing Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'LGUPurchasing';
  AddOnVersion := '1.0.0';
