[Setup]
AppId=eBTPortalLGUBacoorAddOnSetup
AppName=eBT Portal LGU Bacoor AddOn Setup
AppVerName=eBT Portal LGU Bacoor AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUBacoorAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Bacoor Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
