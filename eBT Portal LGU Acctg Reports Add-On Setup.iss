[Setup]
AppId=eBTPortalLGUAcctgReportsAddOnSetup
AppName=eBT Portal LGU Acctg Reports AddOn Setup
AppVerName=eBT Portal LGU Acctg Reports AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUAcctgReportsAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Acctg Reports Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'LGU Acctg Reports Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'LGUAcctgReports';
  AddOnVersion := '1.0.0';
