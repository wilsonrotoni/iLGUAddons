	...
	$progid = "u_tkapprovedhistoryforadmin";
	...
	$page->paging->formid = "./UDP.php?objectcode=u_tkapprovedhistoryforadmin";
	$page->formid = "./UDO.php?objectcode=u_tkapprovedhistoryforadmin";
				...
				if($page->getitemstring("triptype") == 1) {
					if($page->getcolumnstring("checkedT1r".$i) == "Y"){
						if ($obju_OT->getbysql("CODE='".$page->getcolumnstring("requestnoT1r".$i)."'")) {
								...
								$obju_History->setudfvalue("u_typeofrequest",$page->getcolumnstring("typeofrequestT1r".$i));
								$actionReturn = $obju_History->add();
	...
	$objGrid->columnwidth("requestno",20);
	$objGrid->columnwidth("date",20);
	$objGrid->columnwidth("status",1);
	$objGrid->columnwidth("empid",20);
	$objGrid->columnwidth("empname",50);
	$objGrid->columnwidth("remarks",50);
	$objGrid->columnwidth("typeofrequest",30);
	$objGrid->columnwidth("userremarks",50);
	...
	function loadu_trip($p_selected) {
		$status1= array('1' => 'Over Time','2' => 'Leave','3' => 'Loan','4' => 'Time Adjustment','5' => 'Official Business','6' => 'Off-set','7' => 'Off-set Hrs');
		$_html = "";		
		$_selected = "";
		reset($status1);
		while (list($key, $val) = each($status1)) {
...
<script language="JavaScript">
	...
	function showRequestLists(){
		...
		result = page.executeFormattedQuery("SELECT a.code,a.u_appdate,a.u_empid,a.u_empname,IF(c.u_noofapp - IFNULL(c1.u_stageno,0),1,0) as vstatus,CONCAT('Leave Days :',ROUND(a.u_leavedays,2),' Leave Dates : ',DATE_FORMAT(a.u_leavefrom,'%m/%d/%y'),' and ',DATE_FORMAT(a.u_leaveto,'%m/%d/%y')) as 'remarks',CONCAT(u_leavetype,' - ',u_leavereason) as 'typeofrequest' FROM u_tkrequestformleave a INNER JOIN u_premploymentinfo b ON b.company = a.company AND b.branch = a.branch AND b.code = a.u_empid LEFT JOIN (SELECT u_requestno,COUNT(code) as counters FROM u_tkapproverhistory GROUP BY u_requestno) as x ON x.u_requestno = a.code INNER JOIN u_tkapproverfile c ON c.company = b.company AND c.branch = b.branch AND c.code = b.u_employstatus2 INNER JOIN u_tkapproverfileassigned c1 ON c1.company = c.company AND c1.branch = c.branch AND c1.code = c.code AND c1.u_stageno = IFNULL(x.counters,0)+1 WHERE a.company = '"+getGlobal("company")+"' AND a.branch = '"+getGlobal("branch")+"' AND c1.u_valid = 0 AND c.u_admin = '"+getGlobal("userid")+"'  AND a.u_appdate BETWEEN '"+formatDateToDB(getInput("date1"))+"' AND '"+formatDateToDB(getInput("date2"))+"' AND a.u_status = 0");
		...
		result = page.executeFormattedQuery("SELECT a.code,a.u_appdate,a.u_empid,a.u_empname,IF(c.u_noofapp - IFNULL(c1.u_stageno,0),1,0) as vstatus,CONCAT('Loan Dates : ',DATE_FORMAT(a.u_loanfrom,'%m/%d/%y'),' and ',DATE_FORMAT(a.u_loanto,'%m/%d/%y')) as 'remarks',CONCAT(u_loantype,' - ',u_loanreason) as 'typeofrequest' FROM u_tkrequestformloan a INNER JOIN u_premploymentinfo b ON b.company = a.company AND b.branch = a.branch AND b.code = a.u_empid LEFT JOIN (SELECT u_requestno,COUNT(code) as counters FROM u_tkapproverhistory GROUP BY u_requestno) as x ON x.u_requestno = a.code INNER JOIN u_tkapproverfile c ON c.company = b.company AND c.branch = b.branch AND c.code = b.u_employstatus2 INNER JOIN u_tkapproverfileassigned c1 ON c1.company = c.company AND c1.branch = c.branch AND c1.code = c.code AND c1.u_stageno = IFNULL(x.counters,0)+1 WHERE a.company = '"+getGlobal("company")+"' AND a.branch = '"+getGlobal("branch")+"' AND c1.u_valid = 0 AND c.u_admin = '"+getGlobal("userid")+"'  AND a.u_appdate BETWEEN '"+formatDateToDB(getInput("date1"))+"' AND '"+formatDateToDB(getInput("date2"))+"' AND a.u_status = 0");
		...
		result = page.executeFormattedQuery("SELECT a.code,a.u_appdate,a.u_empid,a.u_empname,IF(c.u_noofapp - IFNULL(c1.u_stageno,0),1,0) as vstatus,'Time Adjustment For Incorrect/Missing Time In/Out' as 'remarks',CONCAT('Time Adjustment',' - ',u_tareason) as 'typeofrequest' FROM u_tkrequestformtimeadjustment a INNER JOIN u_premploymentinfo b ON b.company = a.company AND b.branch = a.branch AND b.code = a.u_empid LEFT JOIN (SELECT u_requestno,COUNT(code) as counters FROM u_tkapproverhistory GROUP BY u_requestno) as x ON x.u_requestno = a.code INNER JOIN u_tkapproverfile c ON c.company = b.company AND c.branch = b.branch AND c.code = b.u_employstatus2 INNER JOIN u_tkapproverfileassigned c1 ON c1.company = c.company AND c1.branch = c.branch AND c1.code = c.code AND c1.u_stageno = IFNULL(x.counters,0)+1 WHERE a.company = '"+getGlobal("company")+"' AND a.branch = '"+getGlobal("branch")+"' AND c1.u_valid = 0 AND c.u_admin = '"+getGlobal("userid")+"'  AND a.u_appdate BETWEEN '"+formatDateToDB(getInput("date1"))+"' AND '"+formatDateToDB(getInput("date2"))+"' AND a.u_status = 0");
		...
		result = page.executeFormattedQuery("SELECT a.code,a.u_appdate,a.u_empid,a.u_empname,IF(c.u_noofapp - IFNULL(c1.u_stageno,0),1,0) as vstatus,CONCAT('Work Hrs :',ROUND(a.u_tk_wd,2),' O.B. Dates : ',DATE_FORMAT(a.u_tkdate,'%m/%d/%y')) as 'remarks',CONCAT('Official Business',' - ',u_assreason) as 'typeofrequest' FROM u_tkrequestformass a INNER JOIN u_premploymentinfo b ON b.company = a.company AND b.branch = a.branch AND b.code = a.u_empid LEFT JOIN (SELECT u_requestno,COUNT(code) as counters FROM u_tkapproverhistory GROUP BY u_requestno) as x ON x.u_requestno = a.code INNER JOIN u_tkapproverfile c ON c.company = b.company AND c.branch = b.branch AND c.code = b.u_employstatus2 INNER JOIN u_tkapproverfileassigned c1 ON c1.company = c.company AND c1.branch = c.branch AND c1.code = c.code AND c1.u_stageno = IFNULL(x.counters,0)+1 WHERE a.company = '"+getGlobal("company")+"' AND a.branch = '"+getGlobal("branch")+"' AND c1.u_valid = 0 AND c.u_admin = '"+getGlobal("userid")+"'  AND a.u_appdate BETWEEN '"+formatDateToDB(getInput("date1"))+"' AND '"+formatDateToDB(getInput("date2"))+"' AND a.u_status = 0");
		...
		result = page.executeFormattedQuery("SELECT a.code,a.u_appdate,a.u_empid,a.u_empname,IF(c.u_noofapp - IFNULL(c1.u_stageno,0),1,0) as vstatus,CONCAT('Work Hrs :',ROUND(a.u_tk_wd,2),' Off-set Dates : ',DATE_FORMAT(a.u_tkdate,'%m/%d/%y')) as 'remarks',CONCAT('Off-set',' - ',u_assreason) as 'typeofrequest' FROM u_tkrequestformoffsethrs a INNER JOIN u_premploymentinfo b ON b.company = a.company AND b.branch = a.branch AND b.code = a.u_empid LEFT JOIN (SELECT u_requestno,COUNT(code) as counters FROM u_tkapproverhistory GROUP BY u_requestno) as x ON x.u_requestno = a.code INNER JOIN u_tkapproverfile c ON c.company = b.company AND c.branch = b.branch AND c.code = b.u_employstatus2 INNER JOIN u_tkapproverfileassigned c1 ON c1.company = c.company AND c1.branch = c.branch AND c1.code = c.code AND c1.u_stageno = IFNULL(x.counters,0)+1 WHERE a.company = '"+getGlobal("company")+"' AND a.branch = '"+getGlobal("branch")+"' AND c1.u_valid = 0 AND c.u_admin = '"+getGlobal("userid")+"'  AND a.u_appdate BETWEEN '"+formatDateToDB(getInput("date1"))+"' AND '"+formatDateToDB(getInput("date2"))+"' AND a.u_status = 0");
		...
		result = page.executeFormattedQuery("SELECT a.code,a.u_appdate,a.u_empid,a.u_empname,IF(c.u_noofapp - IFNULL(c1.u_stageno,0),1,0) as vstatus,CONCAT('Work Hrs :',ROUND(a.u_offhrs,2),' Off-set Dates : ',DATE_FORMAT(a.u_offdate,'%m/%d/%y')) as 'remarks',CONCAT('Off-set',' - ',u_offreason) as 'typeofrequest' FROM u_tkrequestformoffsethrs a INNER JOIN u_premploymentinfo b ON b.company = a.company AND b.branch = a.branch AND b.code = a.u_empid LEFT JOIN (SELECT u_requestno,COUNT(code) as counters FROM u_tkapproverhistory GROUP BY u_requestno) as x ON x.u_requestno = a.code INNER JOIN u_tkapproverfile c ON c.company = b.company AND c.branch = b.branch AND c.code = b.u_employstatus2 INNER JOIN u_tkapproverfileassigned c1 ON c1.company = c.company AND c1.branch = c.branch AND c1.code = c.code AND c1.u_stageno = IFNULL(x.counters,0)+1 WHERE a.company = '"+getGlobal("company")+"' AND a.branch = '"+getGlobal("branch")+"' AND c1.u_valid = 0 AND c.u_admin = '"+getGlobal("userid")+"'  AND a.u_appdate BETWEEN '"+formatDateToDB(getInput("date1"))+"' AND '"+formatDateToDB(getInput("date2"))+"' AND a.u_status = 0");
		...
		result = page.executeFormattedQuery("SELECT a.code,a.u_appdate,a.u_empid,a.u_empname,IF(c.u_noofapp - IFNULL(c1.u_stageno,0),1,0) as vstatus,CONCAT('Work Hrs :',ROUND(a.u_tk_wd,2),' Off-set Dates : ',DATE_FORMAT(a.u_tkdate,'%m/%d/%y')) as 'remarks',CONCAT('OB Hrs',' - ',u_assreason) as 'typeofrequest',c.code as 'approvercode',(c1.u_stageno+1) as 'nextstageno' FROM u_tkrequestformobset a INNER JOIN u_premploymentinfo b ON b.company = a.company AND b.branch = a.branch AND b.code = a.u_empid LEFT JOIN (SELECT u_requestno,COUNT(code) as counters FROM u_tkapproverhistory GROUP BY u_requestno) as x ON x.u_requestno = a.code INNER JOIN u_tkapproverfile c ON c.company = b.company AND c.branch = b.branch AND c.code = b.u_employstatus2 INNER JOIN u_tkapproverfileassigned c1 ON c1.company = c.company AND c1.branch = c.branch AND c1.code = c.code AND c1.u_stageno = IFNULL(x.counters,0)+1 WHERE a.company = '"+getGlobal("company")+"' AND a.branch = '"+getGlobal("branch")+"' AND c1.u_stagename = '"+getGlobal("userid")+"'  AND a.u_appdate BETWEEN '"+formatDateToDB(getInput("date1"))+"' AND '"+formatDateToDB(getInput("date2"))+"' AND a.u_status = 0");
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Approved Form For Admin&nbsp;</td>
...
<tr><td><table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
	  ...
	  <td  align=left><select <?php genSelectHtml($schema["status"],array("loadu_batch","",":")) ?> ></select>
      		&nbsp;<input type="text" size="12" <?php genInputTextHtml($schema["sdate"]) ?> /></td>
	</tr>
    <tr><td width="168"><label <?php genCaptionHtml($schema["date1"],"") ?>>From</label></td>
	  		<td  align=left><input type="text" size="12" <?php genInputTextHtml($schema["date1"]) ?> /></td>
    </tr>
    <tr><td width="168"><label <?php genCaptionHtml($schema["date2"],"") ?>>To</label></td>
