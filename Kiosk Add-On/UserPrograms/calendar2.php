<?php
define("MAX_TITLES_DISPLAYED", 35);
...
<div <?php genPopWinHDivHtml("popupFrameADetail","List of Employee",50,200,870,false) ?>>
<table width="100%" cellpadding="0" cellspacing="0" border="01">
<tr><td width="10">&nbsp;</td>
<td>
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr><td colspan="2"><?php $objGridARequestList->draw(false); ?></td></tr>
