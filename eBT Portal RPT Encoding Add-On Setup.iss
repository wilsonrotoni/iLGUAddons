[Setup]
AppId=eBTPortalRPTEncodingAddOnSetup
AppName=eBT Portal RPT Encoding AddOn Setup
AppVerName=eBT Portal RPT Encoding AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalRPTEncodingAddOnSetup.exe
Compression=lzma
...
[Files]
Source: RPT Encoding Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
