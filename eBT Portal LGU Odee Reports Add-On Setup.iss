[Setup]
AppId=eBTPortalLGUOdeeReportsAddOnSetup
AppName=eBT Portal LGU Odee Reports AddOn Setup
AppVerName=eBT Portal LGU Odee Reports AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUOdeeReportsAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Odee Reports Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'LGU Odee Reports Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'LGUOdeeReports';
  AddOnVersion := '1.0.0';
