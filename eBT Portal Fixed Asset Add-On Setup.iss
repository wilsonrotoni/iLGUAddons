[Setup]
AppId=eBTPortalFixedAssetAddOnSetup
AppName=eBT Portal Fixed Asset AddOn Setup
AppVerName=eBT Portal Fixed Asset AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalFixedAssetAddOnSetup.exe
Compression=lzma
...
[Files]
Source: Fixed Asset Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
