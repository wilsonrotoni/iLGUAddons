	...
	switch ($_GET["type"]) {
		case "SanitaryInspections":
			...
			while ($objRs->queryfetchrow("NAME")) {
				...
				array_push($objs["sanitaryinspections"],$data);
 			}
