<tr><td>
        <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr><td width="168" >&nbsp;</td>
                ...
                <td width="240" align=left>&nbsp;<input type="text"  <?php $page->businessobject->items->draw->text("docno") ?> /></td>
            </tr>
            ...
            <tr>
                ...
                <td>&nbsp;<input type="text" <?php $page->businessobject->items->userfields->draw->text("u_docdate") ?>/></td>
            </tr>
            <tr>
         ...
         <tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_owner") ?>>Name of Owner</label></td>
            <td>&nbsp;<input type="text" size="50" <?php $page->businessobject->items->userfields->draw->text("u_owner") ?>/></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
         <tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_manager") ?>>Name of Manager</label></td>
            <td>&nbsp;<input type="text" size="50" <?php $page->businessobject->items->userfields->draw->text("u_manager") ?>/></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
	<tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_category") ?>>Category</label></td>
        ...
        <tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_orfcamt") ?>>Sanitary Fee</label></td>
