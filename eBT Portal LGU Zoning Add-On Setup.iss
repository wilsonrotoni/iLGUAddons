[Setup]
AppId=eBTPortalLGUZoningAddOnSetup
AppName=eBT Portal LGU Zoning AddOn Setup
AppVerName=eBT Portal LGU Zoning AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUZoningAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Zoning Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
