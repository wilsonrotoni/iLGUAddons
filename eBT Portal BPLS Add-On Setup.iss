[Setup]
AppId=eBTPortalBPLSAddOnSetup
AppName=eBT Portal BPLS AddOn Setup
AppVerName=eBT Portal BPLS AddOn Setup Version 01.01.001
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalBPLSAddOnSetup.exe
Compression=lzma
...
[Files]
Source: BPLS Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
