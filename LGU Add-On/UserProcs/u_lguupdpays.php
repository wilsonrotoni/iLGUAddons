...
$page->businessobject->items->setcfl("u_remittancedate","Calendar");
$page->businessobject->items->setcfl("u_asofdate","Calendar");
//$page->businessobject->items->setcfl("u_ordateto","Calendar");
$page->businessobject->items->seteditable("docstatus",false);
$page->businessobject->items->seteditable("u_remittancedate",false);

$objGrids[0]->dataentry = false;
$objGrids[0]->columninput("u_remittancedate","type","text");
$objGrids[0]->columnwidth("u_remittancedate",15);

$addoptions = false;
$deleteoption = false;
$pageHeader = "Cashier Remittance";
?> 
