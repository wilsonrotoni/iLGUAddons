...
$objGrid->columndataentry("u_autoseries","type","checkbox");
$objGrid->columndataentry("u_autoseries","value",1);

//$objGrid->columntitle("u_autoseries","");
$objGrid->columnwidth("u_autoseries",10);

$objGrid->columntitle("code","Barangay");
$objGrid->columnwidth("code",50);
$objGrid->columnvisibility("name",true);
