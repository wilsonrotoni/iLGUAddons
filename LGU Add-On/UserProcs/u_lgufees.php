...
$objGrid->columndataentry("u_environmental","type","checkbox");
$objGrid->columndataentry("u_environmental","value",1);

$objGrid->columndataentry("u_installment","type","checkbox");
$objGrid->columndataentry("u_installment","value",1);

$objGrid->columndataentry("u_interest","type","checkbox");
$objGrid->columndataentry("u_interest","value",1);
...
$objGrid->columnwidth("u_pglcode",15);
$objGrid->columnwidth("u_nglcode",15);
