...
//	include_once("./inc/formaccess.php");
	...
	$page->paging->formid = "./UDP.php?&objectcode=u_lguqueuedisplay2";
...
<script language="JavaScript">
	...
	function onPageLoad() {
		setTimeout("formSearchNow()",<?php echo $refresh * 15000; ?>);
		try {
		<?php if ($speech!="") { ?>
...
//				msg.rate = 5.2;
	...
	function onFormSubmit(action) {
        ...
        function PlayDoorbell(){
            try {
                let src = "../Addons/GPS/LGU Add-On/UserPrograms/sound/doorbell.mp3";
                let audio = document.getElementById("a");
                audio.src = src;
                audio.volume = 1;
                audio.play();
                
                audio.addEventListener('ended',playTexttoSpeech);
            } catch (theError) {
            }
              ...
              <td width="50%" rowspan="2" >
              	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="1" style="background-color:#000000">
                	<tr height="100">
                        ...
                        <td align="center" rowspan="2" ><font size="7" face="Verdana, Arial, Helvetica, sans-serif" color="<?php echo $colors[$coloridx] ?>"><b><label class="tab blink"><?php echo $ref[0] ?></label></b></font></td>
                    </tr>
                	<tr height="100">
