<?php
	$progid = "u_unpaybilllistLocational";
	...
	$page->objectcode = "u_unpaybilllistLocational";
	$page->paging->formid = "./UDP.php?&objectcode=u_unpaybilllistLocational";
...
//	}
	...
	if ($page->getitemstring("u_acctno")!="" || $page->getitemstring("u_custname")!="" ) {
	        $objrs->queryopenext("SELECT A.U_PROFITCENTER, A.U_PAYMODE,A.U_PAYQTR,A.DOCNO, A.U_APPNO,A.U_CUSTNO, A.U_CUSTNAME, A.U_DOCDATE, A.U_DUEDATE, A.U_REMARKS, B.NAME AS U_PROFITCENTERNAME, A.U_DUEAMOUNT FROM U_LGUBILLS A INNER JOIN U_LGUPROFITCENTERS B ON B.CODE=A.U_PROFITCENTER WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' AND A.U_DUEAMOUNT>0 AND A.DOCSTATUS='O' AND A.U_MODULE = 'Zoning Locational Clearance Tax'  $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;List of Unpaid Bills - Locational&nbsp;</td>
