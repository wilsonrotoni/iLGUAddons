<?php
	...
	function executeTaskbplexportGPSLGU() {
		$result = array(0,"error");
		$actionReturn = true;
		echo "executeTaskbplexportGPSLGU():running\r\n";
		...
		$objRs->queryopen("select u_bplexportfilename from u_lgusetup where u_bplexportfilename<>''");
