...
//	$enumdocstatus["Cancelled"]="Cancelled";
	...
	$page->objectcode = "u_rptcontract";
	$page->paging->formid = "./UDP.php?&objectcode=u_rptcontract";
...
//            alert("wilson");
            window.open("http://94.237.70.74/infra/contract-agreement/"+getInput("u_bpcode")+"","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=SomeSize,height=SomeSize");
...
//            alert("wilson");
            window.open("http://94.237.70.74/goods/contract-agreement/"+getInput("u_bpcode")+"","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=SomeSize,height=SomeSize");
//            OpenPopup(1024,600,"http://94.237.70.74/index-of-payment/generated-report/Meralco/2021-01-01/2021-01-31","UpdPays");
//            var targetObjectId = getTableKey("T1","keys",getTableSelectedRow("T1"));
//            OpenLnkBtn(1064,650,'./udo.php?objectcode=u_lgupurchaserequests' + '' + '&targetId=' + targetObjectId ,targetObjectId);
        }
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Contract Agreement&nbsp;</td>
