...
//	$enumdocstatus["Cancelled"]="Cancelled";
	...
	$page->objectcode = "u_rptbidascalculated";
	$page->paging->formid = "./UDP.php?&objectcode=u_rptbidascalculated";
...
//            alert("wilson");
            window.open("http://94.237.70.74/abstract-of-bid/calculated/generated-report/"+getInput("u_bpcode")+"","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=SomeSize,height=SomeSize");
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Abstract of BID as Calculated&nbsp;</td>
