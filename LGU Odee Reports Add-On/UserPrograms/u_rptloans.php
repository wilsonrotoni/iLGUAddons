...
//	$enumdocstatus["Cancelled"]="Cancelled";
	...
	$page->objectcode = "u_rptloans";
	$page->paging->formid = "./UDP.php?&objectcode=u_rptloans";
...
//            alert("wilson");
            window.open("http://94.237.70.74/schedules-on-loans-payable/"+formatDateToDB(getInput("u_duedatefr"))+"/"+formatDateToDB(getInput("u_duedateto"))+"","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=SomeSize,height=SomeSize");
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Schedule of Loans Payables&nbsp;</td>
...
<!--        <tr><td width="100" ><label <?php genCaptionHtml($schema["u_bpcode"],"") ?>>Supplier Code</label></td>
        ...
        <tr class="fillerRow5px"><td></td></tr>
        <tr><td width="100"><label <?php genCaptionHtml($schema["docno"],"") ?>>Date</label></td>
		<td width="300" align=left><input type="text" size="12" <?php genInputTextHtml($schema["u_duedatefr"]) ?> /> &nbsp;<input type="text" size="12" <?php genInputTextHtml($schema["u_duedateto"]) ?> /></td>
		<td width="1142"></td>
		<td width="300" align=left>&nbsp;</td>
	</tr>
        <tr class="fillerRow10px"><td></td></tr>
