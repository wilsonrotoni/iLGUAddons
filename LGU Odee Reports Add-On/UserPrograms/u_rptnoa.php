...
//	$enumdocstatus["Cancelled"]="Cancelled";
	...
	$page->objectcode = "u_rptnoa";
	$page->paging->formid = "./UDP.php?&objectcode=u_rptnoa";
...
//            alert("wilson");
            window.open("http://94.237.70.74/infra/notice-of-award/generated-doc/"+getInput("u_bpcode")+"","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=SomeSize,height=SomeSize");
...
//            alert("wilson");
            window.open("http://94.237.70.74/goods/notice-of-award/generated-doc/"+getInput("u_bpcode")+"","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=SomeSize,height=SomeSize");
//            OpenPopup(1024,600,"http://94.237.70.74/index-of-payment/generated-report/Meralco/2021-01-01/2021-01-31","UpdPays");
//            var targetObjectId = getTableKey("T1","keys",getTableSelectedRow("T1"));
//            OpenLnkBtn(1064,650,'./udo.php?objectcode=u_lgupurchaserequests' + '' + '&targetId=' + targetObjectId ,targetObjectId);
        }
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Notice to Award&nbsp;</td>
