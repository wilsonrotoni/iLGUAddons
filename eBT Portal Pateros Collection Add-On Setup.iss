[Setup]
AppId=eBTPortalPaterosCollectionAddOnSetup
AppName=eBT Portal Pateros Collection AddOn Setup
AppVerName=eBT Portal Pateros Collection AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalPaterosCollectionAddOnSetup.exe
Compression=lzma
...
[Files]
Source: Pateros Collection Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'Pateros Collection Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'PaterosCollection';
  AddOnVersion := '1.0.0';
