[Setup]
AppId=eBTPortalMikeReportAddOnSetup
AppName=eBT Portal Mike Report AddOn Setup
AppVerName=eBT Portal Mike Report AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalMikeReportAddOnSetup.exe
Compression=lzma
...
[Files]
Source: Mike Report Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
