[Setup]
AppId=eBTPortalLGUPaterosAddOnSetup
AppName=eBT Portal LGU Pateros AddOn Setup
AppVerName=eBT Portal LGU Pateros AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUPaterosAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Pateros Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
