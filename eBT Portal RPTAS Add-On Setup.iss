[Setup]
AppId=eBTPortalRPTASAddOnSetup
AppName=eBT Portal RPTAS AddOn Setup
AppVerName=eBT Portal RPTAS AddOn Setup Version 01.01.10
AppPublisher=GREENPEPPER SOFTWARE INC.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalRPTASAddOnSetup.exe
Compression=lzma
...
[Files]
Source: RPTAS Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
