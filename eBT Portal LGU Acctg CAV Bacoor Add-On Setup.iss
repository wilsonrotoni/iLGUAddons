[Setup]
AppId=eBTPortalLGUAcctgCAVBacoorAddOnSetup
AppName=eBT Portal LGU Acctg CAV Bacoor AddOn Setup
AppVerName=eBT Portal LGU Acctg CAV Bacoor AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUAcctgCAVBacoorAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Acctg CAV Bacoor Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'LGU Acctg CAV Bacoor Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'LGUAcctgCAVBacoor';
  AddOnVersion := '1.0.0';
