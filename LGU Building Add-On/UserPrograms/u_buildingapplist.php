...
//	unset($enumdocstatus["D"],$enumdocstatus["O"],$enumdocstatus["C"],$enumdocstatus["CN"]);
	...
	$page->objectcode = "u_buildingapplist  ";
	$page->paging->formid = "./UDP.php?&objectcode=u_buildingapplist";
	$page->formid = "./UDO.php?&objectcode=U_BLDGAPPS";
	$page->objectname = "Building Application List";
...
//                $objGrid->columnvisibility("action2",true);
	...
	$filterExp = genSQLFilterString("U_NATUREOFBUSINESS",$filterExp,$httpVars['df_u_businessnature'],null,null,true);
	$filterExp = genSQLFilterString("U_BUSINESSNAME",$filterExp,$httpVars['df_u_businessname'],null,null,true);
	...
	$filterExp = genSQLFilterString("U_ACCTNO",$filterExp,$httpVars['df_acctno'],null,null,true);
	...
	if ($page->getitemstring("u_businessname")!="") {
		$search=true;
                ...
                $objrs->queryopenext("SELECT *,U_DOCDATE AS U_APPDATE from U_BLDGAPPS B WHERE B.COMPANY = '$company' AND B.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
		...
		while ($objrs->queryfetchrow("NAME")) {
			...
			$objGrid->setitem(null,"u_businessname",$objrs->fields["U_BUSINESSNAME"]);
			...
			case "T1":
				if (getInput("opt")=="Print") {
					...
					if (getTableInput("T1","docno",p_rowIdx)!="") {
						...
						return formView(null,"./UDO.php?&objectcode=u_bldgapps");
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Building Application List&nbsp;</td>
...
<tr><td><table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <table width="1027" border="0"  cellpadding="0" cellspacing="0" class="tableFreeForm">
        ...
        <tr>
          ...
          <td  align=left width="500">&nbsp;<select <?php genSelectHtml($schema["docstatus"],array("loadenumdocstatus","",":[All]"),null,null,null,"width:200px") ?> ></select></td>
        </tr>
         ...
         <tr>
          ...
          <td><label <?php genCaptionHtml($schema["u_businessnature"],"") ?>>Business Nature</label></td>
...
<div class="tabbertab" title="Business Name">
    ...
    <div class="tabbertab" title="Business Address">
        ...
        <tr>
          <td width="250" align=left><input type="text" size="50" <?php genInputTextHtml($schema["u_businessaddress"]) ?> /></td>
        </tr>
        <tr class="fillerRow5px">
          <td align=left></td>
        </tr>
