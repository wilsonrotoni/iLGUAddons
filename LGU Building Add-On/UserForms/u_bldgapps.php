<tr><td>
	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>    <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_bdlgcategory") ?>>Building Applications</label></td>
                        <td >&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_bdlgcategory",null,null,null,null, null) ?>></select></td>
                ...
                <tr>
                    <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_zoningappno") ?>>Zoning Application No</label></td>
                    <td>&nbsp;<input type="text" size="20" <?php $page->businessobject->items->userfields->draw->text("u_zoningappno") ?>/></td>
                ...
                <tr>
				 <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_withannualinspection") ?>>Annual Inspection</label></td>
					<td >&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_withannualinspection",null,null,null,null, null) ?>></select></td>
                ...
                <tr> 
					<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_withoccupational") ?>>Occupancy Permit</label></td>
                    <td >&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_withoccupational",null,null,null,null, null) ?>></select></td>
                        ...
                        <div class="tabber" id="tab1">
                                <div class="tabbertab" title="General">
                                        <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td ><label class="lblobjs"><b>Building Assessment</b></td>
                                                <td>&nbsp;</td>
                                ...
                                <div class="tabbertab" title="Building Permit">
                                    <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td width="700"><?php $objGrids[1]->draw(true); ?></td>
                                                <td ></td>
                                            </tr>
                                    </table>
                                ...
                                <div class="tabbertab" title="Mechanical">
                                    <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td width="700"><?php $objGrids[7]->draw(true); ?> </td>
                                ...
                                <div class="tabbertab" title="Plumbing">
                                     <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td width="700"><?php $objGrids[3]->draw(true); ?> </td>
                                                <td ></td>
                                            </tr>
                                    </table>
                                </div>
                                <div class="tabbertab" title="Electrical">
                                    <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td width="700"><?php $objGrids[9]->draw(true); ?> </td>
                                ...
                                <div class="tabbertab" title="Signage">
                                     <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td width="700"><?php $objGrids[5]->draw(true); ?> </td>
                                                <td ></td>
                                            </tr>
                                    </table>
                                </div>
...
<!--                                <div class="tabbertab" title="Assessment">
 ...
 <?php $page->resize->addgridobject($objGrids[1], 900, 300) ?>
 <?php $page->resize->addgridobject($objGrids[2], 900, 300) ?>
 <?php $page->resize->addgridobject($objGrids[3], 900, 300) ?>
 <?php $page->resize->addgridobject($objGrids[4], 900, 300) ?>
 <?php $page->resize->addgridobject($objGrids[5], 900, 300) ?>

 <?php // $page->resize->addgridobject($objGrids[6], 1300, 300) ?>
 <?php $page->resize->addgridobject($objGrids[7], 1300, 300) ?>
 <?php // $page->resize->addgridobject($objGrids[8], 1300, 300) ?>
 <?php $page->resize->addgridobject($objGrids[9], 1300, 300) ?>
 <?php // $page->resize->addgridobject($objGrids[10], 1300, 300) ?>
