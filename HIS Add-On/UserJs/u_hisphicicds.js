			...
			switch (column) {
				...
				case "name":
					if (getTableInput(table,column)!="") {
						if (column=="code") result = page.executeFormattedQuery("select code, name from u_hisicds where code='"+getTableInput(table,column)+"'");	 
						else result = page.executeFormattedQuery("select code, name from u_hisicds where name='"+getTableInput(table,column)+"'");	 
