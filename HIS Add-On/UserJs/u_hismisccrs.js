...
function onPageSubmitGPSHIS(action) {
	if (action=="a" || action=="sc") {
		...
		if (isInputEmpty("u_issueno")) return false;
			...
			switch(column) {
				...
				case "u_issueno":
					...
					if (getInput("u_issueno")!="") {
						result = page.executeFormattedQuery("select a.u_department, a.u_reftype, a.u_refno, a.u_patientid, a.u_patientname, a.u_pricelist, a.u_disccode, a.u_scdisc, a.u_disconbill, a.u_amount, a.u_vatamount as u_hdrvatamount, a.u_discamount, a.u_prepaid, a.u_payrefno from u_hismiscs a where a.docno='"+getInput("u_issueno")+"' and a.docstatus not in ('CN') ");
						if (result.getAttribute("result")!= "-1") {
							if (parseInt(result.getAttribute("result"))>0) {
...
function onElementCFLGetParamsGPSHIS(Id,params) {
	switch (Id) {
		case "df_u_itemcodeT1":
			params["params"] = "&cflquery="+utils.replaceSpecialChar(Base64.encode("select b.u_itemcode, b.u_itemdesc, b.u_quantity, b.u_crqty, b.u_uom from u_hismiscs a, u_hismiscitems b where b.company=a.company and b.branch=a.branch and b.docid=a.docid and b.u_itemdesc not in ("+getTableInputGroupConCat("T1","u_itemdesc")+") and  a.docno='"+getInput("u_issueno")+"' and a.u_department='"+getInput("u_department")+"' and a.docstatus not in ('CN') "));
			...
			break;
		case "df_u_itemdescT1":
			params["params"] = "&cflquery="+utils.replaceSpecialChar(Base64.encode("select b.u_itemdesc, b.u_itemcode, b.u_quantity, b.u_crqty, b.u_uom from u_hismiscs a, u_hismiscitems b where b.company=a.company and b.branch=a.branch and b.docid=a.docid and b.u_itemdesc not in ("+getTableInputGroupConCat("T1","u_itemdesc")+") and  a.docno='"+getInput("u_issueno")+"' and a.u_department='"+getInput("u_department")+"' and a.docstatus not in ('CN') "));
		...
		case "df_u_issueno":
			if (getInput("u_department")!="") {
				params["params"] = "&cflquery="+utils.replaceSpecialChar(Base64.encode("select docno, u_startdate, u_patientname from u_hismiscs where u_department='"+getInput("u_department")+"'  and docstatus not in ('CN')")); 
				...
				params["params"] = "&cflquery="+utils.replaceSpecialChar(Base64.encode("select docno, u_startdate, u_department, u_patientname from u_hismiscs where docstatus not in ('CN')")); 
		...
		case "df_u_itemdescT1":
			...
			if (items.length>1) {
				...
				if (Id=="df_u_itemcodeT1") {
					result = page.executeFormattedQuery("select b.u_itemcode, b.u_itemdesc, b.u_quantity-b.u_crqty as u_quantity, b.u_uom, b.u_scdiscamount, b.u_discperc, b.u_unitprice, b.u_price, b.u_vatcode, b.u_vatrate from u_hismiscs a, u_hismiscitems b where b.company=a.company and b.branch=a.branch and b.docid=a.docid and b.u_itemcode in ('"+values+"') and b.u_crqty<b.u_quantity and a.docno='"+getInput("u_issueno")+"' and a.u_department='"+getInput("u_department")+"' and a.docstatus not in ('CN') ");			
				} else {
					result = page.executeFormattedQuery("select b.u_itemcode, b.u_itemdesc, b.u_quantity-b.u_crqty as u_quantity, b.u_uom, b.u_scdiscamount, b.u_discperc, b.u_unitprice, b.u_price, b.u_vatcode, b.u_vatrate from u_hismiscs a, u_hismiscitems b where b.company=a.company and b.branch=a.branch and b.docid=a.docid and b.u_itemdesc in ('"+values+"') and b.u_crqty<b.u_quantity and a.docno='"+getInput("u_issueno")+"' and a.u_department='"+getInput("u_department")+"' and a.docstatus not in ('CN') ");			
				}
				if (result.getAttribute("result")!= "-1") {
