<tr><td>
	...
	<tr>
	  ...
	  <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_issueno") ?>>Issue No.</label></td>
		<td  align=left>&nbsp;<input type="text" size="15" <?php $page->businessobject->items->userfields->draw->text("u_issueno") ?>/></td>
	  </tr>
	<tr>
