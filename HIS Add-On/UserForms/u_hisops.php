<tr><td>
	...
	<tr>
	  ...
	  <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_startdate") ?>>Arrival Date /</label><label <?php $page->businessobject->items->userfields->draw->caption("u_starttime") ?>>Time</label></td>
	...
	<tr>
	  <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_assistedby") ?>>Assisting Clerk</label></td>
	  <td  align=left>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_assistedby") ?>></select></td>
	  
	  <td ><?php if ($page->getitemstring("u_expired")==1 && $formSubmitActionReturn) {?><label <?php $page->businessobject->items->userfields->draw->caption("u_expiredate") ?>>Expire Date / </label><label <?php $page->businessobject->items->userfields->draw->caption("u_expiretime") ?>>Time</label><?php } ?></td>
	...
	<tr>
	  <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_department") ?>>Department</label></td>
	  <td  align=left>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_department",array("loadudflinktable","u_hissections:code:name:u_type in ('OP','ER','IP','DIALYSIS','PMR','DIETARY','NURSE','ADMITTING')",":")) ?>></select></td>
...
<tr><td>
		...
		<div class="tabbertab" title="Diagnosis">	
			...
			<table class="tableFreeForm" width="100%" border="0" cellpadding="0" cellspacing="0" >
				...
				<tr>
				  ...
				  <td colspan="2" rowspan="2" valign="top">&nbsp;<TEXTAREA <?php $page->businessobject->items->userfields->draw->textarea("u_complaint") ?>rows="2" cols="50"><?php echo $page->getitemstring("u_complaint"); ?></TEXTAREA></td>
				  <td>&nbsp;</td>
				  <td  align=left>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
			      ...
			      <textarea cols="50" <?php $page->businessobject->items->userfields->draw->textarea("u_pastmedhistory") ?>rows="2"><?php echo $page->getitemstring("u_pastmedhistory"); ?></textarea></td>
                  <td>&nbsp;</td>
				  <td  align=left>&nbsp;</td>
			  </tr>
				<tr>
              ...
              <?php if ($_SESSION["roleid"]=="DOCTOR") { ?>
				<tr>
				  <td><label <?php $page->businessobject->items->userfields->draw->caption("u_historyillness") ?>>History Illness</label></td>
				  <td colspan="2" rowspan="2" valign="top">&nbsp;<TEXTAREA <?php $page->businessobject->items->userfields->draw->textarea("u_historyillness") ?>rows="2" cols="50"><?php echo $page->getitemstring("u_historyillness"); ?></TEXTAREA></td>
				                    <td  align=left>&nbsp;</td>
				  <td  align=left>&nbsp;</td>
			  </tr>
				<tr>
              ...
              <?php } ?>
 				<tr>
				  <td><label <?php $page->businessobject->items->userfields->draw->caption("u_recommendation") ?>>Recommendation</label></td>
				  <td colspan="2" rowspan="2" valign="top">&nbsp;<TEXTAREA <?php $page->businessobject->items->userfields->draw->textarea("u_recommendation") ?>rows="2" cols="50"><?php echo $page->getitemstring("u_recommendation"); ?></TEXTAREA></td>
				  <td>&nbsp;<label class="lblobjs"><b>Incident Details:</b></label></td>
				  <td>&nbsp;</td>
			  </tr>
				<tr>
				  <td>&nbsp;</td>
				  <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_noi") ?>>Nature</label></td>
              		<td  align=left>&nbsp;<input type="text" size="20" <?php $page->businessobject->items->userfields->draw->text("u_noi") ?>/></td>
			  </tr>
              
				<tr>
				  <td valign="top" ><label <?php $page->businessobject->items->userfields->draw->caption("u_remarks") ?>>Initial Diagnosis</label></td>
				  <td colspan="2" rowspan="2" valign="top">&nbsp;<TEXTAREA <?php $page->businessobject->items->userfields->draw->textarea("u_remarks") ?>rows="2" cols="50"><?php echo $page->getitemstring("u_remarks"); ?></TEXTAREA></td>
                  <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_toi") ?>>Time</label></td>
              		<td  align=left>&nbsp;<input type="text" size="20" <?php $page->businessobject->items->userfields->draw->text("u_toi") ?>/></td>
			  </tr>
				<tr>
				  <td valign="top" >&nbsp;</td>
				  <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_doi") ?>>Date</label></td>
              		<td  align=left>&nbsp;<input type="text" size="20" <?php $page->businessobject->items->userfields->draw->text("u_doi") ?>/></td>
			  </tr>
				<tr>
				  <td valign="top" ><label <?php $page->businessobject->items->userfields->draw->caption("u_remarks2") ?>>Final Diagnosis</label></td>
				  <td colspan="2" rowspan="2" valign="top">&nbsp;<TEXTAREA <?php $page->businessobject->items->userfields->draw->textarea("u_remarks2") ?>rows="2" cols="50"><?php echo $page->getitemstring("u_remarks2"); ?></TEXTAREA></td>
				  <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_poi") ?>>Place</label></td>
              		<td  align=left>&nbsp;<input type="text" size="20" <?php $page->businessobject->items->userfields->draw->text("u_poi") ?>/></td>
			  </tr>
				<tr>
				  <td valign="top" >&nbsp;</td>
				  <td>&nbsp;</td>
				...
				<tr>
				  <td><label <?php $page->businessobject->items->userfields->draw->caption("u_orproc") ?>>Operations/Procedures</label></td>
				  <td colspan="2" rowspan="2" valign="top">&nbsp;<TEXTAREA <?php $page->businessobject->items->userfields->draw->textarea("u_orproc") ?>rows="2" cols="50"><?php echo $page->getitemstring("u_orproc"); ?></TEXTAREA></td>
				  <td  align=left>&nbsp;</td>
				  <td  align=left>&nbsp;</td>
			  </tr>
				<tr>
  ...
  <table class="tableFreeForm" width="100%" border="0" cellpadding="0" cellspacing="0" >
		...
		<td  align=left colspan="2">&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_doctorid") ?>></select></td>
			  ...
			  <td  align=left width="168">&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_doctorservice") ?>></select></td>
			  </tr>
			</table>
		  </div>
		</div>
		<div class="tabbertab" title="Vital Signs">	
			<div id="divvs" style="overflow:auto;">
				<table class="tableFreeForm" width="100%" border="0" cellpadding="0" cellspacing="0" >
					
					<tr>
					  <td width="168" >&nbsp;<label class="lblobjs"><b>Vital Signs:</b></label></td>
		...
		<div class="tabbertab" title="Informant/Health Benefits">	
            <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td width="96" ><label <?php $page->businessobject->items->userfields->draw->caption("u_informantrelationship") ?>>Relationship</label></td>
                  <td >&nbsp;<input type="text" size="50" <?php $page->businessobject->items->userfields->draw->text("u_informantrelationship") ?>/></td>
                  <td width="72" >&nbsp;</td>
                  <td width="136" >&nbsp;</td>
                </tr>  
                <tr>
                  ...
                  <td >&nbsp;<input type="text" size="50" <?php $page->businessobject->items->userfields->draw->text("u_informantaddress") ?>/></td>
		...
		<div class="tabbertab" title="Billing">	
	        <div class="tabber" id="tab1-2">
              ...
              <td  align=left>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_disccode") ?>></select></td>
                              <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_billtermby") ?>>Checked By</label></td>
...
<?php $page->resize->addtab("tab1",-1,242); ?>
<?php $page->resize->addtabpage("tab1","diagnosis"); ?>
<?php $page->resize->addtabpage("tab1","vs"); ?>
...
<?php //$page->resize->addgridobject($objGrids[1],20,220) ?>		
...
<?php $page->resize->addgridobject($objGrids[7],38,391) ?>
<?php $page->resize->addgridobject($objGrids[8],30,289) ?>
<?php $page->resize->addgridobject($objGrids[10],30,324) ?>
<?php $page->resize->addgridobject($objGrids[11],20,244) ?>		
<?php $page->resize->addgridobject($objGrids[12],30,344) ?>	
<?php $page->resize->addgridobject($objGrids[13],30,344) ?>	
<?php if ($page->getvarstring("formType")!="lnkbtn" &&  $_SESSION["roleid"]=="DOCTOR") $page->resize->addinput("u_complaint",550,-1) ;//-1?>	
<?php if ($page->getvarstring("formType")!="lnkbtn" &&  $_SESSION["roleid"]=="DOCTOR") $page->resize->addinput("u_pastmedhistory",550,-1) ?>	
<?php if ($page->getvarstring("formType")!="lnkbtn") $page->resize->addinput("u_orproc",550,-1) ;//-1?>	
<?php if ($page->getvarstring("formType")!="lnkbtn" &&  $_SESSION["roleid"]=="DOCTOR") $page->resize->addinput("u_historyillness",550,-1) ?>	
<?php if ($page->getvarstring("formType")!="lnkbtn") $page->resize->addinput("u_recommendation",550,-1) ?>	
<?php if ($page->getvarstring("formType")!="lnkbtn") $page->resize->addinput("u_remarks",550,-1) ;//-1?>	
<?php if ($page->getvarstring("formType")!="lnkbtn") $page->resize->addinput("u_remarks2",550,418) ;//-1?>	
<?php if ($page->getvarstring("formType")!="lnkbtn") $page->resize->addinput("u_medication",220,287) ;//-1?>	
<?php if ($page->getvarstring("formType")!="lnkbtn") $page->resize->addinput("u_finalhistoryillness",210,-1) //384 ?>	
<?php if ($page->getvarstring("formType")!="lnkbtn") $page->resize->addinput("u_finalremarks",210,454) ?>	
<?php if ($page->getvarstring("formType")!="lnkbtn") $page->resize->addinput("u_icddesc",350,-1) ?>	
<?php if ($page->getvarstring("formType")!="lnkbtn") $page->resize->addinput("u_rvsdesc",350,-1) ?>	
