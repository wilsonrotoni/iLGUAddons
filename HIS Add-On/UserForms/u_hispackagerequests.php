<tr><td>
	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
	  ...
	  <td  align=left>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_requestdepartment",array("loadudflinktable","u_hissections:code:name:u_type in ('OP','IP','NURSE')","")) ?>/></select></td>
	...
	<tr><td ><label <?php $page->businessobject->items->userfields->draw->caption("u_reftype") ?>>Reference Type /</label><label <?php $page->businessobject->items->userfields->draw->caption("u_refno") ?>>No.</label></td>
	  ...
	  <td align=left>&nbsp;<input type="text" size="8" <?php $page->businessobject->items->userfields->draw->text("u_requestdate") ?>/>&nbsp;<input type="text" size="5" <?php $page->businessobject->items->userfields->draw->text("u_requesttime") ?>/></td>
	</tr>
	<tr>
	  ...
	  <td align=left>&nbsp;<input type="text" size="8" <?php $page->businessobject->items->userfields->draw->text("u_duedate") ?>/>&nbsp;<input type="text" size="5" <?php $page->businessobject->items->userfields->draw->text("u_duetime") ?>/></td>
	  </tr>
	<tr>
	...
	<tr>
	  <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_packagecode") ?>>Package</label></td>
	  <td  align=left>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_packagecode") ?>/></select></td>
...
<tr><td>
	<div class="tabber" id="tab1">
		...
		<div class="tabbertab" title="Request Documents">	
...
<?php if (!isEditMode()) $page->resize->addgridobject($objGrids[0],20,349);
	 else $page->resize->addgridobject($objGrids[0],20,308); ?>		
<?php //$page->resize->addgridobject($objGrids[1],20,339) ?>		
<?php $page->resize->addgridobject($objGrids[1],20,308) ?>		
<?php $page->resize->addgridobject($objGrids[2],20,308) ?>		
