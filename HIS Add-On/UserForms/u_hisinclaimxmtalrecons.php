<tr><td>
	...
	<td>&nbsp;<input type="text" size="18" <?php $page->businessobject->items->userfields->draw->text("u_refno") ?>/></td></tr>
	<tr>
	...
	<td><?php $page->businessobject->items->userfields->draw->lnkbtn("u_xmtalno","","OpenLnkBtnu_hisinclaimxmtals()") ?><input type="text" size="18" <?php $page->businessobject->items->userfields->draw->text("u_xmtalno") ?>/></td>
	  </tr>
	<tr>
	  <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_startdate") ?>>Date From</label></td>
		<td>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_startdate") ?>/><label <?php $page->businessobject->items->userfields->draw->caption("u_enddate") ?>>To</label>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_enddate") ?>/></td>
	   <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_claimstatus") ?>>Status</label></td>
	<td >&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_claimstatus") ?>></select></td>
	  </tr>
	</table>
</td></tr>	
