<tr><td>
	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
	  ...
	  <td  align=left>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_department",array("loadudflinktable",iif($page->getvarstring("formType")=="lnkbtn","u_hissections:code:name","u_hissections:code:name:u_type in ('".$page->getitemstring("u_trxtype") . "','ER"."')"),":")) ?>/></select></td>
...
<?php $page->resize->addgridobject($objGrids[0],20,298) ?>		
