<tr><td>
	...
	<tr>
		<td width="168" ><label <?php $page->businessobject->items->draw->caption("code") ?> >Package Code</label></td>
...
<tr><td>
	...
	<tr>
		<td width="168" >&nbsp;</td>
		<td  align=left>&nbsp;</td>
		<td width="168" ><label <?php $page->businessobject->items->userfields->draw->caption("u_price") ?> >Total Price</label></td>
		<td  width="168" align=left>&nbsp;<input type="text" <?php $page->businessobject->items->userfields->draw->text("u_price") ?>/></td>
	</tr>
	</table>
</td></tr>	
<?php //$page->resize->addtab("tab1",-1,301); ?>
<?php //$page->resize->addtabpage("tab1","udf") ?>
<?php $page->resize->addgridobject($objGrids[0],0,195) ?>				
