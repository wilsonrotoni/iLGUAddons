...
$objGrid->columncfl("u_barangay","OpenCFLfs()");
$objGrid->columncfl("u_city","OpenCFLfs()");
$objGrid->columncfl("u_province","OpenCFLfs()");
$objGrid->columnwidth("code",40);
$objGrid->columnwidth("u_street",30);
$objGrid->columnwidth("u_city",20);
$objGrid->columnwidth("u_province",20);
$objGrid->columnwidth("u_zip",6);
$objGrid->columnvisibility("name",false);
$objGrid->columnvisibility("u_barangay",false);
$objGrid->columnvisibility("u_address",false);
