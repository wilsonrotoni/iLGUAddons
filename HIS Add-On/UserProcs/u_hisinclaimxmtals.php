...
function onBeforeDefaultGPSHIS() { 
	...
	$data["u_insname"] = $page->getitemstring("u_insname");
...
function onAfterDefaultGPSHIS() { 
	...
	$page->setitem("u_insname",$data["u_insname"]);
	...
	if ($page->getitemstring("u_package")=="0") {
		...
		if ($page->getitemstring("u_membergroup")!="") {
			$objRs->queryopen("select 'BILLINS' as U_DOCTYPE, a.DOCNO, a.U_DOCDATE, a.U_INSCODE AS U_GUARANTORCODE, a.U_PATIENTID, a.U_PATIENTNAME, a.U_GENDER, a.U_AGE, a.U_MEMBERID, a.U_MEMBERNAME, a.U_MEMBERTYPE, a.U_STARTDATE, a.U_ENDDATE, a.U_ICDCODE, sum(b.U_INSAMOUNT) as U_PNAMOUNT from u_hisinclaims a, u_hisinclaimhfs b, u_hishealthinmemtypes c where c.code=a.u_membertype and c.u_group='".$page->getitemstring("u_membergroup")."' and b.company=a.company and b.branch=a.branch and b.docid=a.docid and a.company='".$_SESSION["company"]."' and a.branch='".$_SESSION["branch"]."' and a.DOCSTATUS NOT IN ('CN','D') and a.U_HMO NOT IN (2,7) and a.u_xmtalno='' $filterExp2 group by a.DOCNO union all select 'BILLPNS' as U_DOCTYPE, a.DOCNO, a.U_DOCDATE, a.U_GUARANTORCODE, a.U_PATIENTID, a.U_PATIENTNAME, a.U_GENDER, a.U_AGE, a.U_MEMBERID, a.U_MEMBERNAME, a.U_MEMBERTYPE, a.U_STARTDATE, a.U_ENDDATE, a.U_ICDCODE, if(a.U_TYPE='Debit Memo',a.U_PNAMOUNT*-1,a.U_PNAMOUNT) as U_PNAMOUNT, a.U_REMARKS from u_hispronotes a, u_hishealthinmemtypes c where c.code=a.u_membertype and c.u_group='".$page->getitemstring("u_membergroup")."' and a.company='".$_SESSION["company"]."' and a.branch='".$_SESSION["branch"]."' and a.U_MIGRATED=0 and a.DOCSTATUS NOT IN ('CN','D') and a.U_HMO NOT IN (2,7) and a.u_xmtalno='' $filterExp union all select 'POS' as U_DOCTYPE, a.DOCNO, a.U_DOCDATE, b.U_INSCODE AS U_GUARANTORCODE, a.U_PATIENTID, a.U_PATIENTNAME, '' as U_GENDER, 0 as U_AGE, b.U_MEMBERID, b.U_MEMBERNAME, b.U_MEMBERTYPE, '' as U_STARTDATE, '' as U_ENDDATE, '' as U_ICDCODE, b.U_AMOUNT as U_PNAMOUNT, d.NAME AS U_REMARKS from u_hispos a left outer join u_hissections d on d.code=a.u_department, u_hisposins b, u_hishealthinmemtypes c  where c.code=b.u_membertype and c.u_group='".$page->getitemstring("u_membergroup")."' and  b.company=a.company and b.branch=a.branch and b.docid=a.docid and a.company='".$_SESSION["company"]."' and a.branch='".$_SESSION["branch"]."' and a.DOCSTATUS NOT IN ('CN','D') and b.U_HMO NOT IN (2,7) and b.u_xmtalno='' $filterExp3");
		} else {
			$objRs->queryopen("select 'BILLPNS' as U_DOCTYPE, a.DOCNO, a.U_DOCDATE, a.U_GUARANTORCODE, a.U_PATIENTID, a.U_PATIENTNAME, a.U_GENDER, a.U_AGE, a.U_MEMBERID, a.U_MEMBERNAME, a.U_MEMBERTYPE, a.U_STARTDATE, a.U_ENDDATE, a.U_ICDCODE, if(a.U_TYPE='Debit Memo',a.U_PNAMOUNT*-1,a.U_PNAMOUNT) as U_PNAMOUNT, a.U_REMARKS from u_hispronotes a where a.company='".$_SESSION["company"]."' and a.branch='".$_SESSION["branch"]."' and a.U_MIGRATED=0 and a.DOCSTATUS NOT IN ('CN','D') and a.U_HMO NOT IN (2,7) and a.u_xmtalno='' $filterExp
			union all select 'POS' as U_DOCTYPE, a.DOCNO, a.U_DOCDATE, b.U_INSCODE AS U_GUARANTORCODE, a.U_PATIENTID, a.U_PATIENTNAME, '' as U_GENDER, 0 as U_AGE, b.U_MEMBERID, b.U_MEMBERNAME, b.U_MEMBERTYPE, '' as U_STARTDATE, '' as U_ENDDATE, '' as U_ICDCODE, b.U_AMOUNT as U_PNAMOUNT, d.NAME AS U_REMARKS from u_hispos a left outer join u_hissections d on d.code=a.u_department, u_hisposins b where b.company=a.company and b.branch=a.branch and b.docid=a.docid and a.company='".$_SESSION["company"]."' and a.branch='".$_SESSION["branch"]."' and a.DOCSTATUS NOT IN ('CN','D') and b.U_HMO NOT IN (2,7) and b.u_xmtalno='' $filterExp3 union all 
			         select 'BILLINS' as U_DOCTYPE, a.DOCNO, a.U_DOCDATE, a.U_INSCODE AS U_GUARANTORCODE, a.U_PATIENTID, a.U_PATIENTNAME, a.U_GENDER, a.U_AGE, a.U_MEMBERID, a.U_MEMBERNAME, a.U_MEMBERTYPE, a.U_STARTDATE, a.U_ENDDATE, a.U_ICDCODE, SUM(b.U_INSAMOUNT) as U_PNAMOUNT, '' AS U_REMARKS from u_hisinclaims a, u_hisinclaimhfs b where b.company=a.company and b.branch=a.branch and b.docid=a.docid and a.company='".$_SESSION["company"]."' and a.branch='".$_SESSION["branch"]."' and a.DOCSTATUS NOT IN ('CN','D') and a.U_HMO NOT IN (2,7) and a.u_xmtalno='' $filterExp2 group by a.DOCNO  LIMIT 500");
		}	
		// 
	}	
	//var_dump($objRs->sqls);
