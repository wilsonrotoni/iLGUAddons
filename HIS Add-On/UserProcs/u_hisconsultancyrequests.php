...
function onAfterDefaultGPSHIS() { 
	...
	global $calendardate;
	global $u_trxtype;
	$u_hissetupdata = getu_hissetup("U_DFLTIPD,U_DFLTOPD,U_PREPAIDIPPF, U_PREPAIDOPPF");
	$page->setitem("u_trxtype",$u_trxtype);
	if ($calendardate!="") {
		$page->setitem("u_startdate",$calendardate);
		$page->setitem("u_enddate",$calendardate);
	} else {
...
//		$page->setitem("u_endtime",currenttime());
	...
	$page->setitem("u_doctorid",$doctorid);
