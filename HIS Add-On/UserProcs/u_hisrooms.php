...
function onAfterDefaultGPSHIS() { 
	...
	$objGrids[0]->addrow();
	$objGrids[0]->setitem(null,"u_bedno","");
	$objGrids[0]->setitem(null,"u_status","Vacant");
	return true;
}
...
$objGrids[0]->columnattributes("u_status","disabled");
$objGrids[0]->columnattributes("u_refno","disabled");
$objGrids[0]->columnattributes("u_patientname","disabled");
$objGrids[0]->columnattributes("u_date","disabled");
$objGrids[0]->columnattributes("u_time","disabled");
?> 
