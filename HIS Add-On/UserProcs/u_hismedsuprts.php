...
function onAfterDefaultGPSHIS() { 
	...
	global $userreftype;
	global $u_trxtype;
	$u_hissetupdata = getu_hissetup("U_DFLTPHARMADEPT,U_DFLTLABDEPT,U_DFLTPHARMATFS,U_DFLTIPD,U_DFLTOPD,U_STOCKLINK, U_PREPAIDIPMEDSUP, U_PREPAIDOPMEDSUP");
...
$page->businessobject->items->setcfl("u_issueno","OpenCFLfs()");
...
$objGrids[0]->columnattributes("u_price","disabled");
