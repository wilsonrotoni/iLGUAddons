<?php
	...
	function loadu_hislabtesttypertfnotes($p_args = array(),$p_selected="") {
		...
		$obj->queryopen("select CODE, NAME from U_HISLABTESTTYPENOTES where u_type = '$p_args[0]' and u_format='rtf' and u_doctorid in ('$p_args[1]','')  order by NAME");
