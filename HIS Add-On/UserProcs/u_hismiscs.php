...
function onAfterDefaultGPSHIS() { 
	...
	global $userreftype;
	global $u_trxtype;
	$u_hissetupdata = getu_hissetup("U_DFLTPHARMADEPT,U_DFLTLABDEPT,U_DFLTPHARMATFS,U_DFLTPULMONARYDEPT,U_DFLTIPD,U_DFLTOPD,U_STOCKLINK,U_PREPAIDIPMISC,U_PREPAIDOPMISC");
	...
	elseif ($page->getitemstring("u_trxtype")=="PULMONARY") $page->setitem("u_department",$u_hissetupdata["U_DFLTOPD"]);
	...
	$page->privatedata["prepaidip"] = $u_hissetupdata["U_PREPAIDIPMISC"];
	$page->privatedata["prepaidop"] = $u_hissetupdata["U_PREPAIDOPMISC"];
