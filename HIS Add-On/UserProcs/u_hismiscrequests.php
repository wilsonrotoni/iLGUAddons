...
function onAfterDefaultGPSHIS() { 
	...
	global $userreftype;
	global $u_trxtype;
	$u_hissetupdata = getu_hissetup("U_DFLTPHARMADEPT,U_DFLTLABDEPT,U_DFLTPHARMATFS,U_DFLTIPD,U_DFLTOPD,U_STOCKLINK,U_PREPAIDIPMISC,U_PREPAIDOPMISC,U_OPDPRICELIST,U_DFLTOPDISCCODE,U_DFLTOPPAYTERM");
