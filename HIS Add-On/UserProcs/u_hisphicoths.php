...
$objGrid->columnwidth("u_group",50);
$objGrid->columntitle("code","Package");
$objGrid->columnvisibility("name",false);

$objGrid->columnwidth("u_rate",9);
$objGrid->columnwidth("u_pf",9);
$objGrid->columnwidth("u_hc",9);
$objGrid->columntitle("u_rate","Rate");
$objGrid->columntitle("u_pf","PF");
$objGrid->columntitle("u_hc","HCI");
