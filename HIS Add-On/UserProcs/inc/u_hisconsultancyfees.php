...
<input type="hidden" <?php genInputHiddenDFHtml("u_surgeonid") ?> >
<input type="hidden" <?php genInputHiddenDFHtml("u_surgeonrefno") ?> >
<input type="hidden" <?php genInputHiddenDFHtml("u_surgeonfee") ?> >
