...
function onBeforeDefaultGPSHIS() { 
	...
	if (count($refinfo)==2) {
		$objRs->queryopen("select docno from u_hisclinicobs where company='".$_SESSION["company"]."' and branch='".$_SESSION["branch"]."' and u_reftype='".$refinfo[0]."' and u_refno='".$refinfo[1]."'");
...
$page->businessobject->items->seteditable("u_od_ad",false);
