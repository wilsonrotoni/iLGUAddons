...
$objGrid->columnwidth("code",12);
$objGrid->columntitle("code","ICD Code");
$objGrid->columnwidth("name",50);
$objGrid->columntitle("name","Description");

$objGrid->columnwidth("u_allowreferral",7);
$objGrid->columnwidth("u_repeatproc",9);
$objGrid->columnwidth("u_repeatproctype",30);
$objGrid->columntitle("u_allowreferral","Referral");
$objGrid->columnalignment("u_allowreferral","center");
$objGrid->columndataentry("u_allowreferral","type","checkbox");
$objGrid->columndataentry("u_allowreferral","value",1);
$objGrid->columndataentry("u_repeatproc","type","checkbox");
$objGrid->columndataentry("u_repeatproc","value",1);

$objGrid->columnwidth("u_interval",8);
