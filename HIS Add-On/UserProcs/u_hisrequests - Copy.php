...
$objGrids[0]->columnattributes("u_renderedqty","disabled");
...
$objGrids[1]->columnattributes("u_renderedqty","disabled");
...
$objGrids[2]->columnattributes("u_renderedqty","disabled");
...
$objGrids[3]->columnattributes("u_renderedqty","disabled");
/*
$objGrids[3]->columndataentry("u_packagecode","type","label");
$objGrids[3]->columndataentry("u_packageqty","type","label");
$objGrids[3]->columndataentry("u_itemcode","type","label");
$objGrids[3]->columndataentry("u_itemdesc","type","label");
$objGrids[3]->columndataentry("u_quantity","type","label");
$objGrids[3]->columndataentry("u_uom","type","label");
$objGrids[3]->columndataentry("u_qtyperpack","type","label");
$objGrids[3]->columndataentry("u_renderedqty","type","label");
*/
