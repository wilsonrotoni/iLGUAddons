<?php
	...
	if (isEditMode()) {
		...
		$page->businessobject->items->seteditable("u_issueno",false);
	...
	switch ($page->getitemstring("u_trxtype")) {
		case "PHARMACY": $pageHeader = "Pharmacy Issuances - Cash Sales"; break;
		case "LABORATORY": $pageHeader = "Blood Issuances - Cash Sales"; break;
		case "CSR": $pageHeader = "CSR Issuances - Cash Sales"; break;
