<?php
	...
	$page->paging->formid = "./UDP.php?&objectcode=u_hischargelist";
	...
	switch ($page->getitemstring("u_trxtype")) {
		case "RADIOLOGY":
			$pageHeader = "Radiology - Charged/Rendered List";
			break;	
		case "LABORATORY":
			$pageHeader = "Laboratory - Charged/Rendered List";
			break;	
		case "HEARTSTATION":
			$pageHeader = "Heart Station - Charged/Rendered List";
			break;	
		case "PHARMACY":
			$pageHeader = "Pharmacy - Charged/Rendered List";
			break;	
		case "CSR":
			$pageHeader = "CSR - Charged/Rendered List";
			break;	
		case "DIALYSYS":
			$pageHeader = "Dialysis - Charged/Rendered List";
			break;	
		case "PULMONARY":
			$pageHeader = "Pulmonary - Charged/Rendered List";
			break;	
		case "OP":
			$pageHeader = "Out-Patient - Charged/Rendered List";
			break;	
		default:
