<?php
	...
	$page->objectcode = "A/R";
	$page->paging->formid = "./UDP.php?&objectcode=u_ar_grid";
	$page->formid = "./UDO.php?&objectcode=U_YBLIPRS";
	$page->objectname = "A/R Dashboard";
...
<script language="JavaScript">
	...
	function onPageLoad() {
		if (getInput("firstview")=="1") {
			parent.barFrame.location = "../FusionCharts/MySamples/his_ar_graph.php?valopt=" + getInput("valopt")  + "&byopt=" + getInput("byopt") + "&custgroup=" + getInput("custgroup")   + "&dbname=" + getGlobal("dbname") + "&companycode=" + getGlobal("company")  + "&branchcode=" + getInput("branchcode");
		}	
	}
