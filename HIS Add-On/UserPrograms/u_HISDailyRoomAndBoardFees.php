<?php
	...
	$progid = "u_HISDailyRoomAndBoardFees";
	...
	function onFormAction($action) {
		...
		$date=$datefr;
		while ($date<=$dateto) {
			$actionReturn = executeTaskpostroomandboardfeesGPSHIS($date);
...
<tr><td><table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td align=left colspan="2"><label <?php genCaptionHtml($schema_batchpost["datefr"],"") ?> >From:</label>&nbsp;<input type="text" size="15" <?php genInputTextHtml($schema_batchpost["datefr"]) ?> /><label <?php genCaptionHtml($schema_batchpost["dateto"],"") ?> >To:</label>&nbsp;<input type="text" size="15" <?php genInputTextHtml($schema_batchpost["dateto"]) ?> /></td>
		<td >&nbsp;</td>
   	</tr>
