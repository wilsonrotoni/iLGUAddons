<?php
	$progid = "u_hisconsultancyrequestoutlist";
	...
	$page->paging->formid = "./UDP.php?&objectcode=u_hisconsultancyrequestoutlist";
		...
		switch (p_tableId) {
			case "T1":
				//if (getTableInput("T1","docstatus",p_rowIdx)=="O") {
					var targetObjectId = 'u_hisconsultancyrequests';
					OpenLnkBtn(1024,570,'./udo.php?objectcode=u_hisconsultancyrequests' + '' + '&targetId=' + targetObjectId ,targetObjectId);
