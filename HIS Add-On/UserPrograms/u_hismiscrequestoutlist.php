<?php
	$progid = "u_hismiscrequestoutlist";
	...
	$page->paging->formid = "./UDP.php?&objectcode=u_hismiscrequestoutlist";
	$page->formid = "./UDO.php?&objectcode=U_HISMISCS";
		...
		switch (p_tableId) {
			case "T1":
				//if (getTableInput("T1","docstatus",p_rowIdx)=="O") {
					...
					OpenLnkBtn(1024,600,'./udo.php?objectcode=u_hismiscrequests' + '' + '&targetId=' + targetObjectId ,targetObjectId);
...
<td ><?php genTableRowStatusHtml("T1r" . $ctr) ?>&nbsp;<?php echo @$objrs->fields["U_REMARKS"]?>&nbsp;<input type="hidden" <?php genInputHiddenDFHtml("docstatus","T1r" . $ctr) ?> ><input type="hidden" <?php genInputHiddenDFHtml("docno","T1r" . $ctr) ?> ></td>
