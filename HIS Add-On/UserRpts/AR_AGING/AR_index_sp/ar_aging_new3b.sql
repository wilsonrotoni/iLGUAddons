...
DROP PROCEDURE IF EXISTS `ar_aging_new3b` $$
CREATE PROCEDURE `ar_aging_new3b`(
    ...
    IN pi_healthins VARCHAR(50),
    IN pi_feetype VARCHAR(60)
 )
BEGIN
...
CREATE TEMPORARY TABLE  `advjv` (
    ...
    `advancepayment` NUMERIC(18,6) NULL default '0',
    `DOCDATE` varchar(10) NULL default '',
    INDEX `Index_Docno` (`COMPANY`,`BRANCH`,`DOCNO`)
  ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT
    INTO mainfield (COMPANY,BRANCH,BRANCHNAME,BPCODE,BPNAME,BILLTOADDRESS,ITEMCODE,OBJECTCODE,TRXTYPE,DOCNO,
    BPREFNO,
    OTHERDOCNO,
    OTHERTRXTYPE,
    OTHERBPREFNO,
    ...
    SELECT arinvoices.COMPANY,
        ...
        arinvoices.OTHERDOCNO,
        arinvoices.OTHERTRXTYPE,
        arinvoices.OTHERBPREFNO,
        arinvoices.OTHERBPCODE,
        arinvoices.OTHERBPNAME,
        arinvoices.OTHERBPCODE2,
        arinvoices.OTHERBPNAME2,
...
INSERT
    ...
    SELECT arcreditmemos.COMPANY,
        ...
        arcreditmemos.OTHERDOCNO,
        arcreditmemos.OTHERTRXTYPE,
        arcreditmemos.OTHERBPREFNO,
        arcreditmemos.OTHERBPCODE,
        arcreditmemos.OTHERBPNAME,
        arcreditmemos.OTHERBPCODE2,
        arcreditmemos.OTHERBPNAME2,
...
if pi_output='' then
    ...
    FROM mainfield a
         ...
         LEFT OUTER JOIN u_hishealthins hi ON hi.code = a.BPCODE
    ...
    where (pi_custno='' or (pi_custno<>'' and a.BPCODE=pi_custno))
          ...
          and (pi_healthins='' or (pi_healthins<>'' and hi.u_hmo = pi_healthins))
          and (pi_feetype='' or (pi_feetype<>'' and if(pi_feetype = 'Professional Fees', a.OTHERTRXTYPE = pi_feetype, a.OTHERTRXTYPE <> 'Professional Fees')))
...
INSERT
    ...
    SELECT mf.COMPANY,
        ...
        FROM mainfield mf
        INNER JOIN settlements ON mf.COMPANY = settlements.COMPANY AND mf.BRANCH = settlements.BRANCH
                        AND mf.OBJECTCODE = settlements.OBJECTCODE AND mf.BPREFNO = settlements.DOCNO
