...
DROP PROCEDURE IF EXISTS `std_ar_aging_new3b` $$
CREATE PROCEDURE `std_ar_aging_new3b`(
...
INSERT
    ...
    SELECT arcreditmemos.COMPANY, arcreditmemos.BRANCH, arcreditmemos.OBJECTCODE, arcreditmemos.DOCNO,
        ...
        WHERE arcreditmemos.trxtype<>'POS' and arcreditmemos.totalamount > 0 AND arcreditmemos.accttype = ''
...
INSERT
    ...
    SELECT arcreditmemos.COMPANY,
        ...
        WHERE arcreditmemos.trxtype<>'POS'
          and arcreditmemos.totalamount > 0 AND arcreditmemos.accttype = ''
        AND arcreditmemos.docdate <= pi_date
