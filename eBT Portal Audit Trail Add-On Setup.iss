[Setup]
AppId=eBTPortalAuditTrailAddOnSetup
AppName=eBT Portal Audit Trail AddOn Setup
AppVerName=eBT Portal Audit Trail AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalAuditTrailAddOnSetup.exe
Compression=lzma
...
[Files]
Source: Audit Trail Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
