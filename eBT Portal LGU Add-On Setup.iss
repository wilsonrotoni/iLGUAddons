[Setup]
AppId=eBTPortalLGUAddOnSetup
AppName=eBT Portal LGU AddOn Setup
AppVerName=eBT Portal LGU AddOn Setup Version 01.01.10
AppPublisher=GREENPEPPER SOFTWARE INC.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
