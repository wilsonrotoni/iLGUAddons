[Setup]
AppId=eBTPortalFireSafetyAddOnSetup
AppName=eBT Portal Fire Safety AddOn Setup
AppVerName=eBT Portal Fire Safety AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalFireSafetyAddOnSetup.exe
Compression=lzma
...
[Files]
Source: Fire Safety Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
