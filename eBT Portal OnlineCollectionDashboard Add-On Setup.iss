[Setup]
AppId=eBTPortalOnlineCollectionDashboardAddOnSetup
AppName=eBT Portal OnlineCollectionDashboard AddOn Setup
AppVerName=eBT Portal OnlineCollectionDashboard AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalOnlineCollectionDashboardAddOnSetup.exe
Compression=lzma
...
[Files]
Source: OnlineCollectionDashboard Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'OnlineCollectionDashboard Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'OnlineCollectionDashboard';
  AddOnVersion := '1.0.0';
