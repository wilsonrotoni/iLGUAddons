...
//	$schema["u_birthdate"]["cfl"] = "Calendar";
	...
	$objrs->queryopen("select count(*) from u_lguquegroups");
	if ($objrs->queryfetchrow()) {
		if ($page->getitemnumeric("opt2")> $objrs->fields[0] ) $page->setitem("opt2",1);
	}

	$refresh = 3;
	$objrs->queryopen("select name, u_color, u_voicemessage, u_refresh from u_lguquegroups where code='".$page->getitemnumeric("opt2")."'");
	if ($objrs->queryfetchrow()) {
	...
	$speech = "";
	$idx=0;
	$objrs->queryopen("select U_CTR, U_REF from U_LGUQUE WHERE U_GROUP='".$page->getitemnumeric("opt2")."' AND U_DATE='".currentdateDB()."' ORDER BY DOCNO DESC LIMIT 5");
...
//		params["recordselectionformula"] = "{items.ITEMCODE}='A1000'";
	...
	function pressButton(btn) {
		...
		beep();	
		switch (btn) {
			case "1": setCaption("queuegroup","Business Permit"); break;
			case "2": setCaption("queuegroup","Real Property Tax"); break;
			case "3": setCaption("queuegroup","Other Fees"); break;
		}
		setCaption("queueno","");
		try {
			http = getHTTPObject(); 
		...
		<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#000000">
            ...
            <tr>
              <td width="60%" valign="top">
              	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="1" style="background-color:#000000">
                	<tr height="88">
                    	<td align="center" colspan="4"><a href="" onClick="pressButton('1');return false;" class="buttonDialer">Business Permit</a></td>
                    </tr>
                	<tr height="88">
                    	<td align="center" colspan="4"><a href="" onClick="pressButton('2');return false;" class="buttonDialer">Real Property Tax</a></td>
                    </tr>
                	<tr height="88">
                    	<td align="center" colspan="4"><a href="" onClick="pressButton('3');return false;" class="buttonDialer">Other Fees</a></td>
                    </tr>
                	<tr height="88">
                	...
                	<tr height="52">
                    	...
                    	<td align="center" width="50"><a href="" onClick="rePrint();return false;"><img id="reprint" height=40 src="../Addons/GPS/LGU Queueing Tablet Add-On/UserPrograms/Imgs/printer_small.jpg" width=40 align=absbottom border=0></a></td>
                    </tr>
                </table>              
              </td>
              <td width="40%">
