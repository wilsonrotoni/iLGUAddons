[Setup]
AppId=eBTPortalLGUBugueyAddOnSetup
AppName=eBT Portal LGU Buguey AddOn Setup
AppVerName=eBT Portal LGU Buguey AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUBugueyAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Buguey Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
