[Setup]
AppId=eBTPortalQueueingAddOnSetup
AppName=eBT Portal Queueing AddOn Setup
AppVerName=eBT Portal Queueing AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalQueueingAddOnSetup.exe
Compression=lzma
...
[Files]
Source: Queueing Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
