...
function onPrepareEditGPSLGUZoning(&$override,&$filterExp) { 
	return true;
}
...
$objGrid->columnwidth("u_assess",20);
$objGrid->columnwidth("u_encode",20);
$objGrid->columnwidth("u_approve",20);
$objGrid->columndataentry("u_assess","type","checkbox");
$objGrid->columndataentry("u_assess","value",1);
$objGrid->columndataentry("u_encode","type","checkbox");
$objGrid->columndataentry("u_encode","value",1);
$objGrid->columndataentry("u_approve","type","checkbox");
$objGrid->columndataentry("u_approve","value",1);
