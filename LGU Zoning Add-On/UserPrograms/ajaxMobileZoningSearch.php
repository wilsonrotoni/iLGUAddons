<?php
	...
	switch ($_GET["type"]) {
		case "ClearanceInspections":
			...
			$objRs->queryopen("select a.docno, a.u_businessname from u_zoningclrins a inner join u_zoningclrinspectors b on b.code=a.u_inspector and b.u_userid='".$_GET["userid"]."' where a.company='LGU' and a.branch='main' and a.docstatus='O'");
