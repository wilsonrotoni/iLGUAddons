...
//	unset($enumdocstatus["D"],$enumdocstatus["O"],$enumdocstatus["C"],$enumdocstatus["CN"]);
	...
	$page->objectcode = "u_zoningapplicantlist";
	$page->paging->formid = "./UDP.php?&objectcode=u_zoningapplicantlist";
	$page->formid = "./UDO.php?&objectcode=U_ZONINGCLRAPPS";
	$page->objectname = "Zoning Application List";
	...
	if ($page->getitemstring("u_businessname")!="") {
		$search=true;
                ...
                $objrs->queryopenext("select *,CONCAT(
                         ...
                         from U_ZONINGCLRAPPS B WHERE B.COMPANY = '$company' AND B.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
			...
			case "T1":
				if (getInput("opt")=="Print") {
					...
					if (getTableInput("T1","docno",p_rowIdx)!="") {
						...
						return formView(null,"./UDO.php?&objectcode=u_zoningclrapps");
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Zoning Application List&nbsp;</td>
