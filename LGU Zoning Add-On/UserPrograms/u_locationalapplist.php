...
//	$enumdocstatus["FI"]="For Inspection";
	...
	$page->objectcode = "u_locationalapplist";
	$page->paging->formid = "./UDP.php?&objectcode=u_locationalapplist";
	$page->formid = "./UDO.php?&objectcode=U_LOCATIONALCLRAPPS";
	$page->objectname = "Locational Clearance Application List";
...
//	$schema["u_birthdate"]["cfl"] = "Calendar";
	...
	$objGrid->columntitle("u_businessname","Corporation Name");
	...
	$objGrid->columnwidth("u_projname",50);
...
//                $objGrid->columnvisibility("action2",true);
	...
	$filterExp = genSQLFilterString("U_CORPNAME",$filterExp,$httpVars['df_u_businessname'],null,null,true);
	...
	if ($page->getitemstring("u_businessname")!="") {
		$search=true;
                ...
                $objrs->queryopenext("select *,CONCAT(
                         ...
                         from U_LOCATIONALCLRAPPS B WHERE B.COMPANY = '$company' AND B.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
		...
		while ($objrs->queryfetchrow("NAME")) {
			...
			$objGrid->setitem(null,"u_businessname",$objrs->fields["U_CORPNAME"]);
			...
			case "T1":
				if (getInput("opt")=="Print") {
					...
					if (getTableInput("T1","docno",p_rowIdx)!="") {
						...
						return formView(null,"./UDO.php?&objectcode=u_locationalclrapps");
	...
	function formSearchNow() {
		...
		if (isPopupFrameOpen('popupFrameCheckPrintedStatus')) {
			...
			return false;
                ...
                if(getInput("acctno")=="" && getInput("docno")=="" &&  getInput("u_appdatefr")=="" &&  getInput("u_businessnature")==""  &&  getInput("u_appdateto")=="" &&  getInput("u_projname")=="" &&  getInput("u_businessname")=="" &&  getInput("u_lastname")=="" &&  getInput("u_firstname")=="" && getInput("u_middlename")=="" && getInput("u_bunitno")=="" && getInput("u_bfloorno")=="" && getInput("u_bvillage")=="" && getInput("u_bstreet")=="" && getInput("u_bblock")=="" && getInput("u_bbrgy")=="" && getInput("u_bbldgname")==""&& getInput("u_baddressno")==""&& getInput("u_bphaseno")==""&& getInput("u_blotno")==""){
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Locational Clearance Application List&nbsp;</td>
...
<div class="tabbertab" title="Project Name">
    <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
        
        <tr>
          <td width="250" align=left><input type="text" size="50" <?php genInputTextHtml($schema["u_projname"]) ?> /></td>
        </tr>
        <tr class="fillerRow5px">
          <td align=left></td>
        </tr>
...
<div class="tabbertab" title="Corporation Name">
    <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
