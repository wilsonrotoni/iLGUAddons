<?php
	...
	switch ($_GET["type"]) {
		case "FSIns":
			...
			$objRs->queryopen("select a.docno, a.u_gi_businessname from u_fsins a inner join u_fsinspectors b on b.code=a.u_inspector and b.u_userid='".$_GET["userid"]."' where a.company='LGU' and a.branch='main' and a.docstatus='O'");
