<tr><td>
	...
	<tr>
	  <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_ownerrep") ?>>Name of Owner</label></td>
            <td>&nbsp;<input type="text" size="50" <?php $page->businessobject->items->userfields->draw->text("u_ownerrep") ?>/></td>
	   <td>&nbsp;</td>
            <td>&nbsp;</td>
	  </tr>	
	<tr>
	  <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_classification") ?>>Nature of Business</label></td>
            <td>&nbsp;<input type="text" size="40" <?php $page->businessobject->items->userfields->draw->text("u_classification") ?>/></td>
	   <td>&nbsp;</td>
            <td>&nbsp;</td>
	  </tr>	
        <tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_contactno") ?>>Contact No</label></td>
        ...
        <tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_orfcamt") ?>>Fire Code fees</label></td>
            ...
            <td>&nbsp;</td>
					...
					<tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_address") ?>>Business Address</label></td>
