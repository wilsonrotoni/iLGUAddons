[Setup]
AppId=eBTPortalPMRSMobileAddOnSetup
AppName=eBT Portal PMRS Mobile AddOn Setup
AppVerName=eBT Portal PMRS Mobile AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalPMRSMobileAddOnSetup.exe
Compression=lzma
...
[Files]
Source: PMRS Mobile Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
