<tr><td>
	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<td width="200" align=left>&nbsp;<input type="text" size="21" <?php $page->businessobject->items->draw->text("docno") ?> /></td>
	</tr>
	...
	<div class="tabber" id="tab1">
		<div class="tabbertab" title="G/L Accounts">	
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" >
                <tr><td width="130" >&nbsp;<label class="lblobjs"><b>Stale Check:</b></label></td>
                    <td >&nbsp;</td>
                    <td >&nbsp;</td>
                    <td >&nbsp;</td>
                    <td >&nbsp;</td>
                ...
                <tr> <td width="130" ><label <?php $page->businessobject->items->userfields->draw->caption("u_stalecheckbank") ?>>Bank</label></td>
                    <td >&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_stalecheckbank",array("loadhousebanksbycountry",$_SESSION["branch"].":PH",":")) ?>></select></td>
            ...
            <td width="168">&nbsp;<input type="text" size="4" <?php $page->businessobject->items->userfields->draw->text("u_lvatperc") ?>/><label <?php $page->businessobject->items->userfields->draw->caption("u_lvatperc") ?>>%</label>&nbsp;<input type="text" size="8" <?php $page->businessobject->items->userfields->draw->text("u_lvatamount") ?>/>&nbsp;<input type="text" size="9" <?php $page->businessobject->items->userfields->draw->text("u_lbaseamount") ?>/></td>
                ...
                <tr> <td width="130" ><label <?php $page->businessobject->items->userfields->draw->caption("u_stalecheckbankacctno") ?>>Bank Account No.</label></td>
                    <td >&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_stalecheckbankacctno",array("loadhousebankaccounts",$_SESSION["branch"].":PH:".$page->getitemstring("u_stalecheckbank"),"")) ?>></select></td>
            ...
            <td width="168">&nbsp;<input type="text" size="4" <?php $page->businessobject->items->userfields->draw->text("u_levatperc") ?>/><label <?php $page->businessobject->items->userfields->draw->caption("u_levatperc") ?>>%</label>&nbsp;<input type="text" size="8" <?php $page->businessobject->items->userfields->draw->text("u_levatamount") ?>/>&nbsp;<input type="text" size="9" <?php $page->businessobject->items->userfields->draw->text("u_levatbaseamount") ?>/></td>
                ...
                <tr><td><label <?php $page->businessobject->items->userfields->draw->caption("u_stalecheckno") ?>>Check No.</label></td>
                    <td >&nbsp;<input type="text" size="15" <?php $page->businessobject->items->userfields->draw->text("u_stalecheckno") ?>/></td>
            ...
            <td width="168">&nbsp;<input type="text" size="4" <?php $page->businessobject->items->userfields->draw->text("u_levat2perc") ?>/><label <?php $page->businessobject->items->userfields->draw->caption("u_levat2perc") ?>>%</label>&nbsp;<input type="text" size="8" <?php $page->businessobject->items->userfields->draw->text("u_levat2amount") ?>/>&nbsp;<input type="text" size="9" <?php $page->businessobject->items->userfields->draw->text("u_levat2baseamount") ?>/></td>
                ...
                <tr>                  <td width="130" ><label <?php $page->businessobject->items->userfields->draw->caption("u_stalecheckamount") ?>>Amount</label></td>
                    <td >&nbsp;<input type="text" size="15" <?php $page->businessobject->items->userfields->draw->text("u_stalecheckamount") ?>/></td>
<td >&nbsp;</td>
                    <td >&nbsp;</td>
    ...
    <table class="tableFreeForm" width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
          ...
          <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_evat1") ?>>1.) E-VAT Base Amount</label></td>
            <td width="200">&nbsp;<input type="text" size="21" <?php $page->businessobject->items->userfields->draw->text("u_evat1") ?>/></td>
        </tr>
        <tr>
          <td width="168">&nbsp;</td>
