...
<td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_taxdeduction") ?>>Taxes/Retention</label></td>
						<td >&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_taxdeduction") ?>></select></td>
                  <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_lretamount") ?>>3.) Retention Amount</label></td>
            <td width="168">&nbsp;<input type="text" size="4" <?php $page->businessobject->items->userfields->draw->text("u_lretperc") ?>/><label <?php $page->businessobject->items->userfields->draw->caption("u_lretperc") ?>>%</label>&nbsp;<input type="text" size="8" <?php $page->businessobject->items->userfields->draw->text("u_lretamount") ?>/>&nbsp;</td>
                </tr>
					<tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_checkdate") ?>>Check Date</label></td>
                        ...
                        <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_bpcity") ?>>Supplier Address - City</label></td>
						<td>&nbsp;<input type="text" size="15" <?php $page->businessobject->items->userfields->draw->text("u_bpcity") ?>/></td>
                      <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_lbtamount") ?>>3.) Business Tax Amount</label></td>
            <td width="168">&nbsp;<input type="text" size="4" <?php $page->businessobject->items->userfields->draw->text("u_lbtperc1") ?>/><label <?php $page->businessobject->items->userfields->draw->caption("u_lbtperc1") ?>>%&nbsp;x</label>&nbsp;<input type="text" size="4" <?php $page->businessobject->items->userfields->draw->text("u_lbtperc2") ?>/><label <?php $page->businessobject->items->userfields->draw->caption("u_lbtperc2") ?>>%</label>&nbsp;<input type="text" size="9" <?php $page->businessobject->items->userfields->draw->text("u_lbtamount") ?>/>&nbsp;</td>
					</tr>
					<tr>
					  <td>&nbsp;</td>
					  <td>&nbsp;</td>
...
<?php $page->resize->addtab("tab1",-1,331); ?>
<?php $page->resize->addtabpage("tab1","refund") ?>
<?php $page->resize->addgridobject($objGrids[0],20,532) ?>
<?php $page->resize->addgridobject($objGrids[1],20,401) ?>		
<?php $page->resize->addgridobject($objGrids[2],20,379) ?>
<?php $page->resize->addgridobject($objGrids[3],20,387) ?>
<?php $page->resize->addgridobject($objGrids[4],20,387) ?>
