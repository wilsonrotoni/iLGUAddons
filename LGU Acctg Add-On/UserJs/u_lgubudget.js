	...
	switch (table) {
		case "T1":
			switch (column) {
				...
				case "u_rlq4":
					if (row>0) {
						setTableInput(table,"u_rl",utils.round(((getTableInputNumeric(table,"u_rlq1",row)*0.25))+((getTableInputNumeric(table,"u_rlq2",row)*0.25))+((getTableInputNumeric(table,"u_rlq3",row)*0.25))+((getTableInputNumeric(table,"u_rlq4",row)*0.25)),0),row);
						setTableInputAmount(table,"u_rlamt",getTableInputNumeric(table,"u_yr",row)*(getTableInputNumeric(table,"u_rl",row)/100),row);
						setTableInput(table,"u_lstrldate",getGlobal("serverdate"),row);
					} else {
						setTableInput(table,"u_rl",utils.round(((getTableInputNumeric(table,"u_rlq1")*0.25))+((getTableInputNumeric(table,"u_rlq2")*0.25))+((getTableInputNumeric(table,"u_rlq3")*0.25))+((getTableInputNumeric(table,"u_rlq4")*0.25)),0));
						setTableInputAmount(table,"u_rlamt",getTableInputNumeric(table,"u_yr")*(getTableInputNumeric(table,"u_rl")/100));
						setTableInput(table,"u_lstrldate",getGlobal("serverdate"));
					}
					break;
			}
			break;
	...
	switch (table) {
		case "T1":
			switch (column) {
				...
				case "u_rlq3":
				case "u_rlq4":
					if (column=="u_rlq1" && getTableInputNumeric(table,"u_rlq1",row)==0) {
						setTableInput(table,"u_rlq2","0",row);
						setTableInput(table,"u_rlq3","0",row);
						setTableInput(table,"u_rlq4","0",row);
					}
					if (column=="u_rlq2" && getTableInputNumeric(table,"u_rlq2",row)==0) {
						setTableInput(table,"u_rlq3","0",row);
						setTableInput(table,"u_rlq4","0",row);
					}
					if (column=="u_rlq3" && getTableInputNumeric(table,"u_rlq3",row)==0){
						setTableInput(table,"u_rlq4","0",row);
					}
				
					//if (column=="u_rlq2" && getTableInputNumeric(table,"u_rlq1",row)==0) setTableInput(table,"u_rlq2","0",row);
					//if (column=="u_rlq3" && getTableInputNumeric(table,"u_rlq2",row)==0) setTableInput(table,"u_rlq3","0",row);
					//if (column=="u_rlq4" && getTableInputNumeric(table,"u_rlq3",row)==0) setTableInput(table,"u_rlq4","0",row);
					
					if (column=="u_rlq2" && getTableInputNumeric(table,"u_rlq2",row)==1) { 
						setTableInput(table,"u_rlq1","1",row);
					}	
					if (column=="u_rlq3" && getTableInputNumeric(table,"u_rlq3",row)==1) {
						setTableInput(table,"u_rlq1","1",row);
						setTableInput(table,"u_rlq2","1",row);
					}	
					if (column=="u_rlq4" && getTableInputNumeric(table,"u_rlq4",row)==1) {
						setTableInput(table,"u_rlq1","1",row);
						setTableInput(table,"u_rlq2","1",row);
						setTableInput(table,"u_rlq3","1",row);
					}	
	

					if (getTableInputNumeric(table,"u_rlq1",row)==1) rlamt+= getTableInputNumeric(table,"u_q1",row);
					if (getTableInputNumeric(table,"u_rlq2",row)==1) rlamt+= getTableInputNumeric(table,"u_q2",row);
					if (getTableInputNumeric(table,"u_rlq3",row)==1) rlamt+= getTableInputNumeric(table,"u_q3",row);
					if (getTableInputNumeric(table,"u_rlq4",row)==1) rlamt+= getTableInputNumeric(table,"u_q4",row);
					setTableInputAmount(table,"u_rlamt",rlamt,row);
					break;
			}
			break;
	}
...
function onTableSelectRowGPSLGUAcctg(table,row) {
	...
	switch (table) {
		case "T1":
			...
			} else if (elementFocused.substring(0,11)=="df_u_rlq1T1") {
				focusTableInput(table,"u_rlq1",row);
			} else if (elementFocused.substring(0,11)=="df_u_rlq2T1") {
				focusTableInput(table,"u_rlq2",row);
			} else if (elementFocused.substring(0,11)=="df_u_rlq3T1") {
				focusTableInput(table,"u_rlq3",row);
			} else if (elementFocused.substring(0,11)=="df_u_rlq4T1") {
				focusTableInput(table,"u_rlq4",row);
			}
...
function OpenPopupDownloadGPSLGUAcctg() {
	targetObjectId = "";
	targetOptions = "";
	OpenPopup(650,130,'./udp.php?objectcode=u_downloadBudget' + '' + '&targetId=' + targetObjectId + '&targetOptions=' + targetOptions,targetObjectId);
}
