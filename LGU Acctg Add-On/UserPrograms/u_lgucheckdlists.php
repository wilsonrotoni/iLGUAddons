<?php
	$progid = "u_lgucheckdlists";

	$progaccessid = "u_lgucheckds";
	...
	$page->paging->formid = "./UDP.php?&objectcode=u_lgucheckdlists";
	$page->formid = "./UDO.php?&objectcode=U_LGUCHECKDS";
	$page->objectname = "Check Disbursement Lists";
	...
	$objGrid->columntitle("docno","DV No.");
	...
	$objGrid->columnwidth("u_jevno",15);
	...
	*/
	...
	//} else {	
		$objrs->queryopenext("select A.DOCNO, A.U_JEVNO, A.U_BPCODE, A.U_BPNAME, A.U_DATE, A.U_CHECKBANK, A.U_CHECKNO, A.U_CHECKAMOUNT, A.U_DUEAMOUNT, A.U_ADVANCEAMOUNT, A.DOCSTATUS, A.U_REMARKS
			from U_LGUCHECKDS A WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
	//}
	//var_dump($objrs->sqls);
	$page->paging_recordcount($objrs->recordcount());
...
<tr><td><table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
     <td ><label <?php genCaptionHtml($schema["docno"],"") ?>>DV No.</label></td>
