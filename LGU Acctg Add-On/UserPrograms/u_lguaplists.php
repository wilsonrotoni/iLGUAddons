<?php
	...
	$page->paging->formid = "./UDP.php?&objectcode=u_lguaplists";
	$page->formid = "./UDO.php?&objectcode=U_LGUAPS";
	$page->objectname = "Payable Lists";
	...
	$objGrid->columntitle("docno","Payable No.");
	...
	*/
	...
	//} else {	
		$objrs->queryopenext("select A.DOCNO, A.U_JEVNO, A.U_BPCODE, A.U_BPNAME, A.U_DATE, A.U_DUEAMOUNT, A.DOCSTATUS, A.U_REMARKS
			from U_LGUAPS A WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
	//}
	//var_dump($objrs->sqls);
	$page->paging_recordcount($objrs->recordcount());
...
<tr><td><table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
     <td ><label <?php genCaptionHtml($schema["docno"],"") ?>>Payable No.</label></td>
