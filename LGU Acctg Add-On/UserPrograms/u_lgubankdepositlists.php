<?php
	$progid = "u_lgubankdepositlists";

	$progaccessid = "u_lgubankdps";
	...
	$page->paging->formid = "./UDP.php?&objectcode=u_lgubankdepositlists";
	$page->formid = "./UDO.php?&objectcode=U_LGUBANKDPS";
	$page->objectname = "Bank Deposit Lists";
	...
	$objGrid->columnwidth("u_amount",15);
	...
	*/
	...
	//} else {	
		$objrs->queryopenext("select A.DOCNO, A.U_JEVNO, A.U_DATE, A.U_AMOUNT, A.DOCSTATUS, A.U_REMARKS
			from U_LGUBANKDPS A WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
	//}
	//var_dump($objrs->sqls);
	$page->paging_recordcount($objrs->recordcount());
...
<tr><td><table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
     <td ><label <?php genCaptionHtml($schema["docno"],"") ?>>No.</label></td>
