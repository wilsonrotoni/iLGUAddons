<?php
	$progid = "u_lgufundlists";

	$progaccessid = "u_lgufunds";
	...
	$page->paging->formid = "./UDP.php?&objectcode=u_lgufundlists";
	$page->formid = "./UDO.php?&objectcode=U_LGUFUNDS";
	$page->objectname = "Fund Voucher Lists";
	...
	$objGrid->columntitle("docno","Fund Voucher No.");
	...
	*/
	...
	//} else {	
		$objrs->queryopenext("select A.DOCNO, A.U_JEVNO, A.U_BPCODE, A.U_BPNAME, A.U_DATE, A.U_DUEAMOUNT, A.U_ADVANCEAMOUNT, A.DOCSTATUS, A.U_REMARKS
			from U_LGUFUNDS A WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
	//}
	//var_dump($objrs->sqls);
	$page->paging_recordcount($objrs->recordcount());
...
<tr><td><table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
     <td ><label <?php genCaptionHtml($schema["docno"],"") ?>>Fund Voucher No.</label></td>
