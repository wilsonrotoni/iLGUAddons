...
$page->businessobject->items->setcfl("u_refunddate","Calendar");
$page->businessobject->items->setcfl("u_apbpcode","OpenCFLfs()");
$page->businessobject->items->setcfl("u_requestedbyname","OpenCFLfs()");
$page->businessobject->items->setcfl("u_checkdate","Calendar");
$page->businessobject->items->setcfl("u_dateperiod","Calendar");
...
$page->businessobject->items->setvisible("u_profitcentername",false);
...
$objGrids[0]->columnvisibility("u_amount",true);
$objGrids[0]->columncfl("u_profitcenter","OpenCFLfs()");
$objGrids[0]->columnwidth("u_profitcenter",12);
$objGrids[0]->columnwidth("u_profitcentername",25);
//$objGrids[0]->columnattributes("u_amount","disabled");
$objGrids[0]->columncfl("u_remarks","OpenCFLfs()");
...
$objGrids[3]->columncfl("u_osno","OpenCFLfs()");

$objGrids[4]->columndataentry("u_bank","type","select");
$objGrids[4]->columndataentry("u_bank","options",array("loadhousebanksbycountry",$_SESSION["branch"].":PH",":"));
$objGrids[4]->columndataentry("u_bankacctno","type","select");
$objGrids[4]->columndataentry("u_bankacctno","options",array("loadhousebankaccounts",$_SESSION["branch"].":PH",":"));
