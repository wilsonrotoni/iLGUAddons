			...
			switch(column) {
				...
				case "u_jevno":
					if (getInput("u_jevno")!="" && getInput("u_jevno")!="?") {
						...
						if (getInput("u_isjevseries")=="1")	setInput("u_jevno",getGlobal("branch")+"-"+year+"-"+month+"-"+getInput("u_jevseries")+getInput("u_jevno").padL(4,"0"));
						else setInput("u_jevno",getGlobal("branch")+"-"+year+"-"+month+"-"+getInput("u_jevno").padL(4,"0"));
					}
					break;
			}
	}
