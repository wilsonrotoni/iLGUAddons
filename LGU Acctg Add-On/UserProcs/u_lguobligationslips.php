...
$page->businessobject->items->setcfl("u_cancelleddate","Calendar");
...
$page->businessobject->items->setcfl("u_pono","OpenCFLfs()");
$page->businessobject->items->setcfl("u_billno","OpenCFLfs()");
$page->businessobject->items->setcfl("u_adjobrno","OpenCFLfs()");
...
$objGrids[0]->columnwidth("u_glacctname",35);
$objGrids[0]->columnwidth("u_slcode",6);
$objGrids[0]->columnwidth("u_sldesc",25);
