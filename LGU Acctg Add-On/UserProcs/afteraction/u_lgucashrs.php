...
$objRs->queryopen("SELECT U_CASHRENCODER, U_CASHRAPPROVER FROM USERS WHERE USERID='".$_SESSION["userid"]."'");
if ($objRs->queryfetchrow("NAME")) {
	$page->privatedata["encoder"] = $objRs->fields["U_CASHRENCODER"];
	$page->privatedata["approver"] = $objRs->fields["U_CASHRAPPROVER"];
}
