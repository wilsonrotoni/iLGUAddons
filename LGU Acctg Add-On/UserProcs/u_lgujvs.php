...
$objGrids[0]->columndataentry("u_bank","type","select");
$objGrids[0]->columndataentry("u_bank","options",array("loadhousebanksbycountry",$_SESSION["branch"].":PH",":"));
$objGrids[0]->columndataentry("u_bankacctno","type","select");
$objGrids[0]->columndataentry("u_bankacctno","options",array("loadhousebankaccounts",$_SESSION["branch"].":PH",":"));
