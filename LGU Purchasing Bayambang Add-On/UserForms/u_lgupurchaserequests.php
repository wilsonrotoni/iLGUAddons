<tr><td>
    ...
    <tr>        
        ...
        <tr>
          <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_poprofitcenter") ?>>Purchase Order To</label></td>
		<td  align=left>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_poprofitcenter",null,null,null,null,"width:370px") ?>></select></td>
		<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_refno") ?>>Purchase Request No</label></td>
		...
		<td  align=left>&nbsp;</td>
		<td ></td>
		<td align=left>&nbsp;<input type="checkbox" <?php $page->businessobject->items->userfields->draw->checkbox("u_cashavailable",1) ?>/><label <?php $page->businessobject->items->userfields->draw->caption("u_cashavailable") ?>>Cash Available</label></td>
	</tr>
	</table>
</td></tr>
<tr><td>&nbsp;</td></tr>	
...
<?php $page->resize->addgridobject($objGrids[1],20,380) ?>
