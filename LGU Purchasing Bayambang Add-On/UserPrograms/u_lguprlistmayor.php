...
//	$enumdocstatus["Cancelled"]="Cancelled";
	...
	$page->objectcode = "u_lguprlistmayor";
	$page->paging->formid = "./UDP.php?&objectcode=u_lguprlistmayor";
	$page->formid = "./UDO.php?&objectcode=u_lgupurchaserequests";
	$page->objectname = "Purchase Request List - Mayor";
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Purchase Request List - Mayor&nbsp;</td>
