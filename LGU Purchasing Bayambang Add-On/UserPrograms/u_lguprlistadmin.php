...
//	$enumdocstatus["Cancelled"]="Cancelled";
	...
	$page->objectcode = "u_lguprlistadmin";
	$page->paging->formid = "./UDP.php?&objectcode=u_lguprlistadmin";
	$page->formid = "./UDO.php?&objectcode=u_lgupurchaserequests";
	$page->objectname = "Purchase Request List - Admin";
	...
	$objrs->queryopenext("select * from u_lgupurchaserequests  WHERE COMPANY = '$company' AND BRANCH = '$branch' and docstatus = 'D' and u_totalamount <= 200000 and u_refno != '' and u_cashavailable = 1 $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
		//var_dump($objrs->sqls);
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Purchase Request List - Admin&nbsp;</td>
