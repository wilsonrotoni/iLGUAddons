...
//    $page->events->add->afterDefault("onAfterDefault");
    ...
    $page->objectcode = "u_copyfrompr";
    $page->paging->formid = "./UDP.php?&objectcode=u_copyfrompr";
   ...
   function onFormSubmitReturn(action,success,error) {
	...
	for (i = 1; i <= rc; i++) {
		if(getTableInput("T20","rowstat",i) != "X") {
			if(getTableInput("T20","checked",i)=="1") {
			result = page.executeFormattedQuery("SELECT a.branch,b.u_itemcode,b.u_itemdesc,b.u_itemsubgroup,'' as u_glacctno,b.u_unitissue,b.u_openquantity,a.docno,b.lineid,b.docid,'LGU_Purchase Request'as objectcode,a.u_remarks,b.u_unitcost,b.u_cost,b.u_remarks as u_detailremarks  FROM u_lgupurchaserequests a INNER JOIN u_lgupurchaserequestitems b ON b.company = a.company AND b.branch = a.branch AND b.docid = a.docid WHERE a.company='" + getGlobal("company") + "' AND b.u_openquantity != 0 AND a.docno = '"+getTableInput("T20","docno",i)+"' union all SELECT a.branch,'' as u_itemcode,b.u_itemdesc,'' as u_itemsubgroup, b.u_glacctno,b.u_unitissue,b.u_openquantity,a.docno,b.lineid,b.docid,'LGU_Purchase Request'as objectcode,a.u_remarks,b.u_unitcost,b.u_cost,b.u_remarks as u_detailremarks  FROM u_lgupurchaserequests a INNER JOIN u_lgupurchaserequestservice b ON b.company = a.company AND b.branch = a.branch AND b.docid = a.docid WHERE a.company='" + getGlobal("company") + "' AND b.u_openquantity != 0 AND a.docno = '"+getTableInput("T20","docno",i)+"' ");	 			
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Purchase Request List&nbsp;</td>
