<?php
	$progid = "u_lgupurchasedeliverylist";
...
//	$enumdocstatus["Cancelled"]="Cancelled";
	...
	$page->objectcode = "u_lgupurchasedeliverylist";
	$page->paging->formid = "./UDP.php?&objectcode=u_lgupurchasedeliverylist";
	$page->formid = "./UDO.php?&objectcode=u_lgupurchasedelivery";
	$page->objectname = "Purchase Delivery List";
	...
	$objGrid->columnwidth("u_basedocno",15);
	...
	$objrs->queryopenext("select a.*,group_concat(distinct b.u_basedocno) as U_BASEDOCNO from u_lgupurchasedelivery a inner join u_lgupurchasedeliveryitems b on a.company = b.company and a.branch = b.branch and a.docid = b.docid   WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp group by a.docno 
                               UNION ALL 
                              select a.*,group_concat(distinct b.u_basedocno) as U_BASEDOCNO from u_lgupurchasedelivery a inner join u_lgupurchasedeliveryservice b on a.company = b.company and a.branch = b.branch and a.docid = b.docid   WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp group by a.docno  ", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
		//var_dump($objrs->sqls);
		...
		switch (p_tableId) {
			case "T1":
				...
				//} else {
					...
					return formView(null,"./UDO.php?&objectcode=u_lgupurchasedelivery");
				//}	
...
//            OpenPopup(1024,600,"./udo.php?&objectcode=u_rpfaas1&sf_keys="+arpno1+"&formAction=e","UpdPays");
            ...
            OpenPopup(1064,650,"./udo.php?&objectcode=u_lgupurchasedelivery&sf_keys="+targetObjectId+"&formAction=e","UpdPays");
         }
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Purchase Delivery List&nbsp;</td>
