...
//    $page->events->add->afterDefault("onAfterDefault");
    ...
    $page->objectcode = "u_copyfrombiddocinfra";
    $page->paging->formid = "./UDP.php?&objectcode=u_copyfrombiddocinfra";
    $page->formid = "./UDO.php?&objectcode=u_lgureceipts";
    $page->objectname = "Copy From Purchase Request";
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Biddocs Infra List&nbsp;</td>
