<?php
	$progid = "u_lgupurchaserequestlist";
...
//	$enumdocstatus["Cancelled"]="Cancelled";
	...
	$page->objectcode = "u_lgupurchaserequestlist";
	$page->paging->formid = "./UDP.php?&objectcode=u_lgupurchaserequestlist";
	...
	$objGrid->columntitle("u_projcode","APP Code");
	$objGrid->columntitle("u_projname","APP Name");
	...
	$objGrid->columnwidth("u_doctype",10);
	$objGrid->columnwidth("u_profitcenter",10);
	$objGrid->columnwidth("u_projcode",12);
