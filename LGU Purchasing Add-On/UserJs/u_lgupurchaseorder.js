                        ...
                        case "u_profitcenter":
                                if (getInput(column)!="") {
                                        ...
                                        if (result.getAttribute("result")!= "-1") {
                                                if (parseInt(result.getAttribute("result"))>0) {
                                                        setInput("u_profitcenter",result.childNodes.item(0).getAttribute("profitcenter"));
                                                        setInput("u_pdprofitcenter",result.childNodes.item(0).getAttribute("profitcenter"));
                                                        setInput("u_profitcentername",result.childNodes.item(0).getAttribute("profitcentername"));
                                                } else {
                                                        setInput("u_profitcenter","");
                                                        setInput("u_pdprofitcenter","");
                                                        setInput("u_profitcentername","");
...
function CopyFromAwardGPSLGUPurchasing() {
            OpenPopup(1040,390,"./udp.php?&objectcode=u_copyfromaward&df_doctype="+getInput("u_doctype")+"","Copy From Notice of Award");
}
