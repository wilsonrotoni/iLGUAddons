...
function onAfterEditGPSLGUPurchasing() {
    ...
    $objRs->queryopen("SELECT DOCNO,U_STATUS,U_BIDDER,U_BIDAMOUNT,U_BIDSEC,U_BIDCOMPANY,U_ORNO,U_ORDATE,U_BIDSECAMOUNT,U_REQBIDSECAMOUNT,U_ISSUFFICIENT,U_REMARKS FROM u_lgubidabstractasread  WHERE COMPANY='" . $_SESSION["company"] . "' AND BRANCH='" . $_SESSION["branch"] . "' AND U_BIDNO='" . $page->getitemstring("docno") . "' AND U_BIDTYPE = 'GOODS'");
...
$page->businessobject->items->setcfl("u_opt2code","OpenCFLfs()");
$page->businessobject->items->setcfl("u_opt3code","OpenCFLfs()");
$page->businessobject->items->setcfl("u_opt4code","OpenCFLfs()");
...
$objGridA->columntitle("u_status", "Name of Bidder");
