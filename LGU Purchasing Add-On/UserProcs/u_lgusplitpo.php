...
$page->businessobject->items->seteditable("u_obrno",false);
...
$objGrids[0]->columnattributes("u_unitcost","disabled");
...
$objGrids[1]->columnattributes("u_unitcost","disabled");
$objGrids[1]->columncfl("u_glacctno","OpenCFLfs()");

        $pageHeader = "Progress Billing";
