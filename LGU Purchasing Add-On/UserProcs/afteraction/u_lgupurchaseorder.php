<?php
    ...
    $objRs->queryopen("SELECT U_POENCODER,U_POAPPROVER FROM USERS WHERE USERID='".$_SESSION["userid"]."'");
    if ($objRs->queryfetchrow("NAME")) {
            $page->privatedata["encoder"] = $objRs->fields["U_POENCODER"];
            $page->privatedata["approver"] = $objRs->fields["U_POAPPROVER"];
    }
    if ($page->getitemstring("docstatus")=="O") {
            ...
            $page->popup->additem("popupCopyDocumentFrom","Notice of Award","CopyFromAwardGPSLGUPurchasing()");
