<?php
    ...
    $objRs->queryopen("SELECT U_CANVASSINGENCODER,U_CANVASSINGAPPROVER FROM USERS WHERE USERID='".$_SESSION["userid"]."'");
    if ($objRs->queryfetchrow("NAME")) {
            $page->privatedata["encoder"] = $objRs->fields["U_CANVASSINGENCODER"];
            $page->privatedata["approver"] = $objRs->fields["U_CANVASSINGAPPROVER"];
    }
