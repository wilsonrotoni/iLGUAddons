...
$page->businessobject->items->setcfl("u_empid","OpenCFLfs()");
...
$objGrids[0]->columncfl("u_toempid","OpenCFLfs()");
$objGrids[0]->columncfl("u_toprofitcenter","OpenCFLfs()");
$objGrids[0]->columncfl("u_itemcode","OpenCFLfs()");
$objGrids[0]->columncfl("u_itemdesc","OpenCFLfs()");
$objGrids[0]->columnwidth("u_itemcode",18);
$objGrids[0]->columnwidth("u_toempid",15);
$objGrids[0]->columnwidth("u_toempname",30);
$objGrids[0]->columnwidth("u_toprofitcenter",15);
$objGrids[0]->columnwidth("u_toprofitcentername",30);
