<tr><td>
	...
	<tr><td ><label <?php $page->businessobject->items->userfields->draw->caption("u_profitcentername") ?>>*Profit Center Name</label></td>
		...
		<td align=left>&nbsp;<input type="text" size="17" <?php $page->businessobject->items->userfields->draw->text("u_duedate") ?>/></td>
        </tr>
        <tr>
		...
		<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_refno") ?>>Purchase Order No</label></td>
		<td align=left>&nbsp;<input type="text" size="18" <?php $page->businessobject->items->userfields->draw->text("u_refno") ?>/></td>
	</tr>
        <tr>
                <td ></td>
		...
		<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_obrno") ?>>Obligation No</label></td>
		<td align=left>&nbsp;<input type="text" size="18" <?php $page->businessobject->items->userfields->draw->text("u_obrno") ?>/></td>
	</tr>
        <tr>
		...
		<td ></td>
		<td align=left><input type="checkbox" <?php $page->businessobject->items->userfields->draw->checkbox("u_forrecordingonly",1) ?>/><label <?php $page->businessobject->items->userfields->draw->caption("u_forrecordingonly") ?>>For Recording Only</label></td>
	</tr>
         <tr>
          <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_pdprofitcenter") ?>>Deliver To</label></td>
		<td  align=left>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_pdprofitcenter",null,null,null,null,"width:370px") ?>></select></td>
		<td >&nbsp;</td>
		<td align=left>&nbsp;</td>
	</tr>
	</table>
...
<tr><td>
	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_requestedbyname") ?>>Requested By</label></td>
		    ...
		    <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_obramount") ?>>OBR Amount</label></td>
			<td width="168">&nbsp;<input type="text" size="17"<?php $page->businessobject->items->userfields->draw->text("u_obramount") ?>/></td>
		</tr>
...
<?php $page->resize->addgridobject($objGrids[0],20,420) ?>
<?php $page->resize->addgridobject($objGrids[1],20,420) ?>
