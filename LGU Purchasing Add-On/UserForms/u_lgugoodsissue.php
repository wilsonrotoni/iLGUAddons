<tr><td>
	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<td width="1142" align=left><?php genLinkedButtonHtml("u_empid", "", "OpenLnkBtnu_employee()") ?><input type="text" size="20" <?php $page->businessobject->items->userfields->draw->text("u_empid") ?>/></td>
	...
	<tr><td ><label <?php $page->businessobject->items->userfields->draw->caption("u_empname") ?>>Employee Name</label></td>
      ...
      <tr><td width="168" ><label <?php $page->businessobject->items->userfields->draw->caption("u_profitcenter") ?>>Department</label></td>
	...
	<tr><td ><label <?php $page->businessobject->items->userfields->draw->caption("u_profitcentername") ?>>Department Name</label></td>
