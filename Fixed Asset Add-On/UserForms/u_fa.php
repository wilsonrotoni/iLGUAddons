<tr><td>
	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
                    <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_serviceable") ?>>Serviceable</label></td>
                    <td>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_serviceable",null,null,null,null, "width:100px") ?>></select></td>
                    <td>&nbsp;</td>
                </tr>		
	 </table> 
</td></tr>		
