<?php
	...
	if ($_SESSION["errormessage"]=="") {
		$objGrid->clear();
		$objRs->setdebug();
		$objRs->queryopen("select A.CODE AS U_FACODE, A.NAME AS U_FANAME, A.U_FACLASS, A.U_ITEMCODE, A.U_ITEMDESC, C.U_AMOUNT from U_FA A, U_FADEPRESCHEDS C where A.U_BOOKVALUE>0 AND C.CODE=A.CODE and C.U_POSTED=0  $filterExp");
		//var_dump($objRs->sqls);
