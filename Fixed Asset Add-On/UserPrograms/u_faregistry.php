...
//	$objGrid->addcolumn("u_type");
	...
	//if ($page->getitemstring("branchcode")!="" || $httpVars['df_documentstatus']!="" || $httpVars['df_facode']!="" || $httpVars['df_plateno']!="") {
		$objRs->queryopen("SELECT A.CODE, A.U_ITEMDESC, A.U_DEPARTMENT, A.U_EMPID, A.U_EMPNAME, A.U_PROJCODE, A.U_PROFITCENTER, C.BRANCHNAME FROM U_FA A LEFT JOIN BRANCHESLIST C ON C.BRANCHCODE=A.U_BRANCH $filterExp $orderExp");
	...
	$page->resize->addgridobject($objGrid,10,190);
...
<?php if ($requestorId == "") { ?>
<tr><td>
<?php require(getUserProgramFilePath("U_GenericListToolbar.php"));  ?>
</td></tr>
<?php } ?>
<!-- end content -->
