[Setup]
AppId=eBTPortalLGUReceiptsAddOnSetup
AppName=eBT Portal LGU Receipts AddOn Setup
AppVerName=eBT Portal LGU Receipts AddOn Setup Version 01.01.01
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUReceiptsAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Receipts Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
