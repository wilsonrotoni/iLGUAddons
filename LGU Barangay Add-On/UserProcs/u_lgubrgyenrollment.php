...
$objGrids[0]->columnwidth("u_studno",20);
$objGrids[0]->columnwidth("u_gender",20);
$objGrids[0]->columncfl("u_name","OpenCFLfs()");
$objGrids[0]->columncfl("u_studno","OpenCFLfs()");
$objGrids[0]->columnattributes("u_gender","disabled");
$page->businessobject->items->setcfl("u_date","Calendar");

$objMaster->reportaction = "QS";
$pageHeader = "Enrollment";
?> 
