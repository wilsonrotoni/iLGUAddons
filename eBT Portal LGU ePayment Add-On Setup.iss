[Setup]
AppId=eBTPortalLGUePaymentAddOnSetup
AppName=eBT Portal LGU ePayment AddOn Setup
AppVerName=eBT Portal LGU ePayment AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUePaymentAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU ePayment Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
