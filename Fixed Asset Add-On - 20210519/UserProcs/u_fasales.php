<?php
	include_once("./sls/taxes.php");
	include_once("./sls/wtaxes.php");
...
$page->businessobject->items->setcfl("u_bpcode","OpenCFLbusinesspartners()");
...
$page->businessobject->items->seteditable("u_arinvno",false);
$page->businessobject->items->seteditable("u_bpname",false);
$page->businessobject->items->seteditable("u_gainloss",false);
