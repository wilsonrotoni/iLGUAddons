		...
		<div class="tabbertab" title="General">
			<div id="divudf" style="overflow:auto;">
				<table class="tableFreeForm" width="100%" border="0" cellpadding="0" cellspacing="0" >
					...
					<tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_seqno") ?>>Seq. No.</label></td>
						<td>&nbsp;<input type="text" size="12" <?php $page->businessobject->items->userfields->draw->text("u_seqno") ?>/></td>
					</tr>
