...
//	$objGrid->columnvisibility("action2",false);
	...
	$objGrid->automanagecolumnwidth = false;
        ...
        if ($page->getitemstring("u_ownername") != "") {
            $lookupSortBy = "U_LASTNAME, U_YEAR DESC ";
        } else {
            $lookupSortBy = "";
        }
		...
		switch ($column) {
			case "indicator":
				...
				switch ($label) {
                                        ...
                                        case "On-Hold": $style="background-color:#d13d3d"; break;
				...
				break;
                        default :
                                switch ($indicator){
                                    ...
                                    case "On-Hold": $style="color:#d13d3d";break;
...
<script language="JavaScript">
	...
	function onReportGetParams(p_formattype,p_params) {
		...
		params["reportfile"] = getVar("approotpath") + "AddOns\\GPS\\LGU Bacoor Add-On\\UserRpts\\BPL\\k_mayor_permit2.rpt"; 
