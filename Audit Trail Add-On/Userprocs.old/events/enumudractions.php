<?php
	...
	function onBeforeAddEventenumudractionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumudractionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumudractionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
