<?php
	...
	function onBeforeAddEventenumpostingperiodvalidityGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpostingperiodvalidityGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpostingperiodvalidityGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
