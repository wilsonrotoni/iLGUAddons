<?php
	...
	function onBeforeAddEventaddressesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaddressesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaddressesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
