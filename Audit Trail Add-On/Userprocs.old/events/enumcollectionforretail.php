<?php
	...
	function onBeforeAddEventenumcollectionforretailGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcollectionforretailGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcollectionforretailGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
