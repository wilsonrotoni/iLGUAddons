<?php
	...
	function onBeforeAddEventcompanywrittenoffreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcompanywrittenoffreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcompanywrittenoffreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
