<?php
	...
	function onBeforeAddEventenumfinancialmodulesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumfinancialmodulesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumfinancialmodulesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
