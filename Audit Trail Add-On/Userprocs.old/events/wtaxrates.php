<?php
	...
	function onBeforeAddEventwtaxratesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventwtaxratesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventwtaxratesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
