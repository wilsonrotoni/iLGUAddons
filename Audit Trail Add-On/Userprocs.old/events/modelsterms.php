<?php
	...
	function onBeforeAddEventmodelstermsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventmodelstermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventmodelstermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
