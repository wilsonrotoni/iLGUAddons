<?php
	...
	function onBeforeAddEventenumpettycashtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpettycashtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpettycashtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
