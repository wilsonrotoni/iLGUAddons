<?php
	...
	function onBeforeAddEventmodelGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventmodelGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventmodelGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
