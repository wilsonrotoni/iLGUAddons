<?php
	...
	function onBeforeAddEventgoodstransfersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventgoodstransfersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventgoodstransfersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
