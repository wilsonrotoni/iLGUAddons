<?php
	...
	function onBeforeAddEventsalesdocumentationexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsalesdocumentationexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsalesdocumentationexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
