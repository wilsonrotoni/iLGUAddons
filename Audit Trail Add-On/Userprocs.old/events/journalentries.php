<?php
	...
	function onBeforeAddEventjournalentriesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventjournalentriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventjournalentriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
