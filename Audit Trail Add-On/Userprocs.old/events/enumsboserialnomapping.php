<?php
	...
	function onBeforeAddEventenumsboserialnomappingGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumsboserialnomappingGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumsboserialnomappingGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
