<?php
	...
	function onBeforeAddEventpostingperiodsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpostingperiodsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpostingperiodsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
