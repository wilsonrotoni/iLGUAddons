<?php
	...
	function onBeforeAddEventbatchesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbatchesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbatchesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
