<?php
	...
	function onBeforeAddEventemcortrxsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventemcortrxsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventemcortrxsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
