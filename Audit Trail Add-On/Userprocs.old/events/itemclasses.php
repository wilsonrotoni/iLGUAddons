<?php
	...
	function onBeforeAddEventitemclassesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitemclassesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitemclassesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
