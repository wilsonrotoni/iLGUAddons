<?php
	...
	function onBeforeAddEventcompanytaxdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcompanytaxdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcompanytaxdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
