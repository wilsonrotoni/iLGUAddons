<?php
	...
	function onBeforeAddEventcashcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcashcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcashcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
