<?php
	...
	function onBeforeAddEventenumsaletypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumsaletypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumsaletypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
