<?php
	...
	function onBeforeAddEventitempricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitempricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitempricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
