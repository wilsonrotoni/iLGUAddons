<?php
	...
	function onBeforeAddEventjournalvouchersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventjournalvouchersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventjournalvouchersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
