<?php
	...
	function onBeforeAddEventenumtasktypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumtasktypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumtasktypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
