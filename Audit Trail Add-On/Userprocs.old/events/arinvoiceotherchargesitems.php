<?php
	...
	function onBeforeAddEventarinvoiceotherchargesitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventarinvoiceotherchargesitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventarinvoiceotherchargesitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
