<?php
	...
	function onBeforeAddEventsessionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsessionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsessionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
