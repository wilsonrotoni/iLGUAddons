<?php
	...
	function onBeforeAddEventenumcollectiondoctypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcollectiondoctypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcollectiondoctypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
