<?php
	...
	function onBeforeAddEventpaymenttermpricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpaymenttermpricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpaymenttermpricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
