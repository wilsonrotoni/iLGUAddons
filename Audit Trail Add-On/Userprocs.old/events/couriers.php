<?php
	...
	function onBeforeAddEventcouriersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcouriersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcouriersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
