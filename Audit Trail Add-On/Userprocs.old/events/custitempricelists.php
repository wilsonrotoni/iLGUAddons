<?php
	...
	function onBeforeAddEventcustitempricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcustitempricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcustitempricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
