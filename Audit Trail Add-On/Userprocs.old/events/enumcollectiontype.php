<?php
	...
	function onBeforeAddEventenumcollectiontypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcollectiontypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcollectiontypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
