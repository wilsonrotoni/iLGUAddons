<?php
	...
	function onBeforeAddEventareaassignments_xGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventareaassignments_xGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventareaassignments_xGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
