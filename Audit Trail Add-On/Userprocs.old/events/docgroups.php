<?php
	...
	function onBeforeAddEventdocgroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdocgroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdocgroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
