<?php
	...
	function onBeforeAddEventwtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventwtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventwtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
