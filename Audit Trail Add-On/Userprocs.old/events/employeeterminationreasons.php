<?php
	...
	function onBeforeAddEventemployeeterminationreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventemployeeterminationreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventemployeeterminationreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
