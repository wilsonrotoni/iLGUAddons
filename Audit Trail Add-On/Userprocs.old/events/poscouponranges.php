<?php
	...
	function onBeforeAddEventposcouponrangesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventposcouponrangesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventposcouponrangesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
