<?php
	...
	function onBeforeAddEventarcreditmemosGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventarcreditmemosGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventarcreditmemosGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
