<?php
	...
	function onBeforeAddEventdocnosxGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdocnosxGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdocnosxGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
