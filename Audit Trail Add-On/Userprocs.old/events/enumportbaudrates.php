<?php
	...
	function onBeforeAddEventenumportbaudratesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumportbaudratesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumportbaudratesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
