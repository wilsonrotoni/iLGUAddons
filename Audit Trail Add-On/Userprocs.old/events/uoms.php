<?php
	...
	function onBeforeAddEventuomsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventuomsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventuomsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
