<?php
	...
	function onBeforeAddEventbankdepositcollectionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbankdepositcollectionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbankdepositcollectionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
