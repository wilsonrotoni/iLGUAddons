<?php
	...
	function onBeforeAddEventsaleschannelsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsaleschannelsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsaleschannelsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
