<?php
	...
	function onBeforeAddEventcompanytaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcompanytaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcompanytaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
