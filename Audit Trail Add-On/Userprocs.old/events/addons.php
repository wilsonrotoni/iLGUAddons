<?php
	...
	function onBeforeAddEventaddonsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaddonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaddonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
