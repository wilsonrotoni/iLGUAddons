<?php
	...
	function onBeforeAddEventcollectionsotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcollectionsotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcollectionsotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
