<?php
	...
	function onBeforeAddEventenumapprovaltemplatetermsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumapprovaltemplatetermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumapprovaltemplatetermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
