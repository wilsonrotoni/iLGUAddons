<?php
	...
	function onBeforeAddEventserialsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserialsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserialsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
