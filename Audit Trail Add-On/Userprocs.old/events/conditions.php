<?php
	...
	function onBeforeAddEventconditionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventconditionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventconditionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
