<?php
	...
	function onBeforeAddEventsuppitempricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsuppitempricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsuppitempricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
