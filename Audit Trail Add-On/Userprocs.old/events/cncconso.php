<?php
	...
	function onBeforeAddEventcncconsoGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcncconsoGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcncconsoGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
