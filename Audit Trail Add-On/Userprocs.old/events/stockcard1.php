<?php
	...
	function onBeforeAddEventstockcard1GPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventstockcard1GPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventstockcard1GPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
