<?php
	...
	function onBeforeAddEventenumprintlayoutdfltprintsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumprintlayoutdfltprintsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumprintlayoutdfltprintsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
