<?php
	...
	function onBeforeAddEventaccountloanrestructureGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaccountloanrestructureGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaccountloanrestructureGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
