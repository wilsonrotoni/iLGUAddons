<?php
	...
	function onBeforeAddEventaccountslistGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaccountslistGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaccountslistGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
