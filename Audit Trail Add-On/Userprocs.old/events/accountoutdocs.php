<?php
	...
	function onBeforeAddEventaccountoutdocsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaccountoutdocsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaccountoutdocsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
