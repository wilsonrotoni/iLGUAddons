<?php
	...
	function onBeforeAddEventcaspousesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcaspousesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcaspousesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
