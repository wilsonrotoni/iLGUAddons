<?php
	...
	function onBeforeAddEventenumcompanytypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcompanytypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcompanytypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
