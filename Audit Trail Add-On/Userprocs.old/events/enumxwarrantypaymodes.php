<?php
	...
	function onBeforeAddEventenumxwarrantypaymodesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumxwarrantypaymodesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumxwarrantypaymodesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
