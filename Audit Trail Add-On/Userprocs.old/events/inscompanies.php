<?php
	...
	function onBeforeAddEventinscompaniesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventinscompaniesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventinscompaniesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
