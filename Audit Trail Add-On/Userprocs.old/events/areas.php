<?php
	...
	function onBeforeAddEventareasGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventareasGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventareasGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
