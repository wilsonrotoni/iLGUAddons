<?php
	...
	function onBeforeAddEventcompanypctypeadvanceemployeebudgetgroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcompanypctypeadvanceemployeebudgetgroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcompanypctypeadvanceemployeebudgetgroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
