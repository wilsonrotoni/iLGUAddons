<?php
	...
	function onBeforeAddEventenumcollectionforGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcollectionforGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcollectionforGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
