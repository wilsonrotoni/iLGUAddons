<?php
	...
	function onBeforeAddEventitemopeningbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitemopeningbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitemopeningbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
