<?php
	...
	function onBeforeAddEventenumdbsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumdbsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumdbsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
