<?php
	...
	function onBeforeAddEventcarecommendationGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcarecommendationGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcarecommendationGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
