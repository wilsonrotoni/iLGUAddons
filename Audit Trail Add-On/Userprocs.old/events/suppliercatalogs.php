<?php
	...
	function onBeforeAddEventsuppliercatalogsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsuppliercatalogsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsuppliercatalogsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
