<?php
	...
	function onBeforeAddEventmarketingdocumentcreditcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventmarketingdocumentcreditcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventmarketingdocumentcreditcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
