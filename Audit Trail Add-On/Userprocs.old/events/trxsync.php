<?php
	...
	function onBeforeAddEventtrxsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventtrxsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventtrxsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
