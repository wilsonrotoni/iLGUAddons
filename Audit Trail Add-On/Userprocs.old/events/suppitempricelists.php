<?php
	...
	function onBeforeAddEventsuppitempricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsuppitempricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsuppitempricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
