<?php
	...
	function onBeforeAddEventenumiyesnoGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumiyesnoGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumiyesnoGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
