<?php
	...
	function onBeforeAddEventprofitcenterdistributionrulesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventprofitcenterdistributionrulesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventprofitcenterdistributionrulesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
