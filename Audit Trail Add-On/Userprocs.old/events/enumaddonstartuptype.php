<?php
	...
	function onBeforeAddEventenumaddonstartuptypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumaddonstartuptypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumaddonstartuptypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
