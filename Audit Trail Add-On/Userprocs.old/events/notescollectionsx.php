<?php
	...
	function onBeforeAddEventnotescollectionsxGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventnotescollectionsxGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventnotescollectionsxGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
