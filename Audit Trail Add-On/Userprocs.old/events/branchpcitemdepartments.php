<?php
	...
	function onBeforeAddEventbranchpcitemdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchpcitemdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchpcitemdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
