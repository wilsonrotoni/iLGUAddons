<?php
	...
	function onBeforeAddEventporequestsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventporequestsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventporequestsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
