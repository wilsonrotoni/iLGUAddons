<?php
	...
	function onBeforeAddEventenumpaymenttermstartfromGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpaymenttermstartfromGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpaymenttermstartfromGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
