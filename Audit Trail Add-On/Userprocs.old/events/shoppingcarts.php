<?php
	...
	function onBeforeAddEventshoppingcartsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventshoppingcartsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventshoppingcartsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
