<?php
	...
	function onBeforeAddEventvoluntarydepositsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventvoluntarydepositsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventvoluntarydepositsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
