<?php
	...
	function onBeforeAddEventpcrepsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpcrepsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpcrepsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
