<?php
	...
	function onBeforeAddEventenumloanpurposeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumloanpurposeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumloanpurposeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
