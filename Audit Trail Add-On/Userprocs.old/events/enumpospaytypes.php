<?php
	...
	function onBeforeAddEventenumpospaytypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpospaytypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpospaytypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
