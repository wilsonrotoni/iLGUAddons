<?php
	...
	function onBeforeAddEventobjectaccesssettingsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventobjectaccesssettingsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventobjectaccesssettingsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
