<?php
	...
	function onBeforeAddEventreconciliationsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventreconciliationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventreconciliationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
