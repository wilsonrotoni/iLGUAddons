<?php
	...
	function onBeforeAddEventusermenuGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventusermenuGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventusermenuGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
