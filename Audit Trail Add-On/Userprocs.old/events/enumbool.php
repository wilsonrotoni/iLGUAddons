<?php
	...
	function onBeforeAddEventenumboolGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumboolGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumboolGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
