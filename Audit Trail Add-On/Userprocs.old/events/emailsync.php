<?php
	...
	function onBeforeAddEventemailsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventemailsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventemailsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
