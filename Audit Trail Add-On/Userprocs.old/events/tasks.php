<?php
	...
	function onBeforeAddEventtasksGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventtasksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventtasksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
