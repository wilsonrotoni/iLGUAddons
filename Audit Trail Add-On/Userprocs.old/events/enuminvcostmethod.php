<?php
	...
	function onBeforeAddEventenuminvcostmethodGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenuminvcostmethodGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenuminvcostmethodGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
