<?php
	...
	function onBeforeAddEventsalesquotationsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsalesquotationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsalesquotationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
