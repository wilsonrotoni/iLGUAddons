<?php
	...
	function onBeforeAddEventaccountloanpretermGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaccountloanpretermGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaccountloanpretermGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
