<?php
	...
	function onBeforeAddEventclosingperioditemsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventclosingperioditemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventclosingperioditemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
