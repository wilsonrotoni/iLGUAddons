<?php
	...
	function onBeforeAddEventenumacctstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumacctstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumacctstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
