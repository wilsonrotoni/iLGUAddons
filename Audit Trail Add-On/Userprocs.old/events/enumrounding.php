<?php
	...
	function onBeforeAddEventenumroundingGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumroundingGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumroundingGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
