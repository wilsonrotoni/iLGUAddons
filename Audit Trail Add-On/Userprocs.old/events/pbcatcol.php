<?php
	...
	function onBeforeAddEventpbcatcolGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpbcatcolGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpbcatcolGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
