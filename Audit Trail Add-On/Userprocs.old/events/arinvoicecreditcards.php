<?php
	...
	function onBeforeAddEventarinvoicecreditcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventarinvoicecreditcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventarinvoicecreditcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
