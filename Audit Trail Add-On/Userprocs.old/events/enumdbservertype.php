<?php
	...
	function onBeforeAddEventenumdbservertypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumdbservertypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumdbservertypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
