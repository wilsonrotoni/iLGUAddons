<?php
	...
	function onBeforeAddEventsuppliercontactsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsuppliercontactsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsuppliercontactsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
