<?php
	...
	function onBeforeAddEventcascorecardGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcascorecardGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcascorecardGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
