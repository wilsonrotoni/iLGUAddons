<?php
	...
	function onBeforeAddEventbomsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbomsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbomsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
