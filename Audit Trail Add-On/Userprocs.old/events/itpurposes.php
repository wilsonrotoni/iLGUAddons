<?php
	...
	function onBeforeAddEventitpurposesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitpurposesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitpurposesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
