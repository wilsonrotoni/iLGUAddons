<?php
	...
	function onBeforeAddEventenumwhsdropshipGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumwhsdropshipGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumwhsdropshipGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
