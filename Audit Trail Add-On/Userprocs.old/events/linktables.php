<?php
	...
	function onBeforeAddEventlinktablesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventlinktablesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventlinktablesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
