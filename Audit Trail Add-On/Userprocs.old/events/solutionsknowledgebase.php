<?php
	...
	function onBeforeAddEventsolutionsknowledgebaseGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsolutionsknowledgebaseGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsolutionsknowledgebaseGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
