<?php
	...
	function onBeforeAddEventsmsdevicesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsmsdevicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsmsdevicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
