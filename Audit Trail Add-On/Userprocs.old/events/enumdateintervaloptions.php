<?php
	...
	function onBeforeAddEventenumdateintervaloptionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumdateintervaloptionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumdateintervaloptionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
