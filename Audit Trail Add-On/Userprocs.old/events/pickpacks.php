<?php
	...
	function onBeforeAddEventpickpacksGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpickpacksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpickpacksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
