<?php
	...
	function onBeforeAddEventmakesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventmakesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventmakesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
