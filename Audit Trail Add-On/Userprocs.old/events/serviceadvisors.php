<?php
	...
	function onBeforeAddEventserviceadvisorsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserviceadvisorsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserviceadvisorsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
