<?php
	...
	function onBeforeAddEventdocumentapprovalstageusersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdocumentapprovalstageusersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdocumentapprovalstageusersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
