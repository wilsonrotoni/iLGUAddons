<?php
	...
	function onBeforeAddEventbranchcireqsreviewerGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchcireqsreviewerGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchcireqsreviewerGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
