<?php
	...
	function onBeforeAddEventgoodsissuesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventgoodsissuesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventgoodsissuesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
