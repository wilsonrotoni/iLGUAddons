<?php
	...
	function onBeforeAddEventenumloantypeclassGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumloantypeclassGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumloantypeclassGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
