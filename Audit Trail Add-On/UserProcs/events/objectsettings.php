<?php
	...
	function onBeforeAddEventobjectsettingsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventobjectsettingsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventobjectsettingsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
