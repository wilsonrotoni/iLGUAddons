<?php
	...
	function onBeforeAddEventenumcreditcardrctypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcreditcardrctypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcreditcardrctypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
