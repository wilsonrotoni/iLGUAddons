<?php
	...
	function onBeforeAddEventproductionshiftsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventproductionshiftsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventproductionshiftsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
