<?php
	...
	function onBeforeAddEventenumwtaxcategoryGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumwtaxcategoryGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumwtaxcategoryGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
