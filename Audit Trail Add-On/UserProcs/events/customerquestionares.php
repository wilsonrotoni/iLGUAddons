<?php
	...
	function onBeforeAddEventcustomerquestionaresGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcustomerquestionaresGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcustomerquestionaresGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
