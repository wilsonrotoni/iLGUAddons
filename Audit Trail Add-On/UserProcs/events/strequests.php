<?php
	...
	function onBeforeAddEventstrequestsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventstrequestsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventstrequestsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
