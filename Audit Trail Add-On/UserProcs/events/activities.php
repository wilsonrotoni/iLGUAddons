<?php
	...
	function onBeforeAddEventactivitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventactivitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventactivitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
