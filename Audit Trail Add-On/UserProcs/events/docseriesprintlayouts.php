<?php
	...
	function onBeforeAddEventdocseriesprintlayoutsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdocseriesprintlayoutsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdocseriesprintlayoutsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
