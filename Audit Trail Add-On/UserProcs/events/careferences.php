<?php
	...
	function onBeforeAddEventcareferencesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcareferencesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcareferencesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
