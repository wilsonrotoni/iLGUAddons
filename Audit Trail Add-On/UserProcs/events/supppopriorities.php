<?php
	...
	function onBeforeAddEventsupppoprioritiesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsupppoprioritiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsupppoprioritiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
