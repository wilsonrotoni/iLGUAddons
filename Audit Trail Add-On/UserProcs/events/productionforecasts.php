<?php
	...
	function onBeforeAddEventproductionforecastsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventproductionforecastsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventproductionforecastsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
