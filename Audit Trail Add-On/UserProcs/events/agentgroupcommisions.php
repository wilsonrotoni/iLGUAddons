<?php
	...
	function onBeforeAddEventagentgroupcommisionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventagentgroupcommisionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventagentgroupcommisionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
