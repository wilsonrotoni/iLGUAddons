<?php
	...
	function onBeforeAddEventmarketingdocumentcashcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventmarketingdocumentcashcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventmarketingdocumentcashcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
