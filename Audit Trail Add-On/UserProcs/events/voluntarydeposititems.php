<?php
	...
	function onBeforeAddEventvoluntarydeposititemsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventvoluntarydeposititemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventvoluntarydeposititemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
