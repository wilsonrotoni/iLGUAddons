<?php
	...
	function onBeforeAddEventenumcheckstatuslistGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcheckstatuslistGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcheckstatuslistGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
