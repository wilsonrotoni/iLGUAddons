<?php
	...
	function onBeforeAddEventclosingperiodsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventclosingperiodsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventclosingperiodsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
