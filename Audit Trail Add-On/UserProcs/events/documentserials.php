<?php
	...
	function onBeforeAddEventdocumentserialsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdocumentserialsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdocumentserialsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
