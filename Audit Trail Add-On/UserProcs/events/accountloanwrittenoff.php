<?php
	...
	function onBeforeAddEventaccountloanwrittenoffGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaccountloanwrittenoffGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaccountloanwrittenoffGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
