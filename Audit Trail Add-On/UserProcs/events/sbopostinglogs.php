<?php
	...
	function onBeforeAddEventsbopostinglogsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsbopostinglogsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsbopostinglogsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
