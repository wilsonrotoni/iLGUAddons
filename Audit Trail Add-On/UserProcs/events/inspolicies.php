<?php
	...
	function onBeforeAddEventinspoliciesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventinspoliciesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventinspoliciesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
