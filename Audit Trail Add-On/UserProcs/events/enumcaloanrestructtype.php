<?php
	...
	function onBeforeAddEventenumcaloanrestructtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcaloanrestructtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcaloanrestructtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
