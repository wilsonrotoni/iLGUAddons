<?php
	...
	function onBeforeAddEventagentsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventagentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventagentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
