<?php
	...
	function onBeforeAddEventenumposmodulesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumposmodulesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumposmodulesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
