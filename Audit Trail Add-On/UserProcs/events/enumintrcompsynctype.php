<?php
	...
	function onBeforeAddEventenumintrcompsynctypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumintrcompsynctypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumintrcompsynctypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
