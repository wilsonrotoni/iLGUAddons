<?php
	...
	function onBeforeAddEventrepackingGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventrepackingGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventrepackingGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
