<?php
	...
	function onBeforeAddEventsupplierbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsupplierbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsupplierbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
