<?php
	...
	function onBeforeAddEventpaymentsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpaymentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpaymentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
