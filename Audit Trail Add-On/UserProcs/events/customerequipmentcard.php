<?php
	...
	function onBeforeAddEventcustomerequipmentcardGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcustomerequipmentcardGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcustomerequipmentcardGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
