<?php
	...
	function onBeforeAddEventcievaluationlivingexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcievaluationlivingexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcievaluationlivingexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
