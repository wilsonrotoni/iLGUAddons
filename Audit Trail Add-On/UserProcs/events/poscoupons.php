<?php
	...
	function onBeforeAddEventposcouponsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventposcouponsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventposcouponsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
