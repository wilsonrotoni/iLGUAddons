<?php
	...
	function onBeforeAddEventquestionaresGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventquestionaresGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventquestionaresGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
