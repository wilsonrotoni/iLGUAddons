<?php
	...
	function onBeforeAddEventinventoryGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventinventoryGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventinventoryGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
