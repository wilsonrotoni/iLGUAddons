<?php
	...
	function onBeforeAddEventcarequirementsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcarequirementsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcarequirementsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
