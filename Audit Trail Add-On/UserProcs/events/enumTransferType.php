<?php
	...
	function onBeforeAddEventenumTransferTypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumTransferTypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumTransferTypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
