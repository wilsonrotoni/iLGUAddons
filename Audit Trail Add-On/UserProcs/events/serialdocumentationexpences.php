<?php
	...
	function onBeforeAddEventserialdocumentationexpencesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserialdocumentationexpencesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserialdocumentationexpencesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
