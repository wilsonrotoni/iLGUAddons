<?php
	...
	function onBeforeAddEventbranchpaymentmeansGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchpaymentmeansGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchpaymentmeansGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
