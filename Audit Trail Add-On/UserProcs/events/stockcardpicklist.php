<?php
	...
	function onBeforeAddEventstockcardpicklistGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventstockcardpicklistGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventstockcardpicklistGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
