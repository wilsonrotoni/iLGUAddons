<?php
	...
	function onBeforeAddEventarinvoicechequesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventarinvoicechequesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventarinvoicechequesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
