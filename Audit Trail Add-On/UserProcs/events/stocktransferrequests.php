<?php
	...
	function onBeforeAddEventstocktransferrequestsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventstocktransferrequestsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventstocktransferrequestsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
