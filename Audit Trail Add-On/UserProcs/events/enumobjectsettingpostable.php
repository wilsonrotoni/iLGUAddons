<?php
	...
	function onBeforeAddEventenumobjectsettingpostableGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumobjectsettingpostableGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumobjectsettingpostableGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
