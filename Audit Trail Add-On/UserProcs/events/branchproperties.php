<?php
	...
	function onBeforeAddEventbranchpropertiesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchpropertiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchpropertiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
