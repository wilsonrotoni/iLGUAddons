<?php
	...
	function onBeforeAddEventenumstockcardreftypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumstockcardreftypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumstockcardreftypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
