<?php
	...
	function onBeforeAddEventenumpropertytypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpropertytypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpropertytypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
