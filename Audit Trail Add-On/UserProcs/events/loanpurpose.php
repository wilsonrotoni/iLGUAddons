<?php
	...
	function onBeforeAddEventloanpurposeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventloanpurposeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventloanpurposeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
