<?php
	...
	function onBeforeAddEventcountriesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcountriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcountriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
