<?php
	...
	function onBeforeAddEventloginlogsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventloginlogsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventloginlogsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
