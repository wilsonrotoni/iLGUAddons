<?php
	...
	function onBeforeAddEventbranchareabarangaysGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchareabarangaysGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchareabarangaysGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
