<?php
	...
	function onBeforeAddEventenumudttypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumudttypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumudttypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
