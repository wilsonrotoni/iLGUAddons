<?php
	...
	function onBeforeAddEventenumbatchpostingmodesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumbatchpostingmodesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumbatchpostingmodesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
