<?php
	...
	function onBeforeAddEventenumexpenditureGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumexpenditureGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumexpenditureGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
