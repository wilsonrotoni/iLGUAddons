<?php
	...
	function onBeforeAddEventsuppitembarcodepricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsuppitembarcodepricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsuppitembarcodepricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
