<?php
	...
	function onBeforeAddEventenumrecurringpostingfrequenciesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumrecurringpostingfrequenciesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumrecurringpostingfrequenciesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
