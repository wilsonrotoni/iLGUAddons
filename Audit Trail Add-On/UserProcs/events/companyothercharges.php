<?php
	...
	function onBeforeAddEventcompanyotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcompanyotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcompanyotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
