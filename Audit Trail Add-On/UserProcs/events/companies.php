<?php
	...
	function onBeforeAddEventcompaniesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcompaniesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcompaniesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
