<?php
	...
	function onBeforeAddEventpurchaseforecastsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpurchaseforecastsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpurchaseforecastsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
