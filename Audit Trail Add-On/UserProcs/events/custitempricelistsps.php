<?php
	...
	function onBeforeAddEventcustitempricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcustitempricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcustitempricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
