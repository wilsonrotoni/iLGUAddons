<?php
	...
	function onBeforeAddEventenumdocprinterlistGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumdocprinterlistGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumdocprinterlistGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
