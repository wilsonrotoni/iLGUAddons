<?php
	...
	function onBeforeAddEventlocationsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventlocationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventlocationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
