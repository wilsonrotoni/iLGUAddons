<?php
	...
	function onBeforeAddEventbanksGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbanksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbanksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
