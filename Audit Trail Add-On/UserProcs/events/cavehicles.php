<?php
	...
	function onBeforeAddEventcavehiclesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcavehiclesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcavehiclesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
