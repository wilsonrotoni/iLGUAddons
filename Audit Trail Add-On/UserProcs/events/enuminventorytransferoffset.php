<?php
	...
	function onBeforeAddEventenuminventorytransferoffsetGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenuminventorytransferoffsetGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenuminventorytransferoffsetGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
