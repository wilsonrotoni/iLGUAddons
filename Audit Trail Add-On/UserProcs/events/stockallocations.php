<?php
	...
	function onBeforeAddEventstockallocationsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventstockallocationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventstockallocationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
