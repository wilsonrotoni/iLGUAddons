<?php
	...
	function onBeforeAddEventenumpaymentcagltypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpaymentcagltypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpaymentcagltypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
