<?php
	...
	function onBeforeAddEventdocumentationexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdocumentationexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdocumentationexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
