<?php
	...
	function onBeforeAddEventuserrolesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventuserrolesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventuserrolesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
