<?php
	...
	function onBeforeAddEventudqparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventudqparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventudqparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
