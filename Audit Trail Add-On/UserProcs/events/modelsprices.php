<?php
	...
	function onBeforeAddEventmodelspricesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventmodelspricesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventmodelspricesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
