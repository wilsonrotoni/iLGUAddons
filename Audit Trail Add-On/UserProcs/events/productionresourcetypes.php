<?php
	...
	function onBeforeAddEventproductionresourcetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventproductionresourcetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventproductionresourcetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
