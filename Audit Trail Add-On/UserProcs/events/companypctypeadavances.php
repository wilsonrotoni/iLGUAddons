<?php
	...
	function onBeforeAddEventcompanypctypeadavancesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcompanypctypeadavancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcompanypctypeadavancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
