<?php
	...
	function onBeforeAddEventjimactrxlogconnectionGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventjimactrxlogconnectionGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventjimactrxlogconnectionGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
