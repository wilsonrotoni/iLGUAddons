<?php
	...
	function onBeforeAddEventenumtravelfreqGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumtravelfreqGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumtravelfreqGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
