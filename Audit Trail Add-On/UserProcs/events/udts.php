<?php
	...
	function onBeforeAddEventudtsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventudtsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventudtsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
