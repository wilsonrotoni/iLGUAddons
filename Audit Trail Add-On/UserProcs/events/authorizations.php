<?php
	...
	function onBeforeAddEventauthorizationsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventauthorizationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventauthorizationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
