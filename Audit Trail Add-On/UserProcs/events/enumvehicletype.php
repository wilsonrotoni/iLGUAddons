<?php
	...
	function onBeforeAddEventenumvehicletypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumvehicletypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumvehicletypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
