<?php
	...
	function onBeforeAddEventpctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
