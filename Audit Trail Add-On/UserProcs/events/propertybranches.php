<?php
	...
	function onBeforeAddEventpropertybranchesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpropertybranchesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpropertybranchesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
