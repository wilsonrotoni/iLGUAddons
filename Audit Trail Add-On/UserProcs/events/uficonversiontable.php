<?php
	...
	function onBeforeAddEventuficonversiontableGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventuficonversiontableGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventuficonversiontableGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
