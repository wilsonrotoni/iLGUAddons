<?php
	...
	function onBeforeAddEventinitialquantitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventinitialquantitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventinitialquantitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
