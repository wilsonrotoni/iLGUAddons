<?php
	...
	function onBeforeAddEventpaymenttermsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpaymenttermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpaymenttermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
