<?php
	...
	function onBeforeAddEventdocumentschemaGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdocumentschemaGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdocumentschemaGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
