<?php
	...
	function onBeforeAddEventcabusinessesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcabusinessesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcabusinessesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
