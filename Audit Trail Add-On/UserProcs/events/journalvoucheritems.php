<?php
	...
	function onBeforeAddEventjournalvoucheritemsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventjournalvoucheritemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventjournalvoucheritemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
