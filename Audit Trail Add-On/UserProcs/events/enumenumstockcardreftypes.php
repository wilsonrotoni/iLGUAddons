<?php
	...
	function onBeforeAddEventenumenumstockcardreftypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumenumstockcardreftypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumenumstockcardreftypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
