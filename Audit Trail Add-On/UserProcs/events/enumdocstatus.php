<?php
	...
	function onBeforeAddEventenumdocstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumdocstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumdocstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
