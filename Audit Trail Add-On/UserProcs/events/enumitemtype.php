<?php
	...
	function onBeforeAddEventenumitemtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumitemtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumitemtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
