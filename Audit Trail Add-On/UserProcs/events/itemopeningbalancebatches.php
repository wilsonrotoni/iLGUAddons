<?php
	...
	function onBeforeAddEventitemopeningbalancebatchesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitemopeningbalancebatchesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitemopeningbalancebatchesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
