<?php
	...
	function onBeforeAddEventcievaluationincomerangesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcievaluationincomerangesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcievaluationincomerangesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
