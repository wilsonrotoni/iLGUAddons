<?php
	...
	function onBeforeAddEventcompositionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcompositionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcompositionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
