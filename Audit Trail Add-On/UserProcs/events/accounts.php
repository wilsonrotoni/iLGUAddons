<?php
	...
	function onBeforeAddEventaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
