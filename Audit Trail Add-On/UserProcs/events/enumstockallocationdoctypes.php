<?php
	...
	function onBeforeAddEventenumstockallocationdoctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumstockallocationdoctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumstockallocationdoctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
