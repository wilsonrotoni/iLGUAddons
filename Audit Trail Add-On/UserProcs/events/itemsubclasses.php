<?php
	...
	function onBeforeAddEventitemsubclassesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitemsubclassesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitemsubclassesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
