<?php
	...
	function onBeforeAddEventpaymentinvoicesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpaymentinvoicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpaymentinvoicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
