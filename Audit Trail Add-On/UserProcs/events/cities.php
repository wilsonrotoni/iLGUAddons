<?php
	...
	function onBeforeAddEventcitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
