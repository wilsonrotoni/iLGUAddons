<?php
	...
	function onBeforeAddEventenumtextcaseGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumtextcaseGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumtextcaseGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
