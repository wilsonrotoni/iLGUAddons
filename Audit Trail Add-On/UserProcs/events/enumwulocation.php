<?php
	...
	function onBeforeAddEventenumwulocationGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumwulocationGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumwulocationGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
