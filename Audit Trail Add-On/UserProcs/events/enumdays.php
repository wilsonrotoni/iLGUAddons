<?php
	...
	function onBeforeAddEventenumdaysGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumdaysGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumdaysGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
