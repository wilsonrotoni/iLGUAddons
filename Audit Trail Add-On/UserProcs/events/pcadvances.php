<?php
	...
	function onBeforeAddEventpcadvancesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpcadvancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpcadvancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
