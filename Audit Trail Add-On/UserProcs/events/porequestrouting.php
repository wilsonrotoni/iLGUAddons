<?php
	...
	function onBeforeAddEventporequestroutingGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventporequestroutingGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventporequestroutingGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
