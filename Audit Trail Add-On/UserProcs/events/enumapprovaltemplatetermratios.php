<?php
	...
	function onBeforeAddEventenumapprovaltemplatetermratiosGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumapprovaltemplatetermratiosGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumapprovaltemplatetermratiosGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
