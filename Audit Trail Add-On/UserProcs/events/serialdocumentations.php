<?php
	...
	function onBeforeAddEventserialdocumentationsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserialdocumentationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserialdocumentationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
