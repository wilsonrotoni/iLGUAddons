<?php
	...
	function onBeforeAddEventcreditappsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcreditappsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcreditappsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
