<?php
	...
	function onBeforeAddEventalerttemplatesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventalerttemplatesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventalerttemplatesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
