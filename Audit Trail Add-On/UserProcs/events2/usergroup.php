<?php
	...
	function onBeforeAddEventusergroupGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventusergroupGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventusergroupGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
