<?php
	...
	function onBeforeAddEventenumsmsdevicetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumsmsdevicetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumsmsdevicetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
