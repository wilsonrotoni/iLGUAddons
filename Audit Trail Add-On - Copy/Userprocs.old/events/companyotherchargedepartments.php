<?php
	...
	function onBeforeAddEventcompanyotherchargedepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcompanyotherchargedepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcompanyotherchargedepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
