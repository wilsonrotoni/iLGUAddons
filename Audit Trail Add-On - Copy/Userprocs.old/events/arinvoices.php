<?php
	...
	function onBeforeAddEventarinvoicesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventarinvoicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventarinvoicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
