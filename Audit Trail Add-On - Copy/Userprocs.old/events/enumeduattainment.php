<?php
	...
	function onBeforeAddEventenumeduattainmentGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumeduattainmentGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumeduattainmentGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
