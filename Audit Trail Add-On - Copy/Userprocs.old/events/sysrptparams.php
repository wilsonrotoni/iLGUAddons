<?php
	...
	function onBeforeAddEventsysrptparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsysrptparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsysrptparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
