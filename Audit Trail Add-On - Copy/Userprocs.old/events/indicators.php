<?php
	...
	function onBeforeAddEventindicatorsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventindicatorsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventindicatorsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
