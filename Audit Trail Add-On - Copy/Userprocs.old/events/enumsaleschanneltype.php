<?php
	...
	function onBeforeAddEventenumsaleschanneltypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumsaleschanneltypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumsaleschanneltypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
