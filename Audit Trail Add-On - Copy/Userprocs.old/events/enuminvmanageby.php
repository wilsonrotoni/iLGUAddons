<?php
	...
	function onBeforeAddEventenuminvmanagebyGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenuminvmanagebyGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenuminvmanagebyGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
