<?php
	...
	function onBeforeAddEventcollectionscouponsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcollectionscouponsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcollectionscouponsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
