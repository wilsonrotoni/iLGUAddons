<?php
	...
	function onBeforeAddEventitemgrouppricelisttermsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitemgrouppricelisttermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitemgrouppricelisttermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
