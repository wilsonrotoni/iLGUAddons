<?php
	...
	function onBeforeAddEventenumposvatvaluetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumposvatvaluetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumposvatvaluetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
