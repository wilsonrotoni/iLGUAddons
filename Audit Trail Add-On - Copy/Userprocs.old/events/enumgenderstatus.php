<?php
	...
	function onBeforeAddEventenumgenderstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumgenderstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumgenderstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
