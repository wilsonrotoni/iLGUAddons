<?php
	...
	function onBeforeAddEventenumbomtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumbomtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumbomtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
