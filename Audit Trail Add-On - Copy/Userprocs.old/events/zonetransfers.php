<?php
	...
	function onBeforeAddEventzonetransfersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventzonetransfersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventzonetransfersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
