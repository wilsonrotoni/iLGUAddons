<?php
	...
	function onBeforeAddEventactivityGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventactivityGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventactivityGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
