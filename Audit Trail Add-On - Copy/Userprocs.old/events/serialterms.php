<?php
	...
	function onBeforeAddEventserialtermsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserialtermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserialtermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
