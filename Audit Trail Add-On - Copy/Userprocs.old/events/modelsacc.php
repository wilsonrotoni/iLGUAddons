<?php
	...
	function onBeforeAddEventmodelsaccGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventmodelsaccGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventmodelsaccGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
