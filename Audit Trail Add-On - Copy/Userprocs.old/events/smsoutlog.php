<?php
	...
	function onBeforeAddEventsmsoutlogGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsmsoutlogGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsmsoutlogGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
