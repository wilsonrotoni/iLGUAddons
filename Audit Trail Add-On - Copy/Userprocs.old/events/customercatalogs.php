<?php
	...
	function onBeforeAddEventcustomercatalogsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcustomercatalogsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcustomercatalogsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
