<?php
	...
	function onBeforeAddEventdepositsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdepositsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdepositsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
