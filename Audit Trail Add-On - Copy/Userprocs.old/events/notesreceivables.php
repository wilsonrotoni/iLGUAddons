<?php
	...
	function onBeforeAddEventnotesreceivablesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventnotesreceivablesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventnotesreceivablesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
