<?php
	...
	function onBeforeAddEventenumcheckstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcheckstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcheckstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
