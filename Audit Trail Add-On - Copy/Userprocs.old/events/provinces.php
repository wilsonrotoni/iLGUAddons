<?php
	...
	function onBeforeAddEventprovincesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventprovincesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventprovincesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
