<?php
	...
	function onBeforeAddEventxwarrantiesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventxwarrantiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventxwarrantiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
