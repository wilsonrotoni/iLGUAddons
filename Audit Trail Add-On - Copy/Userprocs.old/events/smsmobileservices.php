<?php
	...
	function onBeforeAddEventsmsmobileservicesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsmsmobileservicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsmsmobileservicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
