<?php
	...
	function onBeforeAddEventudrparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventudrparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventudrparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
