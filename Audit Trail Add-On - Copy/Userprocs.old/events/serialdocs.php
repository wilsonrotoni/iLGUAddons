<?php
	...
	function onBeforeAddEventserialdocsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserialdocsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserialdocsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
