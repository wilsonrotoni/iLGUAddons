<?php
	...
	function onBeforeAddEventenumrecurringpostingsubfrequenciesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumrecurringpostingsubfrequenciesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumrecurringpostingsubfrequenciesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
