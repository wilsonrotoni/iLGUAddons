<?php
	...
	function onBeforeAddEventsmssyncGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsmssyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsmssyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
