<?php
	...
	function onBeforeAddEventenumcollectionacctbranchGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcollectionacctbranchGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcollectionacctbranchGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
