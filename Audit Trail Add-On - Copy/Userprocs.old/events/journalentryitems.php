<?php
	...
	function onBeforeAddEventjournalentryitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventjournalentryitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventjournalentryitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
