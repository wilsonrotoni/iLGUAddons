<?php
	...
	function onBeforeAddEventcashdiscountsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcashdiscountsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcashdiscountsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
