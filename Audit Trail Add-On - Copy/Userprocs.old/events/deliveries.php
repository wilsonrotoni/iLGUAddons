<?php
	...
	function onBeforeAddEventdeliveriesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdeliveriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdeliveriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
