<?php
	...
	function onBeforeAddEventenumparamtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumparamtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumparamtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
