<?php
	...
	function onBeforeAddEventenumudtdefaultformGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumudtdefaultformGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumudtdefaultformGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
