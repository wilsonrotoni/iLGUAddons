<?php
	...
	function onBeforeAddEventsupplierduedateGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsupplierduedateGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsupplierduedateGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
