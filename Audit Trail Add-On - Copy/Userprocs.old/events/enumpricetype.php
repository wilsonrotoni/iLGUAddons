<?php
	...
	function onBeforeAddEventenumpricetypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpricetypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpricetypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
