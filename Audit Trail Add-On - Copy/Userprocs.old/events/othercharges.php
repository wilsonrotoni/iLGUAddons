<?php
	...
	function onBeforeAddEventotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
