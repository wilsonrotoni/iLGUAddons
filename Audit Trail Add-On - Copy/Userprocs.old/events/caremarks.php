<?php
	...
	function onBeforeAddEventcaremarksGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcaremarksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcaremarksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
