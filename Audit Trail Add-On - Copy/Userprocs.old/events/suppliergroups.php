<?php
	...
	function onBeforeAddEventsuppliergroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsuppliergroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsuppliergroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
