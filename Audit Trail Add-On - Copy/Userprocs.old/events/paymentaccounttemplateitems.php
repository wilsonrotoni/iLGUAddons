<?php
	...
	function onBeforeAddEventpaymentaccounttemplateitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpaymentaccounttemplateitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpaymentaccounttemplateitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
