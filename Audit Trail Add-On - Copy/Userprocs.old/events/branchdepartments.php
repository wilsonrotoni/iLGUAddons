<?php
	...
	function onBeforeAddEventbranchdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
