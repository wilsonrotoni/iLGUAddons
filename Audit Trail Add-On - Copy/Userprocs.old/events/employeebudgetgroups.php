<?php
	...
	function onBeforeAddEventemployeebudgetgroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventemployeebudgetgroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventemployeebudgetgroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
