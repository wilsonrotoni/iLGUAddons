<?php
	...
	function onBeforeAddEventitinerariesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitinerariesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitinerariesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
