<?php
	...
	function onBeforeAddEventenumpcpaytotypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpcpaytotypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpcpaytotypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
