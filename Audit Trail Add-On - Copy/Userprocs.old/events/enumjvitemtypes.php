<?php
	...
	function onBeforeAddEventenumjvitemtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumjvitemtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumjvitemtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
