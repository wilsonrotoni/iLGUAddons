<?php
	...
	function onBeforeAddEventstockcardGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventstockcardGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventstockcardGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
