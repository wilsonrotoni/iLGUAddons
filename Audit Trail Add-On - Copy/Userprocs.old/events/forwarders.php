<?php
	...
	function onBeforeAddEventforwardersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventforwardersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventforwardersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
