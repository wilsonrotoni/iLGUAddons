<?php
	...
	function onBeforeAddEventsalesordersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsalesordersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsalesordersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
