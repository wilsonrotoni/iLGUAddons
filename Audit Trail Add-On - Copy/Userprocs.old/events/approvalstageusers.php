<?php
	...
	function onBeforeAddEventapprovalstageusersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventapprovalstageusersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventapprovalstageusersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
