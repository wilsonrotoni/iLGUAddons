<?php
	...
	function onBeforeAddEventservicecontracttemplateGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicecontracttemplateGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicecontracttemplateGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
