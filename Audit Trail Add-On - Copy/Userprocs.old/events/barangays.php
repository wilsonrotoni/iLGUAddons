<?php
	...
	function onBeforeAddEventbarangaysGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbarangaysGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbarangaysGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
