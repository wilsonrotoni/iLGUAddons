<?php
	...
	function onBeforeAddEventbranchpctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchpctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchpctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
