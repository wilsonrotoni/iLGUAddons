<?php
	...
	function onBeforeAddEventcievaluationrequirementsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcievaluationrequirementsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcievaluationrequirementsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
