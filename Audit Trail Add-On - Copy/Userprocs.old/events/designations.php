<?php
	...
	function onBeforeAddEventdesignationsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdesignationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdesignationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
