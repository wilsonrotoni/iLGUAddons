<?php
	...
	function onBeforeAddEventsupplierislandgroupfreightsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsupplierislandgroupfreightsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsupplierislandgroupfreightsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
