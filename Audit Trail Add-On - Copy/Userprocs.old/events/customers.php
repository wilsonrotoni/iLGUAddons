<?php
	...
	function onBeforeAddEventcustomersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcustomersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcustomersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
