<?php
	...
	function onBeforeAddEventenumcollectionreceipttypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcollectionreceipttypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcollectionreceipttypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
