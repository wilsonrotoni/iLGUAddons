<?php
	...
	function onBeforeAddEventsysqryparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsysqryparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsysqryparamsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
