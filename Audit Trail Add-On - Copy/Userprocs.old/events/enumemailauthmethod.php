<?php
	...
	function onBeforeAddEventenumemailauthmethodGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumemailauthmethodGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumemailauthmethodGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
