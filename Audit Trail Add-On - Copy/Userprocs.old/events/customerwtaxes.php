<?php
	...
	function onBeforeAddEventcustomerwtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcustomerwtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcustomerwtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
