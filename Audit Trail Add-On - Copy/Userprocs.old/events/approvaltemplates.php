<?php
	...
	function onBeforeAddEventapprovaltemplatesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventapprovaltemplatesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventapprovaltemplatesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
