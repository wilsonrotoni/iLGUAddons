<?php
	...
	function onBeforeAddEventglcodesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventglcodesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventglcodesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
