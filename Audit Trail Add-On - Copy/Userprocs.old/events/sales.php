<?php
	...
	function onBeforeAddEventsalesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsalesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsalesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
