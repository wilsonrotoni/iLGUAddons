<?php
	...
	function onBeforeAddEventbankdepositsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbankdepositsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbankdepositsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
