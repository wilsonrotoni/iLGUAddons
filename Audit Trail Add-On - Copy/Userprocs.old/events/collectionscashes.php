<?php
	...
	function onBeforeAddEventcollectionscashesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcollectionscashesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcollectionscashesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
