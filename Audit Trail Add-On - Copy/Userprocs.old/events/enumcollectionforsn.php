<?php
	...
	function onBeforeAddEventenumcollectionforsnGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcollectionforsnGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcollectionforsnGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
