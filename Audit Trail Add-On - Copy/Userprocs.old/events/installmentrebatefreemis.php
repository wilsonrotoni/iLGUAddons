<?php
	...
	function onBeforeAddEventinstallmentrebatefreemisGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventinstallmentrebatefreemisGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventinstallmentrebatefreemisGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
