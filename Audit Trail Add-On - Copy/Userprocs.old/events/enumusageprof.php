<?php
	...
	function onBeforeAddEventenumusageprofGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumusageprofGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumusageprofGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
