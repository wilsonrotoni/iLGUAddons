<?php
	...
	function onBeforeAddEventenumotherchargestypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumotherchargestypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumotherchargestypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
