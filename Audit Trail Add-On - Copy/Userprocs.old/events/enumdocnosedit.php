<?php
	...
	function onBeforeAddEventenumdocnoseditGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumdocnoseditGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumdocnoseditGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
