<?php
	...
	function onBeforeAddEventbranchpctypeadvancesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchpctypeadvancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchpctypeadvancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
