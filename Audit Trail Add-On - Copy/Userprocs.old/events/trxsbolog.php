<?php
	...
	function onBeforeAddEventtrxsbologGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventtrxsbologGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventtrxsbologGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
