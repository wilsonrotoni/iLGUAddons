<?php
	...
	function onBeforeAddEventpricelisttermsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpricelisttermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpricelisttermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
