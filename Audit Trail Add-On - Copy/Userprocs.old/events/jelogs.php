<?php
	...
	function onBeforeAddEventjelogsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventjelogsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventjelogsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
