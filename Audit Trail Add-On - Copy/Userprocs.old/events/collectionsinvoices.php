<?php
	...
	function onBeforeAddEventcollectionsinvoicesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcollectionsinvoicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcollectionsinvoicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
