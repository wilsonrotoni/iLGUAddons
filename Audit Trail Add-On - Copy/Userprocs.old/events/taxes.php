<?php
	...
	function onBeforeAddEventtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
