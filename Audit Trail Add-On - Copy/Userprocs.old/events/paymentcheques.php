<?php
	...
	function onBeforeAddEventpaymentchequesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpaymentchequesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpaymentchequesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
