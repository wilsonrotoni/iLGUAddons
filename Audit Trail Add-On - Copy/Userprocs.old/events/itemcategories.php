<?php
	...
	function onBeforeAddEventitemcategoriesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitemcategoriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitemcategoriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
