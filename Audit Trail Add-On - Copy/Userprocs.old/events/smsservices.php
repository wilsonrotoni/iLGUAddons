<?php
	...
	function onBeforeAddEventsmsservicesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsmsservicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsmsservicesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
