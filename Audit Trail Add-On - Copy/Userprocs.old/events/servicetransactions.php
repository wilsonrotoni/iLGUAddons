<?php
	...
	function onBeforeAddEventservicetransactionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicetransactionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicetransactionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
