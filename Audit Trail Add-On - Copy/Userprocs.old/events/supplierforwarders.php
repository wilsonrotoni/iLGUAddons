<?php
	...
	function onBeforeAddEventsupplierforwardersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsupplierforwardersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsupplierforwardersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
