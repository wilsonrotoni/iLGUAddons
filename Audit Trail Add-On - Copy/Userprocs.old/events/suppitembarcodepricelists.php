<?php
	...
	function onBeforeAddEventsuppitembarcodepricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsuppitembarcodepricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsuppitembarcodepricelistsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
