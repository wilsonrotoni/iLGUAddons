<?php
	...
	function onBeforeAddEventemployeesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventemployeesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventemployeesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
