<?php
	...
	function onBeforeAddEventbranchwrittenoffreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchwrittenoffreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchwrittenoffreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
