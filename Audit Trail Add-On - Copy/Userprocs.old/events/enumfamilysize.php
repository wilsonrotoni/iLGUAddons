<?php
	...
	function onBeforeAddEventenumfamilysizeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumfamilysizeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumfamilysizeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
