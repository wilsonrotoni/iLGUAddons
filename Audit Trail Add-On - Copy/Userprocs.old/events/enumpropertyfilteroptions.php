<?php
	...
	function onBeforeAddEventenumpropertyfilteroptionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpropertyfilteroptionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpropertyfilteroptionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
