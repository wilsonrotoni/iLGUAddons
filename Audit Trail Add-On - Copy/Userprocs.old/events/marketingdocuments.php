<?php
	...
	function onBeforeAddEventmarketingdocumentsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventmarketingdocumentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventmarketingdocumentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
