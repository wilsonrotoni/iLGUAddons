<?php
	...
	function onBeforeAddEventenumgenderGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumgenderGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumgenderGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
