<?php
	...
	function onBeforeAddEventservicecategoriesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicecategoriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicecategoriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
