<?php
	...
	function onBeforeAddEventusermsgsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventusermsgsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventusermsgsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
