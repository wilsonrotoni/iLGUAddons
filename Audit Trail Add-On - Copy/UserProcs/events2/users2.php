<?php
	...
	function onBeforeAddEventusersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventusersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventusersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
