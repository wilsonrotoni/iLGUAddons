<?php
	...
	function onBeforeAddEventuserbranchesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventuserbranchesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventuserbranchesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
