<?php
	...
	function onBeforeAddEventenumposdiscchrgclassificationsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumposdiscchrgclassificationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumposdiscchrgclassificationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
