<?php
	...
	function onBeforeAddEventsalutationsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsalutationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsalutationsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
