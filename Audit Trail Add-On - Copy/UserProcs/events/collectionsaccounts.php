<?php
	...
	function onBeforeAddEventcollectionsaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcollectionsaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcollectionsaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
