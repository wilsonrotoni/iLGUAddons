<?php
	...
	function onBeforeAddEventapprovalstagesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventapprovalstagesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventapprovalstagesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
