<?php
	...
	function onBeforeAddEventemployeestatusGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventemployeestatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventemployeestatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
