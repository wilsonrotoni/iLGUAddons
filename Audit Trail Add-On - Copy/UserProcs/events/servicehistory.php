<?php
	...
	function onBeforeAddEventservicehistoryGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicehistoryGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicehistoryGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
