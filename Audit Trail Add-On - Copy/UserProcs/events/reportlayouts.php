<?php
	...
	function onBeforeAddEventreportlayoutsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventreportlayoutsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventreportlayoutsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
