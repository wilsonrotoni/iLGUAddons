<?php
	...
	function onBeforeAddEventenumjebooksGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumjebooksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumjebooksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
