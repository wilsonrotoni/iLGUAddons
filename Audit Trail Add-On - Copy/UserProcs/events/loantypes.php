<?php
	...
	function onBeforeAddEventloantypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventloantypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventloantypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
