<?php
	...
	function onBeforeAddEventenumposvaluetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumposvaluetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumposvaluetypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
