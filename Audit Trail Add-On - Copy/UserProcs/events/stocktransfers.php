<?php
	...
	function onBeforeAddEventstocktransfersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventstocktransfersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventstocktransfersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
