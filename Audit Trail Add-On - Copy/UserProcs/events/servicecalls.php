<?php
	...
	function onBeforeAddEventservicecallsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicecallsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicecallsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
