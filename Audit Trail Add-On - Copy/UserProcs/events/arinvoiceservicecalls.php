<?php
	...
	function onBeforeAddEventarinvoiceservicecallsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventarinvoiceservicecallsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventarinvoiceservicecallsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
