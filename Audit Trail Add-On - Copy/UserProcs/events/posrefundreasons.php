<?php
	...
	function onBeforeAddEventposrefundreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventposrefundreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventposrefundreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
