<?php
	...
	function onBeforeAddEventenumsboreceivableacctGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumsboreceivableacctGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumsboreceivableacctGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
