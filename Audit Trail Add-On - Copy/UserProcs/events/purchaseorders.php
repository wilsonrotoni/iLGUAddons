<?php
	...
	function onBeforeAddEventpurchaseordersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpurchaseordersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpurchaseordersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
