<?php
	...
	function onBeforeAddEventmobiletypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventmobiletypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventmobiletypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
