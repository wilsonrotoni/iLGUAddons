<?php
	...
	function onBeforeAddEventenumpopriorityGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpopriorityGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpopriorityGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
