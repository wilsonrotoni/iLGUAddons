<?php
	...
	function onBeforeAddEventemcorglentriesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventemcorglentriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventemcorglentriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
