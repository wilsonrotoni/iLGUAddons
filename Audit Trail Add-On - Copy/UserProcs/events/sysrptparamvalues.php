<?php
	...
	function onBeforeAddEventsysrptparamvaluesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsysrptparamvaluesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsysrptparamvaluesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
