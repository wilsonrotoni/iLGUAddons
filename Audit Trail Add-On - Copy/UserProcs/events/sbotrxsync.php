<?php
	...
	function onBeforeAddEventsbotrxsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsbotrxsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsbotrxsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
