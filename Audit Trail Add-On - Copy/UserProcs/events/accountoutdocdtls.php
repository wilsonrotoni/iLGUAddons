<?php
	...
	function onBeforeAddEventaccountoutdocdtlsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaccountoutdocdtlsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaccountoutdocdtlsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
