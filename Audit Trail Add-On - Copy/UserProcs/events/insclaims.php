<?php
	...
	function onBeforeAddEventinsclaimsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventinsclaimsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventinsclaimsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
