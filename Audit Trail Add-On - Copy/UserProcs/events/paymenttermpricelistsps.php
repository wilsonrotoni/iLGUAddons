<?php
	...
	function onBeforeAddEventpaymenttermpricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpaymenttermpricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpaymenttermpricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
