<?php
	...
	function onBeforeAddEventserviceactivitydeflocationGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserviceactivitydeflocationGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserviceactivitydeflocationGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
