<?php
	...
	function onBeforeAddEventenuminvsourcetypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenuminvsourcetypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenuminvsourcetypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
