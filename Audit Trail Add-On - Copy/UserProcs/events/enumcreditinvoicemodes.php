<?php
	...
	function onBeforeAddEventenumcreditinvoicemodesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcreditinvoicemodesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcreditinvoicemodesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
