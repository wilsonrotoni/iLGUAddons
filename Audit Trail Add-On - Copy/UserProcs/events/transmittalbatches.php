<?php
	...
	function onBeforeAddEventtransmittalbatchesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventtransmittalbatchesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventtransmittalbatchesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
