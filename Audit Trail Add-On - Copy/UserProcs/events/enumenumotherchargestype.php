<?php
	...
	function onBeforeAddEventenumenumotherchargestypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumenumotherchargestypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumenumotherchargestypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
