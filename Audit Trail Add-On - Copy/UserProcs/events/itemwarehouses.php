<?php
	...
	function onBeforeAddEventitemwarehousesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitemwarehousesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitemwarehousesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
