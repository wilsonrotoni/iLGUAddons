<?php
	...
	function onBeforeAddEventenumcollectionreftypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumcollectionreftypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumcollectionreftypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
