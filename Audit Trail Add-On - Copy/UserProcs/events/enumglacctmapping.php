<?php
	...
	function onBeforeAddEventenumglacctmappingGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumglacctmappingGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumglacctmappingGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
