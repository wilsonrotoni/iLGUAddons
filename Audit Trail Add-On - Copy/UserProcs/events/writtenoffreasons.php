<?php
	...
	function onBeforeAddEventwrittenoffreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventwrittenoffreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventwrittenoffreasonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
