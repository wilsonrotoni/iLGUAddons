<?php
	...
	function onBeforeAddEventcompositionpartsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcompositionpartsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcompositionpartsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
