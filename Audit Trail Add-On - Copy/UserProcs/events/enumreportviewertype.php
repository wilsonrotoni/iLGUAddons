<?php
	...
	function onBeforeAddEventenumreportviewertypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumreportviewertypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumreportviewertypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
