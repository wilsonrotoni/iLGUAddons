<?php
	...
	function onBeforeAddEventregionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventregionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventregionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
