<?php
	...
	function onBeforeAddEventbranchgroupinterbranchtrxtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchgroupinterbranchtrxtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchgroupinterbranchtrxtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
