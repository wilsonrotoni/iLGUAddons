<?php
	...
	function onBeforeAddEventenumapprovalstagebranchtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumapprovalstagebranchtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumapprovalstagebranchtypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
