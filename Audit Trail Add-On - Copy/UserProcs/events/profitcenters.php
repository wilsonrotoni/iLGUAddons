<?php
	...
	function onBeforeAddEventprofitcentersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventprofitcentersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventprofitcentersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
