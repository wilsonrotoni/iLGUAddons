<?php
	...
	function onBeforeAddEventpcgeneralexpensestypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpcgeneralexpensestypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpcgeneralexpensestypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
