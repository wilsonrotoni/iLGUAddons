<?php
	...
	function onBeforeAddEventsmsmobilesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsmsmobilesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsmsmobilesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
