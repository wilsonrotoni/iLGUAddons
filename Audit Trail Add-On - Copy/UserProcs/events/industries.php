<?php
	...
	function onBeforeAddEventindustriesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventindustriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventindustriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
