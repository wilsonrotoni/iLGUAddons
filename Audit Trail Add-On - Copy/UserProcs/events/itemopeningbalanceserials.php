<?php
	...
	function onBeforeAddEventitemopeningbalanceserialsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitemopeningbalanceserialsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitemopeningbalanceserialsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
