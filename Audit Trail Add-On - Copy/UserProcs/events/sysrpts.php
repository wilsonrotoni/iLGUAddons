<?php
	...
	function onBeforeAddEventsysrptsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsysrptsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsysrptsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
