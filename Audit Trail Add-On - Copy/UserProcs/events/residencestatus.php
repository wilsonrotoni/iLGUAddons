<?php
	...
	function onBeforeAddEventresidencestatusGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventresidencestatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventresidencestatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
