<?php
	...
	function onBeforeAddEventglopenbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventglopenbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventglopenbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
