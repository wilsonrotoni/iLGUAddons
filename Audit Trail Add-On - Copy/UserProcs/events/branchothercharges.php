<?php
	...
	function onBeforeAddEventbranchotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
