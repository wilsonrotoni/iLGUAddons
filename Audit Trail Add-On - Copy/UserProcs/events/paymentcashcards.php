<?php
	...
	function onBeforeAddEventpaymentcashcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpaymentcashcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpaymentcashcardsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
