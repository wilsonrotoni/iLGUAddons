<?php
	...
	function onBeforeAddEventcollectionschequesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcollectionschequesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcollectionschequesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
