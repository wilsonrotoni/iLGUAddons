<?php
	...
	function onBeforeAddEventhousebankaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventhousebankaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventhousebankaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
