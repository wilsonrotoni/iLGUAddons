<?php
	...
	function onBeforeAddEventpaymentbanksGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpaymentbanksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpaymentbanksGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
