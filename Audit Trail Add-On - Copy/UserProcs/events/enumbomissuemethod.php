<?php
	...
	function onBeforeAddEventenumbomissuemethodGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumbomissuemethodGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumbomissuemethodGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
