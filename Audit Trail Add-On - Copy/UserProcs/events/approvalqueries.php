<?php
	...
	function onBeforeAddEventapprovalqueriesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventapprovalqueriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventapprovalqueriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
