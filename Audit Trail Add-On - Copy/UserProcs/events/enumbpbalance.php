<?php
	...
	function onBeforeAddEventenumbpbalanceGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumbpbalanceGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumbpbalanceGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
