<?php
	...
	function onBeforeAddEventserialpricesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserialpricesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserialpricesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
