<?php
	...
	function onBeforeAddEventserviceactivitydefsubjectGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserviceactivitydefsubjectGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserviceactivitydefsubjectGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
