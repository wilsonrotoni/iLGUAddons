<?php
	...
	function onBeforeAddEventcolorsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcolorsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcolorsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
