<?php
	...
	function onBeforeAddEventstockcardissuanceGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventstockcardissuanceGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventstockcardissuanceGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
