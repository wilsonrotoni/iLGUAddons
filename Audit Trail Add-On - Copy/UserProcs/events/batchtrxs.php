<?php
	...
	function onBeforeAddEventbatchtrxsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbatchtrxsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbatchtrxsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
