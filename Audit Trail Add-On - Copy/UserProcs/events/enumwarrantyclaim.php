<?php
	...
	function onBeforeAddEventenumwarrantyclaimGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumwarrantyclaimGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumwarrantyclaimGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
