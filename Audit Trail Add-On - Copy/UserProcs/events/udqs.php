<?php
	...
	function onBeforeAddEventudqsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventudqsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventudqsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
