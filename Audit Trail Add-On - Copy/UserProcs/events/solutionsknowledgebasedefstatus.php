<?php
	...
	function onBeforeAddEventsolutionsknowledgebasedefstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsolutionsknowledgebasedefstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsolutionsknowledgebasedefstatusGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
