<?php
	...
	function onBeforeAddEventenumjvsagltypesIBGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumjvsagltypesIBGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumjvsagltypesIBGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
