<?php
	...
	function onBeforeAddEventenumbptypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumbptypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumbptypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
