<?php
	...
	function onBeforeAddEventapprovaltermsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventapprovaltermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventapprovaltermsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
