<?php
	...
	function onBeforeAddEventdocnosGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdocnosGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdocnosGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
