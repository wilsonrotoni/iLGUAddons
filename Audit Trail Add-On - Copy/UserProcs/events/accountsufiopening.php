<?php
	...
	function onBeforeAddEventaccountsufiopeningGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaccountsufiopeningGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaccountsufiopeningGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
