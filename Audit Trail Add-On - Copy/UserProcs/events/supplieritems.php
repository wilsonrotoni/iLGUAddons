<?php
	...
	function onBeforeAddEventsupplieritemsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsupplieritemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsupplieritemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
