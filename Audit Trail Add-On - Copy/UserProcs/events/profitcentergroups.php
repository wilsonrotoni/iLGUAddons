<?php
	...
	function onBeforeAddEventprofitcentergroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventprofitcentergroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventprofitcentergroupsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
