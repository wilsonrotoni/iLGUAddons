<?php
	...
	function onBeforeAddEventglopeningbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventglopeningbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventglopeningbalancesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
