<?php
	...
	function onBeforeAddEventservicecallexpenselabortravelGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicecallexpenselabortravelGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicecallexpenselabortravelGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
