<?php
	...
	function onBeforeAddEventenumprodordertypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumprodordertypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumprodordertypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
