<?php
	...
	function onBeforeAddEventenumobjectsettingpostasGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumobjectsettingpostasGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumobjectsettingpostasGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
