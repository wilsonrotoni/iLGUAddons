<?php
	...
	function onBeforeAddEventstocktransferlossesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventstocktransferlossesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventstocktransferlossesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
