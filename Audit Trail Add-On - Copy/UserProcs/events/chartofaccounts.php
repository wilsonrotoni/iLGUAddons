<?php
	...
	function onBeforeAddEventchartofaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventchartofaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventchartofaccountsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
