<?php
	...
	function onBeforeAddEventreligionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventreligionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventreligionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
