<?php
	...
	function onBeforeAddEventbrancheslistGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbrancheslistGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbrancheslistGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
