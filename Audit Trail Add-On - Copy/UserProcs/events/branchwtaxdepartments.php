<?php
	...
	function onBeforeAddEventbranchwtaxdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventbranchwtaxdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventbranchwtaxdepartmentsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
