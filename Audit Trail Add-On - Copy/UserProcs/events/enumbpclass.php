<?php
	...
	function onBeforeAddEventenumbpclassGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumbpclassGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumbpclassGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
