<?php
	...
	function onBeforeAddEventitemsquantitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitemsquantitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitemsquantitiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
