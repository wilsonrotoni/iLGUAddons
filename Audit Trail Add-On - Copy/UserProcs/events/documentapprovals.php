<?php
	...
	function onBeforeAddEventdocumentapprovalsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventdocumentapprovalsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventdocumentapprovalsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
