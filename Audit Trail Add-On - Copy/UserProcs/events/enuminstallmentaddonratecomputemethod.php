<?php
	...
	function onBeforeAddEventenuminstallmentaddonratecomputemethodGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenuminstallmentaddonratecomputemethodGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenuminstallmentaddonratecomputemethodGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
