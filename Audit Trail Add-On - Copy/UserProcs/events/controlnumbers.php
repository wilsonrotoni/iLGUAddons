<?php
	...
	function onBeforeAddEventcontrolnumbersGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcontrolnumbersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcontrolnumbersGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
