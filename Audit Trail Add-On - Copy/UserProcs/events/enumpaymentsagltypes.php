<?php
	...
	function onBeforeAddEventenumpaymentsagltypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumpaymentsagltypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumpaymentsagltypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
