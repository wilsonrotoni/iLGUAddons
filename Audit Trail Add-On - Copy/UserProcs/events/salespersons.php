<?php
	...
	function onBeforeAddEventsalespersonsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsalespersonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsalespersonsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
