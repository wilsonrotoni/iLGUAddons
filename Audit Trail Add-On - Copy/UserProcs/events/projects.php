<?php
	...
	function onBeforeAddEventprojectsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventprojectsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventprojectsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
