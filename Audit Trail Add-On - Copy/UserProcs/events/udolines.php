<?php
	...
	function onBeforeAddEventudolinesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventudolinesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventudolinesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
