<?php
	...
	function onBeforeAddEventservicecalldefproblemtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicecalldefproblemtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicecalldefproblemtypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
