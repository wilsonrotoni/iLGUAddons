<?php
	...
	function onBeforeAddEventenumsalesstagesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumsalesstagesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumsalesstagesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
