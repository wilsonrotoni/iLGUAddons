<?php
	...
	function onBeforeAddEventcontrolnumberscustomerGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcontrolnumberscustomerGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcontrolnumberscustomerGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
