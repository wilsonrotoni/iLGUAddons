<?php
	...
	function onBeforeAddEventserialdocumentationexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserialdocumentationexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserialdocumentationexpensesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
