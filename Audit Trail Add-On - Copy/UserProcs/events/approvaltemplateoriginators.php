<?php
	...
	function onBeforeAddEventapprovaltemplateoriginatorsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventapprovaltemplateoriginatorsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventapprovaltemplateoriginatorsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
