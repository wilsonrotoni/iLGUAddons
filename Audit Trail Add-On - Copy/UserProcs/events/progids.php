<?php
	...
	function onBeforeAddEventprogidsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventprogidsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventprogidsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
