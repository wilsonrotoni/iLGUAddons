<?php
	...
	function onBeforeAddEventproductionprocessesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventproductionprocessesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventproductionprocessesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
