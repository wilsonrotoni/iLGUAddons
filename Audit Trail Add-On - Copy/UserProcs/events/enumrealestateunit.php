<?php
	...
	function onBeforeAddEventenumrealestateunitGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumrealestateunitGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumrealestateunitGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
