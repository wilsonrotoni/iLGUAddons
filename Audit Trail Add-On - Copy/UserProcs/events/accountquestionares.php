<?php
	...
	function onBeforeAddEventaccountquestionaresGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaccountquestionaresGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaccountquestionaresGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
