<?php
	...
	function onBeforeAddEventalertqueriesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventalertqueriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventalertqueriesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
