<?php
	...
	function onBeforeAddEventitempricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventitempricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventitempricelistspsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
