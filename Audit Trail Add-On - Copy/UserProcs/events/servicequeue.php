<?php
	...
	function onBeforeAddEventservicequeueGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicequeueGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicequeueGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
