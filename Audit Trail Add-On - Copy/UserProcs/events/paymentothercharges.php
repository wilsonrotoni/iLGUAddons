<?php
	...
	function onBeforeAddEventpaymentotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventpaymentotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventpaymentotherchargesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
