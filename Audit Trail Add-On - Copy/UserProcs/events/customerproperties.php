<?php
	...
	function onBeforeAddEventcustomerpropertiesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcustomerpropertiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcustomerpropertiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
