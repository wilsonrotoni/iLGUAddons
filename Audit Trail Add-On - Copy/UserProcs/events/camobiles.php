<?php
	...
	function onBeforeAddEventcamobilesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcamobilesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcamobilesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
