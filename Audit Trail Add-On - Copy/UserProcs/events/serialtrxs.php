<?php
	...
	function onBeforeAddEventserialtrxsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventserialtrxsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventserialtrxsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
