<?php
	...
	function onBeforeAddEventaccountsactionsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventaccountsactionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventaccountsactionsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
