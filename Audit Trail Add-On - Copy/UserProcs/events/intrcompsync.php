<?php
	...
	function onBeforeAddEventintrcompsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventintrcompsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventintrcompsyncGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
