<?php
	...
	function onBeforeAddEventservicedefstateGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicedefstateGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicedefstateGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
