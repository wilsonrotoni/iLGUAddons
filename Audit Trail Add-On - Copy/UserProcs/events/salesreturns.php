<?php
	...
	function onBeforeAddEventsalesreturnsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsalesreturnsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsalesreturnsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
