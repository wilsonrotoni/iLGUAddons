<?php
	...
	function onBeforeAddEventenumbptypeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumbptypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumbptypeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
