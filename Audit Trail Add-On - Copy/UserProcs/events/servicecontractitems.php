<?php
	...
	function onBeforeAddEventservicecontractitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicecontractitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicecontractitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
