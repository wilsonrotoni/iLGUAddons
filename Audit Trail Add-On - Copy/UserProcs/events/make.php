<?php
	...
	function onBeforeAddEventmakeGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventmakeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventmakeGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
