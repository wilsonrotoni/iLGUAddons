<?php
	...
	function onBeforeAddEventsupplierwtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsupplierwtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsupplierwtaxesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
