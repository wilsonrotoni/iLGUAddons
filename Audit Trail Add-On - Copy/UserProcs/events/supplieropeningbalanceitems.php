<?php
	...
	function onBeforeAddEventsupplieropeningbalanceitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventsupplieropeningbalanceitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventsupplieropeningbalanceitemsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
