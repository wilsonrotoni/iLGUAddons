<?php
	...
	function onBeforeAddEventservicecallitempartsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventservicecallitempartsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventservicecallitempartsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
