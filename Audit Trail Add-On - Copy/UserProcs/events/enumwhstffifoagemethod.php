<?php
	...
	function onBeforeAddEventenumwhstffifoagemethodGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumwhstffifoagemethodGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumwhstffifoagemethodGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
