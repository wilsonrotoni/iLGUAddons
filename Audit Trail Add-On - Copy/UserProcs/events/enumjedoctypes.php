<?php
	...
	function onBeforeAddEventenumjedoctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumjedoctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumjedoctypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
