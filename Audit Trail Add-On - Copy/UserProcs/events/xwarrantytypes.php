<?php
	...
	function onBeforeAddEventxwarrantytypesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventxwarrantytypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventxwarrantytypesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
