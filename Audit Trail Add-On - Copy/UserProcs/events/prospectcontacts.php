<?php
	...
	function onBeforeAddEventprospectcontactsGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventprospectcontactsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventprospectcontactsGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
