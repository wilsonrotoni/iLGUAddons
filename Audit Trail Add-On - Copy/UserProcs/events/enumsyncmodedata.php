<?php
	...
	function onBeforeAddEventenumsyncmodedataGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventenumsyncmodedataGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventenumsyncmodedataGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
