<?php
	...
	function onBeforeAddEventapprovaltemplatestagesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventapprovaltemplatestagesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventapprovaltemplatestagesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
