<?php
	...
	function onBeforeAddEventcapropertiesGPSAuditTrail(&$objTable) {
		global $httpVars;
	...
	function onBeforeUpdateEventcapropertiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
	...
	function onBeforeDeleteEventcapropertiesGPSAuditTrail(&$objTable) {
		global $httpVars;
		global $objConnection;
		global $page;
