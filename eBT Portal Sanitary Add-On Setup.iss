[Setup]
AppId=eBTPortalSanitaryAddOnSetup
AppName=eBT Portal Sanitary AddOn Setup
AppVerName=eBT Portal Sanitary AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalSanitaryAddOnSetup.exe
Compression=lzma
...
[Files]
Source: Sanitary Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
