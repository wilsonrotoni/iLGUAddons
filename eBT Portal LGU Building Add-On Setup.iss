[Setup]
AppId=eBTPortalLGUBuildingAddOnSetup
AppName=eBT Portal LGU Building AddOn Setup
AppVerName=eBT Portal LGU Building AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUBuildingAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Building Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
