function u_ajaxloadu_bplsubdivisions(p_elementid, p_u_kind,p_value,p_filler) {
	http = getHTTPObject(); // We create the HTTP Object
	document.getElementById(p_elementid).innerHTML = "<option>Loading..</option>"
	http.open("GET", "udp.php?ajax=1&objectcode=u_ajaxslu_bplsudivisions&u_subdivisions=" + p_u_kind + "&value=" + p_value + "&filler=" + p_filler, false);
