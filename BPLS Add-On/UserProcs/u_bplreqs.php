...
$objGrid->columncfl("u_feecode","OpenCFLfs()");
$objGrid->columncfl("u_feedesc","OpenCFLfs()");

$objGrid->columnwidth("code",10);
$objGrid->columnwidth("u_feecode",10);
$objGrid->columnwidth("u_feedesc",25);
$objGrid->columnwidth("u_common",7);
$objGrid->columnwidth("u_office",20);
$objGrid->columnwidth("u_reqdtls",9);
$objGrid->columnwidth("u_chkfee",8);
$objGrid->columnwidth("u_uchkfee",9);
$objGrid->columnwidth("u_seqno",7);
?> 
