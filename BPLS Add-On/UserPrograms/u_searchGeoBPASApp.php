<?php
	...
	$page->objectcode = "u_searchGeoBPASApp";
	$page->paging->formid = "./UDP.php?&objectcode=u_searchGeoBPASApp";
...
//	$filterExp = genSQLFilterDate("A.U_DUEDATE",$filterExp,$httpVars['df_u_duedate'],null,"<=");
	...
	$objrs = new recordset(null,$objConnection);
        $odbccon = @odbc_connect("bpas_ro","bpas_ro","Qwerty123",SQL_CUR_USE_ODBC) or  die("<B>Error!</B> Couldn't Connect To Database. Error Code:  ".odbc_error());
