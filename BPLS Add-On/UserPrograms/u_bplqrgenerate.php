...
//	include_once("./inc/formaccess.php");
        ...
        $page->objectcode = "u_bplqrgenerate";
	$page->paging->formid = "./UDP.php?&objectcode=u_bplqrgenerate";
    ...
    function onFormAction($action) {
        ...
        if($action=="migratebplgeo"){   
                ...
                if ($actionReturn) {
                        ...
                        $objRs->queryopen("SELECT CODE FROM U_BPLMDS WHERE U_ISGENERATEDQR = 0 AND U_YEAR = 2022 ");
                        while ($objRs->queryfetchrow("NAME")) {
                                ...
                                $codeContents = "https://api.bacoor.gov.ph/bizper/or_no.php?accountnumber=".$objRs->fields["CODE"];

                                $fileName = $objRs->fields["CODE"].'.png';
                                ...
                                if (!file_exists($pngAbsoluteFilePath)) {
                                    ...
                                    if ($objBPLMDs->getbysql("CODE='".$objRs->fields["CODE"]."'")) {
...
<td>
      <div style="border:0px solid gray" >
        <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td >&nbsp;</td>
                <td  >&nbsp;<a class="button" href="" onClick="formSubmit('migratebplgeo');return false;">Generate QR</a></td>
