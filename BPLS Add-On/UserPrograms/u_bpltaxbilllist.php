<?php
	...
	$page->objectcode = "u_bpltaxbilllist";
	$page->paging->formid = "./UDP.php?&objectcode=u_bpltaxbilllist";
	$page->formid = "./UDO.php?&objectcode=U_BPLTAXBILL";
...
//	$objGrid->columnvisibility("viewpaymenthistory",false);
        
	$objGrid->columntitle("taxcredit","Tax Credit");
	...
	$objGrid->columnwidth("taxcredit",12);
        
	$objGrid->columntitle("adjustment","Adjustment");
	$objGrid->columnalignment("adjustment","center");
	$objGrid->columninput("adjustment","type","link");
	$objGrid->columninput("adjustment","caption","");
	$objGrid->columnwidth("adjustment",12);
//	$objGrid->columnvisibility("viewpaymenthistory",false);
	...
	if ($page->getitemstring("u_businessname")!="" || $page->getitemstring("u_ownername")!="" || $page->getitemstring("u_corpname")!="" || $page->getitemstring("u_appdatefr")!="" || $page->getitemstring("u_appdateto")!="" || $page->getitemstring("acctno")!="" || $page->getitemstring("docno")!="" || $page->getitemstring("u_bunitno")!="" || $page->getitemstring("u_bfloorno")!="" || $page->getitemstring("u_bvillage")!=""  || $page->getitemstring("u_bstreet")!=""  || $page->getitemstring("u_bblock")!=""  || $page->getitemstring("u_bbrgy")!="" || $page->getitemstring("u_bbldgname")!="" || $page->getitemstring("u_baddressno")!="" || $page->getitemstring("u_bphaseno")!="" || $page->getitemstring("u_blotno")!="") {
		...
		$page->paging_recordcount($objrs->recordcount());
			...
			if ($objrs->fields["U_YEAR"]<date('Y')) {
				...
				$objGrid->setitem(null,"adjustment","");
				...
				$objGrid->setitem(null,"adjustment","[For Adjustment]");
				...
				switch (column) {
					case "print":
						...
						*/
						break;
                                        case "taxcredit":
						OpenPopup(540,330,"./udo.php?&objectcode=u_bpltaxcredits&formAction=e","Tax Credit");
						break;
					case "adjustment":
						setInput("u_bpno",getTableInput("T1","docno",row));
						setInput("u_apptype","ADJUSTMENT");
						setKey("keys","");
					...
					case "viewpaymenthistory":
                                                OpenPopup(1280,600,"./udp.php?&objectcode=u_bplbusinessledger&df_refno2="+getTableInput("T1","u_appno",row)+"","Business Ledger");
						break;
                                        case "action2":
						setInput("u_bpno",getTableInput("T1","docno",row));
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;BPL Tax Bill List&nbsp;</td>
