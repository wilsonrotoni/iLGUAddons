...
<div <?php genPopWinHDivHtml("popupFrameAuction","Auction TD",10,30,550,false) ?>>
...
<td>
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<tr class="fillerRow5px"><td colspan="2"></td></tr>
		<tr><td >&nbsp;</td>
			<td align="right"><a class="button" href="" onClick="unAuctionTDGPSRPTAS();return false;" >Confirm</a></td>
		</tr>
		<tr class="fillerRow5px"><td colspan="2"></td></tr>
	</table>
</td>
