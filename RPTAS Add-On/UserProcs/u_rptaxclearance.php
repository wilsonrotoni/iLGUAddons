...
function onAfterDefaultLGURPTAS() { 
	...
	global $objGrids;
        ...
        $page->setitem("u_yearfr",date('Y'));
        $page->setitem("u_yearto",date('Y'));
...
$objGrids[0]->columnwidth("u_orno",15);
...
$objGrids[0]->columnattributes("u_kind","disabled");
$objGrids[0]->columnattributes("u_bilyear","disabled");
$objGrids[0]->columnattributes("u_marketvalue","disabled");
$objGrids[0]->columnattributes("u_assvalue","disabled");
