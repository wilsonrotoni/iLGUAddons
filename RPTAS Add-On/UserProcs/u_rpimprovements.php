...
function onPrepareEditGPSRPTAS(&$override,&$filterExp) { 
	return true;
}
...
$objGrids[0]->columnwidth("u_gryear",10);
$objGrids[0]->columnalignment("u_gryear","right");

//$objGrid->columnwidth("u_gryear",6);
//$objGrid->columnalignment("u_gryear","right");
