<?php
	...
	$progid = "u_updateGEORPTASSuperseded";
        ...
        if($action=="migraterptgeo"){   
                ...
                if ($actionReturn) {
                     $odbcres = @odbc_exec($odbccon,"SELECT
                                                        ...
                                                        A.TDNId
                                                        FROM PATAS.TDN A 
                                                        ORDER BY A.PropertyTypeId,A.TDNId") or die("<B>Error!</B> Couldn't Run Query 12:<br><br>" . $query . "<br><br>Error Code:  ".odbc_error());
                                            ...
                                            if($actionReturn){
                                                   $odbcres2 = @odbc_exec($odbccon,"SELECT B.TDNID AS PREVDOCNO,A.TDN AS PREVTD,A.PIN AS PREVPIN,A.OwnerName AS PREVOWNER,A.PreviousImprovementValue,B.YearEffectivity AS PREVEFFYEAR,B.QuarterEffectivity AS PREVEFFQTR,B.RecordingPerson AS PREVRECORDPERSON,B.DateRecorded AS PREVDATERECORD FROM PATAS.TDNHistory A
                                                    ...
                                                    while(odbc_fetch_row($odbcres2)) {
                                                           ...
                                                           $obju_Faas2p->docid = $obju_Faas1->docid;
                                                           $obju_Faas2p->lineid = getNextIDByBranch("u_rpfaas1p",$objConnection);
                                            ...
                                            if($actionReturn){
                                                  $odbcres2 = @odbc_exec($odbccon,"SELECT B.TDNID AS PREVDOCNO,A.TDN AS PREVTD,A.PIN AS PREVPIN,A.OwnerName AS PREVOWNER,A.PreviousImprovementValue,B.YearEffectivity AS PREVEFFYEAR,B.QuarterEffectivity AS PREVEFFQTR,B.RecordingPerson AS PREVRECORDPERSON,B.DateRecorded AS PREVDATERECORD FROM PATAS.TDNHistory A
                                                   ...
                                                   while(odbc_fetch_row($odbcres2)) {
                                                          ...
                                                          $obju_Faas3p->docid = $obju_Faas1->docid;
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Update Geodata Records Prev Assessment&nbsp;</td>
