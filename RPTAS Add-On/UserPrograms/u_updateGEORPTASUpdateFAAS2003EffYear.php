<?php
	...
	$progid = "u_updateGEORPTASUpdateFAAS2003EffYear";
...
//	include_once("./inc/formaccess.php");
        ...
        $page->objectcode = "u_updateGEORPTASUpdateFAAS2003EffYear";
    ...
    function onFormAction($action) {
        ...
        if($action=="migraterptgeo"){   
                ...
                if ($actionReturn) {
                     $odbcres = @odbc_exec($odbccon,"SELECT TDNId,AssessmentEffectivity,PropertyTypeId FROM PATAS.TDN WHERE RevisionYear = 2003 AND AssessmentEffectivity is not null") or die("<B>Error!</B> Couldn't Run Query 12:<br><br>" . $query . "<br><br>Error Code:  ".odbc_error());
...
<script language="JavaScript">
	...
	function onFormSubmit(action) {
            if(action=="migraterptgeo"){
                    if(confirm("Update GEO Records FAAS Effectivity Year?")) return true;
                    else  return false;
            }
	}  
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;Update Geodata FAAS Effectivity Year&nbsp;</td>
...
<td>
      <div style="border:0px solid gray" >
        <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td >&nbsp;</td>
                <td  >&nbsp;<a class="button" href="" onClick="formSubmit('migraterptgeo');return false;">Update GeoData Records Eff Year</a></td>
                <td ></td>
                <td align=left>&nbsp;</td>
            </tr>
        </table>
