<?php
	...
	$page->objectcode = "U_LRALIST";
	$page->paging->formid = "./UDP.php?&objectcode=u_lralist";
...
//	$filterExp = genSQLFilterString("A.U_TDNO",$filterExp,$httpVars['df_u_tdno'],null,null,true);
	...
	if ($page->getitemstring("u_ownername")!="" || $page->getitemstring("u_adminname")!="" || $page->getitemstring("u_barangay")!="" || $page->getitemstring("u_oldbarangay")!="" || $page->getitemstring("u_tctno")!="" || $page->getitemstring("u_prevtdno")!="" || $page->getitemstring("u_prevarpno2")!="" || $page->getitemstring("u_surveyno")!="" || $page->getitemstring("u_pin")!="" || $page->getitemstring("u_varpno")!="" || $page->getitemstring("u_cadlotno")!="" ) {
            if ($page->getitemstring("u_kind")=="") {
                    ...
                    $objrs->queryopenext("select  A.U_TRXCODE,A.U_REVISIONYEAR,IF(A.U_LOCATION='',A.U_SUBDIVISION,A.U_LOCATION) AS U_LOCATION,0 AS U_TOTALAREASQM, '' AS U_BLOCK, '' AS U_LOTNO,A.U_TEMPORARY,A.U_ASSVALUE,A.U_MARKETVALUE,'' AS U_TCTNO,A.DOCNO,A.U_NOTICENO,A.U_VARPNO, A.U_TDNO, if(A.U_PIN='',concat(a.u_prefix,'-',a.u_suffix),a.u_pin) as U_PIN, 'MACHINERY' AS U_KIND, A.U_OWNERNAME, A.U_ADMINNAME,A.U_PREVTDNO, A.U_PREVARPNO2, A.U_CADLOTNO, '' as U_SURVEYNO, A.U_BARANGAY, A.U_OLDBARANGAY, A.U_MUNICIPALITY, A.U_CITY, A.U_PROVINCE, A.U_CANCELLED, A.DOCSTATUS FROM U_RPFAAS3 A  WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
            }
        }
		//var_dump($objrs->sqls);
...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	  <td class="labelPageHeader" >&nbsp;LRA Data List&nbsp;</td>
