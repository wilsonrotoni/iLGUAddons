...
//	$filterExp = genSQLFilterString("A.U_REVISIONYEAR",$filterExp,$httpVars['df_u_revisionyear'],null,null,false);
	...
	if ($page->getitemstring("u_ownername")!="" || $page->getitemstring("u_adminname")!="" || $page->getitemstring("u_barangay")!=""  || $page->getitemstring("u_tctno")!="" || $page->getitemstring("u_prevtdno")!="" || $page->getitemstring("u_surveyno")!="" || $page->getitemstring("u_pin")!="" || $page->getitemstring("u_varpno")!="" || $page->getitemstring("u_cadlotno")!="" ) {
            if ($page->getitemstring("u_kind")=="") {
                    $objrs->queryopenext("SELECT A.U_TOTALAREASQM,A.U_BLOCK,A.U_LOTNO,A.U_ASSVALUE,A.U_MARKETVALUE,A.U_TCTNO,A.DOCNO,A.U_VARPNO, A.U_TDNO, A.U_PIN, A.U_KIND, A.U_OWNERNAME, A.U_ADMINNAME, A.U_PREVTDNO, A.U_CADLOTNO, A.U_SURVEYNO, A.U_BARANGAY, A.U_MUNICIPALITY, A.U_CITY, A.U_PROVINCE, A.U_CANCELLED, A.DOCSTATUS FROM( SELECT A.U_TOTALAREASQM,A.U_BLOCK,A.U_LOTNO,A.U_ASSVALUE,A.U_MARKETVALUE,A.U_TCTNO,A.DOCNO,A.U_VARPNO, A.U_TDNO, A.U_PIN, 'LAND' AS U_KIND, A.U_OWNERNAME, A.U_ADMINNAME,A.U_PREVTDNO, A.U_CADLOTNO, A.U_SURVEYNO, A.U_BARANGAY, A.U_MUNICIPALITY, A.U_CITY, A.U_PROVINCE, A.U_CANCELLED, A.DOCSTATUS FROM U_RPFAAS1 A  WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp  UNION ALL select A.U_TOTALAREASQM,A.U_BLOCK,A.U_LOTNO,A.U_ASSVALUE,A.U_MARKETVALUE,A.U_TCTNO,A.DOCNO,A.U_VARPNO, A.U_TDNO, if(A.U_PIN='',concat(a.u_prefix,'-',a.u_suffix),a.u_pin) AS U_PIN, 'BUILDING' AS U_KIND, A.U_OWNERNAME, A.U_ADMINNAME,A.U_PREVTDNO, A.U_CADLOTNO, A.U_SURVEYNO, A.U_BARANGAY, A.U_MUNICIPALITY, A.U_CITY, A.U_PROVINCE, A.U_CANCELLED, A.DOCSTATUS FROM U_RPFAAS2 A  WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp UNION ALL select 0 AS U_TOTALAREASQM,'' AS U_BLOCK,'' AS U_LOTNO,A.U_ASSVALUE,A.U_MARKETVALUE,'' AS U_TCTNO,A.DOCNO,A.U_VARPNO, A.U_TDNO, if(A.U_PIN='',concat(a.u_prefix,'-',a.u_suffix),a.u_pin) AS U_PIN, 'MACHINERY' AS U_KIND, A.U_OWNERNAME, A.U_ADMINNAME,A.U_PREVTDNO, A.U_CADLOTNO, '' as U_SURVEYNO, A.U_BARANGAY, A.U_MUNICIPALITY, A.U_CITY, A.U_PROVINCE, A.U_CANCELLED, A.DOCSTATUS FROM U_RPFAAS3 A  WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp ) AS A", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
            } elseif ($page->getitemstring("u_kind")=="L") {
                    $objrs->queryopenext("select A.U_TOTALAREASQM,A.U_BLOCK,A.U_LOTNO,A.U_ASSVALUE,A.U_MARKETVALUE,A.U_TCTNO,A.DOCNO,A.U_VARPNO, A.U_TDNO, A.U_PIN, 'LAND' AS U_KIND, A.U_OWNERNAME, A.U_ADMINNAME,A.U_PREVTDNO, A.U_CADLOTNO, A.U_SURVEYNO, A.U_BARANGAY, A.U_MUNICIPALITY, A.U_CITY, A.U_PROVINCE, A.U_CANCELLED, A.DOCSTATUS FROM U_RPFAAS1 A  WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
            } elseif ($page->getitemstring("u_kind")=="B") {
                    $objrs->queryopenext("select A.U_TOTALAREASQM,A.U_BLOCK,A.U_LOTNO,A.U_ASSVALUE,A.U_MARKETVALUE,A.U_TCTNO,A.DOCNO,A.U_VARPNO, A.U_TDNO, if(A.U_PIN='',concat(a.u_prefix,'-',a.u_suffix),a.u_pin) as U_PIN, 'BUILDING' AS U_KIND, A.U_OWNERNAME, A.U_ADMINNAME,A.U_PREVTDNO, A.U_CADLOTNO, A.U_SURVEYNO, A.U_BARANGAY, A.U_MUNICIPALITY, A.U_CITY, A.U_PROVINCE, A.U_CANCELLED, A.DOCSTATUS FROM U_RPFAAS2 A  WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
            } elseif ($page->getitemstring("u_kind")=="M") {
                    $objrs->queryopenext("select 0 AS U_TOTALAREASQM, '' AS U_BLOCK, '' AS U_LOTNO,A.U_ASSVALUE,A.U_MARKETVALUE,'' AS U_TCTNO,A.DOCNO,A.U_VARPNO, A.U_TDNO, if(A.U_PIN='',concat(a.u_prefix,'-',a.u_suffix),a.u_pin) as U_PIN, 'MACHINERY' AS U_KIND, A.U_OWNERNAME, A.U_ADMINNAME,A.U_PREVTDNO, A.U_CADLOTNO, '' as U_SURVEYNO, A.U_BARANGAY, A.U_MUNICIPALITY, A.U_CITY, A.U_PROVINCE, A.U_CANCELLED, A.DOCSTATUS FROM U_RPFAAS3 A  WHERE A.COMPANY = '$company' AND A.BRANCH = '$branch' $filterExp", $objGrid->sortby,"",$objGrid->sortas,$page->paging->currentrow,$page->paging->numperpage,"");
            }
        }
		//var_dump($objrs->sqls);
