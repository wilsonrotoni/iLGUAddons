<tr><td>
	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
                    ...
                    <td width="168" ><label <?php $page->businessobject->items->draw->caption("u_type") ?>>Type</label></td>
                    <td width="168" align=left>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_type") ?>></select></td>
		</tr>
		<tr>
...
<tr><td>
	<div class="tabber" id="tab1">
		<div class="tabbertab" title="Assessment Level">	
