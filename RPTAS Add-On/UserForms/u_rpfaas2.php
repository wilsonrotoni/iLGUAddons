	...
	<div class="tabber" id="tab1">
				...
				<table class="tableFreeForm" width="100%" border="0" cellpadding="0" cellspacing="0" >
					<tr>
					  <td colspan="4">&nbsp;</td>
                                          ...
                                          <td colspan="3">&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_revisionyear",null,null,null,null,null) ?>></select></td>
					  <td width="8">&nbsp;</td>
					  <td width="8">&nbsp;</td>
					  <td width="8">&nbsp;</td>
				  </tr>
					...
					<tr><td><input type="radio" <?php $page->businessobject->items->userfields->draw->radio("u_ownertype","C") ?> /><label <?php $page->businessobject->items->userfields->draw->caption("u_ownercompanyname") ?>>Name/s</label></td>
					  <td colspan="3">&nbsp;<input type="text" size="43" <?php $page->businessobject->items->userfields->draw->text("u_ownercompanyname") ?>/></td>
						<td width="217"><label <?php $page->businessobject->items->userfields->draw->caption("u_ownertelno") ?>>Tel No.</label></td>
					...
					<tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_owneraddress") ?>>Address</label></td>
                                            <td colspan="3">&nbsp;<input type="text" size="43" <?php $page->businessobject->items->userfields->draw->text("u_owneraddress") ?>/></td>
					...
					<tr><td colspan="4"><label class="lblobjs"><b>ADMINISTRATOR</b></label></td>
						...
						<td>&nbsp;</td>
                                         ...
                                         <tr><td><label <?php $page->businessobject->items->userfields->draw->caption("u_adminname") ?>>Name/s</label></td>
                                            <td colspan="3">&nbsp;<input type="text" size="43" <?php $page->businessobject->items->userfields->draw->text("u_adminname") ?>/></td>
                                            <td ></td>
                                            <td colspan="3">&nbsp;</td>
                                            <td>&nbsp;</td>
                                         </tr>
					...
					<tr><td><label <?php $page->businessobject->items->userfields->draw->caption("u_adminaddress") ?>>Address</label></td>
                                            <td colspan="3">&nbsp;<input type="text" size="43" <?php $page->businessobject->items->userfields->draw->text("u_adminaddress") ?>/></td>
                                            <td width="217"><label <?php $page->businessobject->items->userfields->draw->caption("u_admintin") ?>>TIN</label></td>
					...
					<tr>
                                        <td ><label class="lblobjs"><b>BUILDING LOCATION</b></label></td>
                                        <td colspan="4" >&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_barangay",null,null,null,null,"width:200px") ?>></select></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>    <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_municipality") ?>>Municipality</label></td>
                                            ...
                                            <td colspan="3">&nbsp;<input type="text" size="13" <?php $page->businessobject->items->userfields->draw->text("u_city") ?>/><label class="lblobjs">&nbsp;/&nbsp;</label><input type="text" size="13" <?php $page->businessobject->items->userfields->draw->text("u_province") ?>/></td>
                                            <td>&nbsp;</td>
                                    </tr>
					
					<tr>
					  <td colspan="4"><label class="lblobjs"><b>LAND REFERENCE</b></label></td>
                      <td colspan="3">&nbsp;</td>
					  <td>&nbsp;</td>
					  <td colspan="3">&nbsp;</td>
				  </tr>
					<tr><td><label <?php $page->businessobject->items->userfields->draw->caption("u_landowner") ?>>Owner</label></td>
						...
						<td>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_surveyno") ?>/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr><td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_tctno") ?>>OCT/TCT/CLOA No.</label></td>
					  <td width="299">&nbsp;<input type="text" size="25" <?php $page->businessobject->items->userfields->draw->text("u_tctno") ?>/></td>
					  <td width="20">&nbsp;</td>
					  <td width="50">&nbsp;</td>
					  <td ><label <?php $page->businessobject->items->userfields->draw->caption("u_lotno") ?>>Lot No.</label></td>
						<td>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_lotno") ?>/></td>
						<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_block") ?>>Blk</label></td>
						<td>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_block") ?>/></td>
						<td>&nbsp;</td>
					</tr>
					<tr><td width="301"><label <?php $page->businessobject->items->userfields->draw->caption("u_landtdno") ?>>TD No.</label></td>
					  <td width="299">&nbsp;<input type="text" size="25" <?php $page->businessobject->items->userfields->draw->text("u_landtdno") ?>/></td>
					  <td>&nbsp;</td>
						<td>&nbsp;</td>
                        <td><label <?php $page->businessobject->items->userfields->draw->caption("u_sqm") ?>>Area (sqm.)</label></td>
						<td>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_sqm") ?>/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					...
					<tr>
					  <td colspan="4"><label class="lblobjs"><b>GENERAL DESCRIPTION</b></label></td>
                      <td colspan="3">&nbsp;</td>
					  <td>&nbsp;</td>
					  <td colspan="3">&nbsp;</td>
					  <td>&nbsp;</td>
				  </tr>
					<tr><td width="301"><label <?php $page->businessobject->items->userfields->draw->caption("u_building") ?>>Kind of Building</label></td>
					  <td colspan="3">&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_building",null,null,null,null,"width:300px") ?>></select></td>
						<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_bldgname") ?>>Building Name</label></td>
						<td>&nbsp;<input type="text" size="30" <?php $page->businessobject->items->userfields->draw->text("u_bldgname") ?>/></td>
						<td >&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr><td width="301"><label <?php $page->businessobject->items->userfields->draw->caption("u_structuretype") ?>>Structural Type</label></td>
                                            <td>&nbsp;<select <?php $page->businessobject->items->userfields->draw->select("u_structuretype") ?>></select></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_bpno") ?>>Bldg. Permit No.</label></td>
						<td>&nbsp;<input type="text" size="20" <?php $page->businessobject->items->userfields->draw->text("u_bpno") ?>/></td>
						<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_bpdate") ?>>Issued On</label></td>
						<td>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_bpdate") ?>/></td>
						<td>&nbsp;</td>
					</tr>
					<tr><td width="301"><label <?php $page->businessobject->items->userfields->draw->caption("u_cct") ?>>Codominium Certificate of Title (CCT)</label></td>
					  <td>&nbsp;<input type="text" size="25" <?php $page->businessobject->items->userfields->draw->text("u_cct") ?>/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_startyear") ?>>Year Constructed</label></td>
						<td>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_startyear") ?>/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr><td width="301"><label <?php $page->businessobject->items->userfields->draw->caption("u_ccidate") ?>>Certificate of Completion Issued On</label></td>
					  <td>&nbsp;<input type="text" size="25" <?php $page->businessobject->items->userfields->draw->text("u_ccidate") ?>/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_endyear") ?>>Year Completed</label></td>
						<td>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_endyear") ?>/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr><td width="301"><label <?php $page->businessobject->items->userfields->draw->caption("u_coidate") ?>>Certificate of Occupancy Issued On</label></td>
					  <td>&nbsp;<input type="text" size="25" <?php $page->businessobject->items->userfields->draw->text("u_coidate") ?>/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_occyear") ?>>Year Occupied</label></td>
						<td>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_occyear") ?>/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr><td width="301"><label <?php $page->businessobject->items->userfields->draw->caption("u_floorcount") ?>>No. of Storeys</label></td>
					  <td>&nbsp;<input type="text" size="25" <?php $page->businessobject->items->userfields->draw->text("u_floorcount") ?>/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td ><label <?php $page->businessobject->items->userfields->draw->caption("u_renyear") ?>>Year Renovated</label></td>
						<td>&nbsp;<input type="text" size="10" <?php $page->businessobject->items->userfields->draw->text("u_renyear") ?>/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
 	  ...
 	  <div class="tabbertab" title="Building Assessment">
          <div id="divass" style="overflow:auto;">
                  <table class="tableFreeForm" width="100%" border="0" cellpadding="0" cellspacing="0" > 
					<tr><td colspan="9"><label class="lblobjs"><b>BUILDING DETAILS</b></label></td>
                    <td colspan="9" align="right"></td>
					</tr>
                 </table>   
         		<?php $objGridA->draw(true); ?>	
                  <table class="tableFreeForm" width="100%" border="0" cellpadding="0" cellspacing="0" > 
					<tr><td colspan="9"><label class="lblobjs"><b>ADDITIONAL ITEMS</b></label></td>
					</tr>
                 </table>   
	  ...
	  <div class="tabbertab" title="Structural Materials">
...
<?php $page->resize->addtab("tab1",-1,150); ?>
...
<?php $page->resize->addgridobject($objGridA,20,-1) ?>
<?php $page->resize->addgridobject($objGridB,20,-1) ?>
<?php $page->resize->addgridobject($objGridC,20,-1) ?>
<?php $page->resize->addgridobject($objGridD,20,-1) ?>
<?php $page->resize->addgridobject($objGrids[1],20,350) ?>
<?php $page->resize->addgridobject($objGrids[2],20,350) ?>