[Setup]
AppId=eBTPortalLGUAcctgPaterosAddOnSetup
AppName=eBT Portal LGU Acctg Pateros AddOn Setup
AppVerName=eBT Portal LGU Acctg Pateros AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUAcctgPaterosAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Acctg Pateros Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'LGU Acctg Pateros Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'LGUAcctgPateros';
  AddOnVersion := '1.0.0';
