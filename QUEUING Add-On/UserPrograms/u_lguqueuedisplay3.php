...
//	include_once("./inc/formaccess.php");
	...
	$page->paging->formid = "./UDP.php?&objectcode=u_lguqueuedisplay3";
...
//	$schema["u_birthdate"]["cfl"] = "Calendar";
	...
	$objrs->queryopen("select count(*) from u_lguquegroups where u_monitor = 1");
	if ($objrs->queryfetchrow()) {
		if ($page->getitemnumeric("opt2")> $objrs->fields[0] ) $page->setitem("opt2",1);
	}

	$refresh = 3;
	$objrs->queryopen("select name, u_color, u_voicemessage, u_refresh from u_lguquegroups where u_groupcount='".$page->getitemnumeric("opt2")."' and u_monitor = 1");
	if ($objrs->queryfetchrow()) {
	...
	$speech = "";
	$idx=0;
	$objrs->queryopen("select U_CTR, U_REF from U_LGUQUE WHERE u_groupcount='".$page->getitemnumeric("opt2")."' AND U_DATE='".currentdateDB()."' and u_monitor = 1 ORDER BY DOCNO DESC LIMIT 5");
...
<script language="JavaScript">
  	...
  	var timerRunning = false;
		...
		var minutes = now.getMinutes();
	  	...
	  	var oStatusClock;
	  	oStatusClock = document.getElementById('statusClock');
	  	Day = new Array(7);
	  	Day[0]="Sunday";
	  	Day[1]="Monday";
	  	Day[2]="Tuesday";
	  	...
	  	if (month > 9) timeValue += month + "-";
	  	else timeValue += "0" + month + "-";
	  
	  	timeValue += date + "-" +  year + " ";
	  
	  	if (hours <= 12) timeValue += hours;
	  	else timeValue += hours - 12;
	  
	  	if (minutes > 9) timeValue += ":" + minutes;
	  	else timeValue += ":0" + minutes;
	  
	  	if (seconds > 9) timeValue += ":" + seconds;
	  	else timeValue += ":0" + seconds;
	
	  	if (hours > 12) timeValue += " PM";
	  	else timeValue += " AM";
                
                
	  	oStatusClock.innerHTML = timeValue;
...
<tr>
	<td>
            <table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" >
            <tr>
              <td colspan="2" width="100%">
              	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#008080; border-bottom: 1px">
                	<tr height="100">
                    	<td align="center" width="100%"><font size="15" face="Monospace" color="#ffffff"><b><?php echo $quename ?></b></font></td>
                    </tr>
                </table>
              </td>
            </tr>
            <tr>
              <td width="100%">
              	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="1" style="background-color:#ffffff; ">
                    <tr height="50" >
                    	<td align="center" width="370px"><font size="7" face="Monospace" color="#000000"><b>Counter</b></font></td>
                    	<td align="center" width="370px" ><font size="7" face="Monospace" color="#000000"><b>Customer</b></font></td>
                    </tr>
                    <tr height="100">
                    	<td align="center"  border="0"><font size="12" face="Verdana, Arial, Helvetica, sans-serif" color="#008080"><b><?php echo $ctr[0] ?></b></font></td>
                        <td align="center" border="0"><font size="12" face="Verdana, Arial, Helvetica, sans-serif" color="<?php echo $colors[$coloridx] ?>"><b><?php echo $ref[0] ?></b></font></td>
                    </tr>
                    <tr height="100">
                    	<td align="center"><font size="12" face="Verdana, Arial, Helvetica, sans-serif" color="#008080"><b><?php echo $ctr[1] ?></b></font></td>
                        <td align="center"><font size="12" face="Verdana, Arial, Helvetica, sans-serif" color="<?php echo $colors[$coloridx] ?>"><b><?php echo $ref[1] ?></b></font></td>
                    </tr>
                    <tr height="100">
                    	<td align="center"><font size="12" face="Verdana, Arial, Helvetica, sans-serif" color="#008080"><b><?php echo $ctr[2] ?></b></font></td>
                        <td align="center"><font size="12" face="Verdana, Arial, Helvetica, sans-serif" color="<?php echo $colors[$coloridx] ?>"><b><?php echo $ref[2] ?></b></font></td>
                    </tr>
                    <tr height="100">
                    	<td align="center"><font size="12" face="Verdana, Arial, Helvetica, sans-serif" color="#008080"><b><?php echo $ctr[3] ?></b></font></td>
                        <td align="center"><font size="12" face="Verdana, Arial, Helvetica, sans-serif" color="<?php echo $colors[$coloridx] ?>"><b><?php echo $ref[3] ?></b></font></td>
                    </tr>
                    <tr height="100">
                    	<td align="center"><font size="12" face="Verdana, Arial, Helvetica, sans-serif" color="#008080"><b><?php echo $ctr[4] ?></b></font></td>
                        <td align="center"><font size="12" face="Verdana, Arial, Helvetica, sans-serif" color="<?php echo $colors[$coloridx] ?>"><b><?php echo $ref[4] ?></b></font></td>
                        <td align="center"  ><font size="12" face="Century Gothic" color="#000000"><b><label id="statusClock" for=""></label></b></font></td>
                    </tr>
                </table>
              </td>
              <td width="50%">&nbsp; </td>
            ...
            <tr>
              <td colspan="2" width="100%">
              	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#008080; ">
                	<tr height="100">
                            <td align="center" width="100%"><font size="8" face="Monospace" color="#ffffff"><b><?php // echo $quename ?> ANNOUNCEMENT!! Lorem ipsum dolor sit amet, consectetuer</b></font> </td>
                    </tr>
                </table>
              </td>
            </tr>
