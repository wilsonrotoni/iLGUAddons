[Setup]
AppId=eBTPortalRPTASMACROAddOnSetup
AppName=eBT Portal RPTAS MACRO AddOn Setup
AppVerName=eBT Portal RPTAS MACRO AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalRPTASMACROAddOnSetup.exe
Compression=lzma
...
[Files]
Source: RPTAS MACRO Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
