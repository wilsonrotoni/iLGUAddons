[Setup]
AppId=eBTPortalOnlineBillingAddOnSetup
AppName=eBT Portal Online Billing AddOn Setup
AppVerName=eBT Portal Online Billing AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalOnlineBillingAddOnSetup.exe
Compression=lzma
...
[Files]
Source: Online Billing Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'Online Billing Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'OnlineBilling';
  AddOnVersion := '1.0.0';
