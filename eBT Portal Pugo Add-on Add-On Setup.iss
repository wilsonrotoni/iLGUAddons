[Setup]
AppId=eBTPortalPugoAdd-onAddOnSetup
AppName=eBT Portal Pugo Add-on AddOn Setup
AppVerName=eBT Portal Pugo Add-on AddOn Setup Version 1.0
AppPublisher=GPS
AppPublisherURL=GPS
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalPugoAdd-onAddOnSetup.exe
Compression=lzma
...
[Files]
Source: Pugo Add-on Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'Pugo Add-on Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'PugoAdd-on';
  AddOnVersion := '1.0';
  AddOnCompanyName := 'GPS';
  AddOnCompanyWebSite := 'GPS';
end;
