[Setup]
AppId=eBTPortalLGUMiscellaneousAddOnSetup
AppName=eBT Portal LGU Miscellaneous AddOn Setup
AppVerName=eBT Portal LGU Miscellaneous AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUMiscellaneousAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Miscellaneous Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'LGU Miscellaneous Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'LGUMiscellaneous';
  AddOnVersion := '1.0.0';
