<?php 
	...
	$filepath = "";
	$objrs->queryopen("select u_filepath from u_quesetup");
...
<iframe id="queue" style="border:none; width: 100%; height: 100%;   display: block; position: absolute;" scrolling="no" src="./udp.php?objectcode=u_queuedisplay2&df_u_group=<?php echo $group ?>">
</iframe>
