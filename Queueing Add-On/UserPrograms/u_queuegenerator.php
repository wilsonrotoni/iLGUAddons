		...
		<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#000000">
            <tr>
              <td width="100%" colspan="2">
              	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="" style="background-color:#bf0000">
                    <tr height="150">
                     
                        <td align="center" width="100%"><font style="font-size:80px" face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff"><label> Queueing System </label></font></td>
                    </tr>
                </table>              
              </td>
            </tr>
            <tr>
              <td width="60%" valign="top">
                <?php 
					$count=0;
					$objRs = new recordset(null,$objConnection);
					$objRs->queryopen("select count(*) from u_quegroups");
					if ($objRs->queryfetchrow()) {
						$count = $objRs->fields[0];
					}	
				?>
                ...
                <?php 
						$ctr=0;
						$objRs->queryopen("select code, name from u_quegroups order by convert(code, signed)");
						while ($objRs->queryfetchrow()) {
							$ctr++;
				?>
                	<tr height="88">
                    	<td align="center" colspan="4"><a href="" onClick="pressButton('<?php echo $objRs->fields[0] ?>','<?php echo $objRs->fields[1] ?>');return false;" class="buttonDialer" style="background-color:#bf0000"><?php echo $objRs->fields[1] ?></a></td>
                    </tr>
                <?php
						} 
						for ($i=$ctr;$i<4;$i++) { ?>
                	...
                	<tr height="352">
                    	<td align="center" colspan="4">
                        	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#000000">
                            	<tr>
                                	<td width="50%">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="1" style="background-color:#000000">
										<?php 
												$ctr=0;
                                                $objRs->queryopen("select code, name from u_quegroups order by convert(code, signed) limit 0,4");
                                                while ($objRs->queryfetchrow()) {
													$ctr++;
                                        ?>
                                        <tr height="88">
                                            <td align="center"><a href="" onClick="pressButton('<?php echo $objRs->fields[0] ?>','<?php echo $objRs->fields[1] ?>');return false;" class="buttonDialer"  style="background-color:#bf0000"><?php echo $objRs->fields[1] ?></a></td>
                                        </tr>
										<?php
                                                }
												for ($i=$ctr;$i<4;$i++) { ?>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="1" style="background-color:#000000">
										<?php 
												$ctr=0;
                                                $objRs->queryopen("select code, name from u_quegroups order by convert(code, signed) limit 4,4");
                                                while ($objRs->queryfetchrow()) {
													$ctr++;
                                        ?>
                                        <tr height="88">
				...
				?>    
                	<tr height="100">
                    	<td align="center" ><font size="10" face="Verdana, Arial, Helvetica, sans-serif" color="white"><label id="cf_queuegroup"></label></font></td>
                    	...
                    	<td align="center" width="50"><a href="" onClick="rePrint();return false;"><img id="reprint" height=40 src="../Addons/GPS/Queueing Add-On/UserPrograms/Images/printer_small.jpg" width=40 align=absbottom border=0></a></td>
                    </tr>
                </table>              
              </td>
              <td width="40%">
              	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="1" style="background-color:#000000">
                	...
                	<tr height="76">
                    	<td align="center"><a href="" onClick="pressDial('1');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;1&nbsp;&nbsp;</a></td>
                    	<td align="center"><a href="" onClick="pressDial('2');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;2&nbsp;&nbsp;</a></td>
                    	<td align="center"><a href="" onClick="pressDial('3');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;3&nbsp;&nbsp;</a></td>
                    </tr>
                	<tr height="76">
                    	<td align="center"><a href="" onClick="pressDial('4');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;4&nbsp;&nbsp;</a></td>
                    	<td align="center"><a href="" onClick="pressDial('5');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;5&nbsp;&nbsp;</a></td>
                    	<td align="center"><a href="" onClick="pressDial('6');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;6&nbsp;&nbsp;</a></td>
                    </tr>
                 	<tr height="76">
                    	<td align="center"><a href="" onClick="pressDial('7');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;7&nbsp;&nbsp;</a></td>
                    	<td align="center"><a href="" onClick="pressDial('8');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;8&nbsp;&nbsp;</a></td>
                    	<td align="center"><a href="" onClick="pressDial('9');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;9&nbsp;&nbsp;</a></td>
                    </tr>
                 	<tr height="76">
                    	<td align="center"><a href="" onClick="pressDial('0');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;0&nbsp;&nbsp;</a></td>
                    	<td align="center"><a href="" onClick="pressDial('<');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;<&nbsp;&nbsp;</a></td>
                    	<td align="center"><a href="" onClick="pressDial('C');return false;" class="buttonDialer" style="background-color:#bf0000">&nbsp;&nbsp;C&nbsp;&nbsp;</a></td>
                    </tr>
               </table>              
              </td>
              </tr>
