...
function onAfterDefaultGPSLGUReceipts() {
        ...
        $page->setitem("u_dateissued",currentdate());
...
//$page->businessobject->items->seteditable("u_receiptfrm",false);
...
$objGrids[0]->columnwidth("u_form",20);
$objGrids[0]->columnwidth("u_receiptto",15);
$objGrids[0]->columnwidth("u_receiptfrm",15);
$objGrids[0]->columnwidth("u_receiptlineid",12);
$objGrids[0]->columnwidth("u_noofreceipt",12);
$objGrids[0]->columnwidth("u_available",12);
$objGrids[0]->columnwidth("u_docseries",12);
