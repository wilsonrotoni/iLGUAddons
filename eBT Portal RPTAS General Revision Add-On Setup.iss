[Setup]
AppId=eBTPortalRPTASGeneralRevisionAddOnSetup
AppName=eBT Portal RPTAS General Revision AddOn Setup
AppVerName=eBT Portal RPTAS General Revision AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalRPTASGeneralRevisionAddOnSetup.exe
Compression=lzma
...
[Files]
Source: RPTAS General Revision Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'RPTAS General Revision Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'RPTASGeneralRevision';
  AddOnVersion := '1.0.0';
