...
<?php $page->resize->addtab("tab1",-1,299); ?>
<?php $page->resize->addtabpage("tab1","refund") ?>
<?php $page->resize->addgridobject($objGrids[0],20,462) ?>
<?php $page->resize->addgridobject($objGrids[1],20,319) ?>		
<?php $page->resize->addgridobject($objGrids[2],20,347) ?>
<?php $page->resize->addgridobject($objGrids[3],20,349) ?>
<?php $page->resize->addgridobject($objGrids[4],20,349) ?>
