<tr><td>
	<table class="tableFreeForm" width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
		  <td width="168"><label <?php $page->businessobject->items->userfields->draw->caption("u_projcode") ?>>Program/Project</label></td>
			<td>&nbsp;<input type="text" <?php $page->businessobject->items->userfields->draw->text("u_projcode") ?>/>&nbsp;<input type="text" size="50"<?php $page->businessobject->items->userfields->draw->text("u_projname") ?>/></td>
		  <td >&nbsp;</td>
		  <td align=left>&nbsp;</td>
	  </tr>
	</table>
