[Setup]
AppId=eBTPortalLGUAcctgAddOnSetup
AppName=eBT Portal LGU Acctg AddOn Setup
AppVerName=eBT Portal LGU Acctg AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUAcctgAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Acctg Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
