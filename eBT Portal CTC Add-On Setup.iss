[Setup]
AppId=eBTPortalCTCAddOnSetup
AppName=eBT Portal CTC AddOn Setup
AppVerName=eBT Portal CTC AddOn Setup Version 1.0.0
AppPublisher=GREENPEPPER SOFTWARE INC.
AppPublisherURL=WWW.GPS-SW.COM
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalCTCAddOnSetup.exe
Compression=lzma
...
[Files]
Source: CTC Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
