...
and collections.collfor in('DP') and collections.doctype='C'
...
and payments.collfor in('DP') and payments.doctype='C'
...
CREATE TEMPORARY TABLE  `mainfield` (
    ...
    `SALESPERSON` varchar(100) NULL default '',
...
INSERT
    ...
    SELECT collections.COMPANY,
        ...
        WHERE collections.PAIDAMOUNT > 0 AND collections.cleared<>0 AND collections.collfor in('DP') and collections.doctype='C'
         and (collections.docstat not in ('CN','BC','D') or (collections.docstat = 'CN' and collections.pdc=0 and collections.cancelleddate > pi_date) or (collections.docstat = 'BC' and collections.cancelleddate > pi_date) )
        AND collections.valuedate <= pi_date AND collections.valuedate <> '0000-00-00'
...
INSERT
    ...
    SELECT payments.COMPANY,
        ...
        WHERE payments.PAIDAMOUNT > 0 AND payments.collfor in('DP') and payments.doctype='C'
...
if pi_output='' then
    ...
    FROM mainfield a
         ...
         LEFT OUTER JOIN salespersons sp ON a.salesperson = sp.salesperson
