...
INSERT
    ...
    SELECT apcreditmemos.COMPANY, apcreditmemos.BRANCH, apcreditmemos.OBJECTCODE, apcreditmemos.DOCNO,
        ...
        WHERE #apcreditmemos.totalamount > 0 AND
...
#select * from mainfield;
#select * from concatfield;
...
#   SELECT a.`COMPANY`,a.`BRANCH`,a.`BRANCHNAME`,a.`BPCODE`,a.`BPNAME`,a.`BILLTOADDRESS`,a.`ITEMCODE`,a.`OBJECTCODE`,a.`DOCNO`,a.`DOCDATE`,a.`DOCDUEDATE`,a.`DUEAMOUNT`,a.`aging`,a.`fisrtmonth`,a.`secondndmonth`,a.`thirdmonth`,a.`advpay`,a.`current`,a.`D7`,a.`D15`,a.`D30`,a.`UP30`,a.`PDC`,a.`cname`,a.`AMOUNT`,a.`SEQ`,a.`PAYDOCNO`,a.`PAYDOCDATE`,ct.DEBTPAYACCTNO from mainfield a LEFT OUTER JOIN suppliers ct ON ct.suppno = a.BPCODE
#        LEFT OUTER JOIN paymentterms pt ON pt.paymentterm = ct.paymentterm where (pi_suppno='' or (pi_suppno<>'' and a.BPCODE=pi_suppno))
#         and (pi_suppgroup='' or (pi_suppgroup<>'' and ct.SUPPGROUP=pi_suppgroup))
#         and (pi_ctrlacct='' or (pi_ctrlacct<>'' and ct.DEBTPAYACCTNO=pi_ctrlacct));
