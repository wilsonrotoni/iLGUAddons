...
BEGIN
  ...
  DECLARE v_companyname VARCHAR(500);
  DECLARE v_branchname VARCHAR(500);
...
call sp_processtime('end','');
  ...
  SELECT
    ...
    a.AGING,
    SUM(if(a.DUEAMOUNT < 0, a.DUEAMOUNT, a.current)) as CURRENT,
    0 as NEXT_MONTHS,
    sum(if(a.DUEAMOUNT < 0, 0, a.D7) + if(a.DUEAMOUNT < 0, 0, a.D15)) as '1-15',
    sum(if(a.DUEAMOUNT < 0, 0, a.D30)) as '16-30',
    sum(if(a.DUEAMOUNT < 0, 0, a.UP30))  as 'OVER30',
    sum(a.PDC) PDC
