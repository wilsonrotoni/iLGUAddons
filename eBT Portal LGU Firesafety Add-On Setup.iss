[Setup]
AppId=eBTPortalLGUFiresafetyAddOnSetup
AppName=eBT Portal LGU Firesafety AddOn Setup
AppVerName=eBT Portal LGU Firesafety AddOn Setup Version 1.0.0
AppPublisher=GreenPepper Software Inc.
AppPublisherURL=www.gps-sw.com
DefaultDirName={code:GetDefaultDir}
DisableProgramGroupPage=yes
OutputBaseFilename=eBTPortalLGUFiresafetyAddOnSetup.exe
Compression=lzma
...
[Files]
Source: LGU Firesafety Add-On\*.*;DestDir: {app}; Flags: recursesubdirs
...
begin
  AddOnName := 'LGU Firesafety Add-On';
  AddOnNameSpace := 'GPS';
  AddOnID := 'LGUFiresafety';
  AddOnVersion := '1.0.0';
